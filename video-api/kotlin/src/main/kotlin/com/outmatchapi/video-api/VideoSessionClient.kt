 ...
 *
 * @param name The name of the browser used to view the video session.
 * @param type The type of client used to view the video session.
 * @param version The version of the browser used to view the video session.
 */


data class VideoSessionClient (
