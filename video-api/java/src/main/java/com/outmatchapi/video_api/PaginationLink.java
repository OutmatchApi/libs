...
public class PaginationLink {
  ...
  **/
  ...
  public PaginationLink uri(String uri) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rel, paginationLink.rel) &&
        Objects.equals(this.uri, paginationLink.uri);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaginationLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginationLink` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
