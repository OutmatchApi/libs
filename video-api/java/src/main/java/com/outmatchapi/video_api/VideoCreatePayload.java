...
public class VideoCreatePayload {
  ...
  * @throws IOException if the JSON Object is invalid with respect to VideoCreatePayload
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VideoCreatePayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VideoCreatePayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoCreatePayload` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
