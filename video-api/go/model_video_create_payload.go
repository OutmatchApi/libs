...
func (o VideoCreatePayload) MarshalJSON() ([]byte, error) {
...
func (v NullableVideoCreatePayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoCreatePayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
