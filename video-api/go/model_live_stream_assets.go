...
func (o LiveStreamAssets) MarshalJSON() ([]byte, error) {
...
func (v NullableLiveStreamAssets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLiveStreamAssets) UnmarshalJSON(src []byte) error {
	v.isSet = true
