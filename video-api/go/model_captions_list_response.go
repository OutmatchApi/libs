...
func (o CaptionsListResponse) MarshalJSON() ([]byte, error) {
...
func (v NullableCaptionsListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCaptionsListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
