...
func (o AuthenticatePayload) MarshalJSON() ([]byte, error) {
...
func (v NullableAuthenticatePayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthenticatePayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
