...
func (o VideoThumbnailPickPayload) MarshalJSON() ([]byte, error) {
...
func (v NullableVideoThumbnailPickPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoThumbnailPickPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
