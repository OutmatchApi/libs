...
func (o LiveStreamUpdatePayload) MarshalJSON() ([]byte, error) {
...
func (v NullableLiveStreamUpdatePayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLiveStreamUpdatePayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
