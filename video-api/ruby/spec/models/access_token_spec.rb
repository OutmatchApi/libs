...
# Unit tests for video-api::AccessToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe video-api::AccessToken do
  let(:instance) { video-api::AccessToken.new }

  describe 'test an instance of AccessToken' do
    it 'should create an instance of AccessToken' do
      expect(instance).to be_instance_of(video-api::AccessToken)
    end
  end
