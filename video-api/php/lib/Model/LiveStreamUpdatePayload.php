 ...
 */
class LiveStreamUpdatePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'live-stream-update-payload';
    ...
    */
     ...
     * Sets player_id
     *
     * @param string|null $player_id The unique ID for the player associated with a live stream that you want to update.
     *
     * @return self
     */
