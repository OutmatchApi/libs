...
class AccessToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets access_token
     *
     * @param string|null $access_token The access token containing security credentials allowing you to acccess the API. The token lasts for one hour.
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Lists the time in seconds when your access token expires. It lasts for one hour.
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token A token you can use to get the next access token when your current access token expires.
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param string|null $token_type The type of token you have.
     *
     * @return self
     */
