...
class Subtitle(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["default", "src", "srclang", "uri", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["default", "src", "srclang", "uri", ], str]):
