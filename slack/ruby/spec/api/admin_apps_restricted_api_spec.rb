...
# Unit tests for slack::AdminAppsRestrictedApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AdminAppsRestrictedApi' do
  before do
  ...
  describe 'test an instance of AdminAppsRestrictedApi' do
    it 'should create an instance of AdminAppsRestrictedApi' do
      expect(@api_instance).to be_instance_of(slack::AdminAppsRestrictedApi)
    end
  end
