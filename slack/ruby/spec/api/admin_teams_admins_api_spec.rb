...
# Unit tests for slack::AdminTeamsAdminsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AdminTeamsAdminsApi' do
  before do
  ...
  describe 'test an instance of AdminTeamsAdminsApi' do
    it 'should create an instance of AdminTeamsAdminsApi' do
      expect(@api_instance).to be_instance_of(slack::AdminTeamsAdminsApi)
    end
  end
