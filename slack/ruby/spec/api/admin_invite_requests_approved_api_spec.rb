...
# Unit tests for slack::AdminInviteRequestsApprovedApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AdminInviteRequestsApprovedApi' do
  before do
  ...
  describe 'test an instance of AdminInviteRequestsApprovedApi' do
    it 'should create an instance of AdminInviteRequestsApprovedApi' do
      expect(@api_instance).to be_instance_of(slack::AdminInviteRequestsApprovedApi)
    end
  end
