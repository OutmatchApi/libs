...
# Unit tests for slack::AdminAppsApprovedApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AdminAppsApprovedApi' do
  before do
  ...
  describe 'test an instance of AdminAppsApprovedApi' do
    it 'should create an instance of AdminAppsApprovedApi' do
      expect(@api_instance).to be_instance_of(slack::AdminAppsApprovedApi)
    end
  end
