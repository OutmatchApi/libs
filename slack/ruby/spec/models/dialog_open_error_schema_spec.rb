...
# Unit tests for slack::DialogOpenErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::DialogOpenErrorSchema do
  let(:instance) { slack::DialogOpenErrorSchema.new }

  describe 'test an instance of DialogOpenErrorSchema' do
    it 'should create an instance of DialogOpenErrorSchema' do
      expect(instance).to be_instance_of(slack::DialogOpenErrorSchema)
    end
  end
