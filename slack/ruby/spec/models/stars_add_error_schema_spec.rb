...
# Unit tests for slack::StarsAddErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::StarsAddErrorSchema do
  let(:instance) { slack::StarsAddErrorSchema.new }

  describe 'test an instance of StarsAddErrorSchema' do
    it 'should create an instance of StarsAddErrorSchema' do
      expect(instance).to be_instance_of(slack::StarsAddErrorSchema)
    end
  end
