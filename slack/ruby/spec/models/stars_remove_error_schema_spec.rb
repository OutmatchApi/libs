...
# Unit tests for slack::StarsRemoveErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::StarsRemoveErrorSchema do
  let(:instance) { slack::StarsRemoveErrorSchema.new }

  describe 'test an instance of StarsRemoveErrorSchema' do
    it 'should create an instance of StarsRemoveErrorSchema' do
      expect(instance).to be_instance_of(slack::StarsRemoveErrorSchema)
    end
  end
