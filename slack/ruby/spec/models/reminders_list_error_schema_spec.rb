...
# Unit tests for slack::RemindersListErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::RemindersListErrorSchema do
  let(:instance) { slack::RemindersListErrorSchema.new }

  describe 'test an instance of RemindersListErrorSchema' do
    it 'should create an instance of RemindersListErrorSchema' do
      expect(instance).to be_instance_of(slack::RemindersListErrorSchema)
    end
  end
