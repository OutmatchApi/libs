...
# Unit tests for slack::UsersProfileSetErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::UsersProfileSetErrorSchema do
  let(:instance) { slack::UsersProfileSetErrorSchema.new }

  describe 'test an instance of UsersProfileSetErrorSchema' do
    it 'should create an instance of UsersProfileSetErrorSchema' do
      expect(instance).to be_instance_of(slack::UsersProfileSetErrorSchema)
    end
  end
