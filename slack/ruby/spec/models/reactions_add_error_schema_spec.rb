...
# Unit tests for slack::ReactionsAddErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::ReactionsAddErrorSchema do
  let(:instance) { slack::ReactionsAddErrorSchema.new }

  describe 'test an instance of ReactionsAddErrorSchema' do
    it 'should create an instance of ReactionsAddErrorSchema' do
      expect(instance).to be_instance_of(slack::ReactionsAddErrorSchema)
    end
  end
