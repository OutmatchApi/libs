...
# Unit tests for slack::RemindersDeleteErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::RemindersDeleteErrorSchema do
  let(:instance) { slack::RemindersDeleteErrorSchema.new }

  describe 'test an instance of RemindersDeleteErrorSchema' do
    it 'should create an instance of RemindersDeleteErrorSchema' do
      expect(instance).to be_instance_of(slack::RemindersDeleteErrorSchema)
    end
  end
