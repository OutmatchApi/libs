...
# Unit tests for slack::RemindersAddErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::RemindersAddErrorSchema do
  let(:instance) { slack::RemindersAddErrorSchema.new }

  describe 'test an instance of RemindersAddErrorSchema' do
    it 'should create an instance of RemindersAddErrorSchema' do
      expect(instance).to be_instance_of(slack::RemindersAddErrorSchema)
    end
  end
