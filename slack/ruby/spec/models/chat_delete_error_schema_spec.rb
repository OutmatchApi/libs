...
# Unit tests for slack::ChatDeleteErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::ChatDeleteErrorSchema do
  let(:instance) { slack::ChatDeleteErrorSchema.new }

  describe 'test an instance of ChatDeleteErrorSchema' do
    it 'should create an instance of ChatDeleteErrorSchema' do
      expect(instance).to be_instance_of(slack::ChatDeleteErrorSchema)
    end
  end
