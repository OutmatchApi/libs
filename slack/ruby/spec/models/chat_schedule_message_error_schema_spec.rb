...
# Unit tests for slack::ChatScheduleMessageErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::ChatScheduleMessageErrorSchema do
  let(:instance) { slack::ChatScheduleMessageErrorSchema.new }

  describe 'test an instance of ChatScheduleMessageErrorSchema' do
    it 'should create an instance of ChatScheduleMessageErrorSchema' do
      expect(instance).to be_instance_of(slack::ChatScheduleMessageErrorSchema)
    end
  end
