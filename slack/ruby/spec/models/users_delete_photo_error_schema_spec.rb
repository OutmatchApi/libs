...
# Unit tests for slack::UsersDeletePhotoErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::UsersDeletePhotoErrorSchema do
  let(:instance) { slack::UsersDeletePhotoErrorSchema.new }

  describe 'test an instance of UsersDeletePhotoErrorSchema' do
    it 'should create an instance of UsersDeletePhotoErrorSchema' do
      expect(instance).to be_instance_of(slack::UsersDeletePhotoErrorSchema)
    end
  end
