...
# Unit tests for slack::DndEndSnoozeErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::DndEndSnoozeErrorSchema do
  let(:instance) { slack::DndEndSnoozeErrorSchema.new }

  describe 'test an instance of DndEndSnoozeErrorSchema' do
    it 'should create an instance of DndEndSnoozeErrorSchema' do
      expect(instance).to be_instance_of(slack::DndEndSnoozeErrorSchema)
    end
  end
