...
# Unit tests for slack::UsersIdentityErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::UsersIdentityErrorSchema do
  let(:instance) { slack::UsersIdentityErrorSchema.new }

  describe 'test an instance of UsersIdentityErrorSchema' do
    it 'should create an instance of UsersIdentityErrorSchema' do
      expect(instance).to be_instance_of(slack::UsersIdentityErrorSchema)
    end
  end
