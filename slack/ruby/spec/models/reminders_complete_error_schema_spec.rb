...
# Unit tests for slack::RemindersCompleteErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::RemindersCompleteErrorSchema do
  let(:instance) { slack::RemindersCompleteErrorSchema.new }

  describe 'test an instance of RemindersCompleteErrorSchema' do
    it 'should create an instance of RemindersCompleteErrorSchema' do
      expect(instance).to be_instance_of(slack::RemindersCompleteErrorSchema)
    end
  end
