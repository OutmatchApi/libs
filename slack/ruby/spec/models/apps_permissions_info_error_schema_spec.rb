...
# Unit tests for slack::AppsPermissionsInfoErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::AppsPermissionsInfoErrorSchema do
  let(:instance) { slack::AppsPermissionsInfoErrorSchema.new }

  describe 'test an instance of AppsPermissionsInfoErrorSchema' do
    it 'should create an instance of AppsPermissionsInfoErrorSchema' do
      expect(instance).to be_instance_of(slack::AppsPermissionsInfoErrorSchema)
    end
  end
