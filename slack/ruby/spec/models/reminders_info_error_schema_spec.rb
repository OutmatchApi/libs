...
# Unit tests for slack::RemindersInfoErrorSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe slack::RemindersInfoErrorSchema do
  let(:instance) { slack::RemindersInfoErrorSchema.new }

  describe 'test an instance of RemindersInfoErrorSchema' do
    it 'should create an instance of RemindersInfoErrorSchema' do
      expect(instance).to be_instance_of(slack::RemindersInfoErrorSchema)
    end
  end
