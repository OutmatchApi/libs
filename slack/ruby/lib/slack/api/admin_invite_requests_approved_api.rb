  ...
  class AdminInviteRequestsApprovedApi
    ...
    def admin_invite_requests_approved_list_with_http_info(token, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdminInviteRequestsApprovedApi.admin_invite_requests_approved_list ...'
      end
      # verify the required parameter 'token' is set
      if @api_client.config.client_side_validation && token.nil?
        fail ArgumentError, "Missing the required parameter 'token' when calling AdminInviteRequestsApprovedApi.admin_invite_requests_approved_list"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AdminInviteRequestsApprovedApi.admin_invite_requests_approved_list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdminInviteRequestsApprovedApi#admin_invite_requests_approved_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
