  ...
  class AdminTeamsAdminsApi
    ...
    def admin_teams_admins_list_with_http_info(token, team_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdminTeamsAdminsApi.admin_teams_admins_list ...'
      end
      # verify the required parameter 'token' is set
      if @api_client.config.client_side_validation && token.nil?
        fail ArgumentError, "Missing the required parameter 'token' when calling AdminTeamsAdminsApi.admin_teams_admins_list"
      end
      # verify the required parameter 'team_id' is set
      if @api_client.config.client_side_validation && team_id.nil?
        fail ArgumentError, "Missing the required parameter 'team_id' when calling AdminTeamsAdminsApi.admin_teams_admins_list"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AdminTeamsAdminsApi.admin_teams_admins_list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdminTeamsAdminsApi#admin_teams_admins_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
