  ...
  class AdminAppsRestrictedApi
    ...
    def admin_apps_restricted_list_with_http_info(token, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdminAppsRestrictedApi.admin_apps_restricted_list ...'
      end
      # verify the required parameter 'token' is set
      if @api_client.config.client_side_validation && token.nil?
        fail ArgumentError, "Missing the required parameter 'token' when calling AdminAppsRestrictedApi.admin_apps_restricted_list"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AdminAppsRestrictedApi.admin_apps_restricted_list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdminAppsRestrictedApi#admin_apps_restricted_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
