  ...
  class UsergroupsUsersApi
    ...
    def usergroups_users_list_with_http_info(token, usergroup, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsergroupsUsersApi.usergroups_users_list ...'
      end
      # verify the required parameter 'token' is set
      if @api_client.config.client_side_validation && token.nil?
        fail ArgumentError, "Missing the required parameter 'token' when calling UsergroupsUsersApi.usergroups_users_list"
      end
      # verify the required parameter 'usergroup' is set
      if @api_client.config.client_side_validation && usergroup.nil?
        fail ArgumentError, "Missing the required parameter 'usergroup' when calling UsergroupsUsersApi.usergroups_users_list"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UsergroupsUsersApi.usergroups_users_list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsergroupsUsersApi#usergroups_users_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def usergroups_users_update_with_http_info(token, usergroup, users, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsergroupsUsersApi.usergroups_users_update ...'
      end
      # verify the required parameter 'token' is set
      if @api_client.config.client_side_validation && token.nil?
        fail ArgumentError, "Missing the required parameter 'token' when calling UsergroupsUsersApi.usergroups_users_update"
      end
      # verify the required parameter 'usergroup' is set
      if @api_client.config.client_side_validation && usergroup.nil?
        fail ArgumentError, "Missing the required parameter 'usergroup' when calling UsergroupsUsersApi.usergroups_users_update"
      end
      # verify the required parameter 'users' is set
      if @api_client.config.client_side_validation && users.nil?
        fail ArgumentError, "Missing the required parameter 'users' when calling UsergroupsUsersApi.usergroups_users_update"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UsergroupsUsersApi.usergroups_users_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsergroupsUsersApi#usergroups_users_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
