...
public class ConversationMPIMObject {
  ...
  private Set<String> connectedTeamIds = null;
  ...
  private Set<String> internalTeamIds = null;
   ...
   * Gets or Sets isMpim
   */
  @JsonAdapter(IsMpimEnum.Adapter.class)
  public enum IsMpimEnum {
    TRUE("true");

    private Boolean value;

    IsMpimEnum(Boolean value) {
      this.value = value;
    }
    ...
    public static IsMpimEnum fromValue(Boolean value) {
      for (IsMpimEnum b : IsMpimEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<IsMpimEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final IsMpimEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public IsMpimEnum read(final JsonReader jsonReader) throws IOException {
        Boolean value =  jsonReader.nextBoolean();
        return IsMpimEnum.fromValue(value);
      }
    }
  }
  ...
  private List<ObjsChannelLatestInner> latest = null;
  ...
  private List<ConversationObjectParentConversationInner> parentConversation = null;
  ...
  private Set<String> pendingConnectedTeamIds = null;
  ...
  **/
  ...
  public ConversationMPIMObject isMpim(IsMpimEnum isMpim) {
  ...
  **/
  ...
  public IsMpimEnum getIsMpim() {
    return isMpim;
  }


  public void setIsMpim(IsMpimEnum isMpim) {
    this.isMpim = isMpim;
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConversationMPIMObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConversationMPIMObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ConversationMPIMObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConversationMPIMObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("connected_team_ids") != null && !jsonObj.get("connected_team_ids").isJsonArray()) {
      ...
      if (jsonObj.get("display_counts") != null && !jsonObj.get("display_counts").isJsonNull()) {
        ConversationObjectDisplayCounts.validateJsonObject(jsonObj.getAsJsonObject("display_counts"));
      }
      if (!jsonObj.get("id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("id").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("internal_team_ids") != null && !jsonObj.get("internal_team_ids").isJsonArray()) {
      ...
      if (jsonObj.get("latest") != null && !jsonObj.get("latest").isJsonNull()) {
        ...
        if (jsonArraylatest != null) {
          ...
          for (int i = 0; i < jsonArraylatest.size(); i++) {
            ObjsChannelLatestInner.validateJsonObject(jsonArraylatest.get(i).getAsJsonObject());
          };
        }
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("parent_conversation") != null && !jsonObj.get("parent_conversation").isJsonNull()) {
        ...
        if (jsonArrayparentConversation != null) {
          ...
          for (int i = 0; i < jsonArrayparentConversation.size(); i++) {
            ConversationObjectParentConversationInner.validateJsonObject(jsonArrayparentConversation.get(i).getAsJsonObject());
          };
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("pending_connected_team_ids") != null && !jsonObj.get("pending_connected_team_ids").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("shared_team_ids") != null && !jsonObj.get("shared_team_ids").isJsonArray()) {
      ...
      if (jsonObj.get("shares") != null && !jsonObj.get("shares").isJsonNull()) {
        ...
        if (jsonArrayshares != null) {
          ...
          for (int i = 0; i < jsonArrayshares.size(); i++) {
            ConversationObjectSharesInner.validateJsonObject(jsonArrayshares.get(i).getAsJsonObject());
          };
        }
      }
