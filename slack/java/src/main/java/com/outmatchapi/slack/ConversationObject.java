...
public class ConversationObject {
  ...
  **/
  ...
  public ConversationObject isMpim(IsMpimEnum isMpim) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConversationObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConversationObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ConversationObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConversationObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
