...
public class TeamAccessLogsSchemaLoginsInner {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TeamAccessLogsSchemaLoginsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamAccessLogsSchemaLoginsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TeamAccessLogsSchemaLoginsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamAccessLogsSchemaLoginsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (!jsonObj.get("isp").isJsonPrimitive()) {
