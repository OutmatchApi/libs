 ...
 */
@ApiModel(description = "Schema for error response from pins.remove method")
...
public class PinsRemoveErrorSchema {
  ...
  **/
  ...
  public PinsRemoveErrorSchema ok(DefsOkFalse ok) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PinsRemoveErrorSchema
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PinsRemoveErrorSchema.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PinsRemoveErrorSchema.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PinsRemoveErrorSchema` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
