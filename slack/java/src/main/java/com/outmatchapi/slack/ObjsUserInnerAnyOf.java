 ...
 */
@ApiModel(description = "user object for non enterprise type")
...
public class ObjsUserInnerAnyOf {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ObjsUserInnerAnyOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ObjsUserInnerAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ObjsUserInnerAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObjsUserInnerAnyOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
