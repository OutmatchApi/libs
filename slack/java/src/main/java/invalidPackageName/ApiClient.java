...
import invalidPackageName.auth.RetryingOAuth;
import invalidPackageName.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://slack.com/api";
    ...
    public ApiClient() {
        ...
        authentications.put("slackAuth", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://slack.com/api/oauth.access";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://slack.com/api
