...
type UsersListErrorSchema struct {
...
func (o UsersListErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableUsersListErrorSchema struct {
	value *UsersListErrorSchema
	isSet bool
}

func (v NullableUsersListErrorSchema) Get() *UsersListErrorSchema {
	return v.value
}

func (v *NullableUsersListErrorSchema) Set(val *UsersListErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableUsersListErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableUsersListErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsersListErrorSchema(val *UsersListErrorSchema) *NullableUsersListErrorSchema {
	return &NullableUsersListErrorSchema{value: val, isSet: true}
}

func (v NullableUsersListErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsersListErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
