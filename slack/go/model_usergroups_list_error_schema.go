...
type UsergroupsListErrorSchema struct {
...
func NewUsergroupsListErrorSchema(error_ string, ok DefsOkFalse) *UsergroupsListErrorSchema {
	this := UsergroupsListErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o UsergroupsListErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableUsergroupsListErrorSchema struct {
	value *UsergroupsListErrorSchema
	isSet bool
}

func (v NullableUsergroupsListErrorSchema) Get() *UsergroupsListErrorSchema {
	return v.value
}

func (v *NullableUsergroupsListErrorSchema) Set(val *UsergroupsListErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableUsergroupsListErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableUsergroupsListErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsergroupsListErrorSchema(val *UsergroupsListErrorSchema) *NullableUsergroupsListErrorSchema {
	return &NullableUsergroupsListErrorSchema{value: val, isSet: true}
}

func (v NullableUsergroupsListErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsergroupsListErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
