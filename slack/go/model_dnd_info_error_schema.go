...
type DndInfoErrorSchema struct {
...
func (o DndInfoErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableDndInfoErrorSchema struct {
	value *DndInfoErrorSchema
	isSet bool
}

func (v NullableDndInfoErrorSchema) Get() *DndInfoErrorSchema {
	return v.value
}

func (v *NullableDndInfoErrorSchema) Set(val *DndInfoErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableDndInfoErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableDndInfoErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDndInfoErrorSchema(val *DndInfoErrorSchema) *NullableDndInfoErrorSchema {
	return &NullableDndInfoErrorSchema{value: val, isSet: true}
}

func (v NullableDndInfoErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDndInfoErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
