...
type UsersInfoErrorSchema struct {
...
func (o UsersInfoErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableUsersInfoErrorSchema struct {
	value *UsersInfoErrorSchema
	isSet bool
}

func (v NullableUsersInfoErrorSchema) Get() *UsersInfoErrorSchema {
	return v.value
}

func (v *NullableUsersInfoErrorSchema) Set(val *UsersInfoErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableUsersInfoErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableUsersInfoErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsersInfoErrorSchema(val *UsersInfoErrorSchema) *NullableUsersInfoErrorSchema {
	return &NullableUsersInfoErrorSchema{value: val, isSet: true}
}

func (v NullableUsersInfoErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsersInfoErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
