...
// AdminInviteRequestsApprovedApiService AdminInviteRequestsApprovedApi service
type AdminInviteRequestsApprovedApiService service

type ApiAdminInviteRequestsApprovedListRequest struct {
	ctx context.Context
	ApiService *AdminInviteRequestsApprovedApiService
	token *string
	teamId *string
	cursor *string
	limit *int32
...
*/
func (a *AdminInviteRequestsApprovedApiService) AdminInviteRequestsApprovedList(ctx context.Context) ApiAdminInviteRequestsApprovedListRequest {
	return ApiAdminInviteRequestsApprovedListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AdminInviteRequestsApprovedApiService) AdminInviteRequestsApprovedListExecute(r ApiAdminInviteRequestsApprovedListRequest) (*DefaultSuccessTemplate, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminInviteRequestsApprovedApiService.AdminInviteRequestsApprovedList")
	if err != nil {
