...
type MigrationExchangeErrorSchema struct {
...
func NewMigrationExchangeErrorSchema(error_ string, ok DefsOkFalse) *MigrationExchangeErrorSchema {
	this := MigrationExchangeErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o MigrationExchangeErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableMigrationExchangeErrorSchema struct {
	value *MigrationExchangeErrorSchema
	isSet bool
}

func (v NullableMigrationExchangeErrorSchema) Get() *MigrationExchangeErrorSchema {
	return v.value
}

func (v *NullableMigrationExchangeErrorSchema) Set(val *MigrationExchangeErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableMigrationExchangeErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableMigrationExchangeErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMigrationExchangeErrorSchema(val *MigrationExchangeErrorSchema) *NullableMigrationExchangeErrorSchema {
	return &NullableMigrationExchangeErrorSchema{value: val, isSet: true}
}

func (v NullableMigrationExchangeErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMigrationExchangeErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
