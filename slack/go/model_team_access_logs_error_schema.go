...
type TeamAccessLogsErrorSchema struct {
...
func NewTeamAccessLogsErrorSchema(error_ string, ok DefsOkFalse) *TeamAccessLogsErrorSchema {
	this := TeamAccessLogsErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o TeamAccessLogsErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableTeamAccessLogsErrorSchema struct {
	value *TeamAccessLogsErrorSchema
	isSet bool
}

func (v NullableTeamAccessLogsErrorSchema) Get() *TeamAccessLogsErrorSchema {
	return v.value
}

func (v *NullableTeamAccessLogsErrorSchema) Set(val *TeamAccessLogsErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamAccessLogsErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamAccessLogsErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamAccessLogsErrorSchema(val *TeamAccessLogsErrorSchema) *NullableTeamAccessLogsErrorSchema {
	return &NullableTeamAccessLogsErrorSchema{value: val, isSet: true}
}

func (v NullableTeamAccessLogsErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamAccessLogsErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
