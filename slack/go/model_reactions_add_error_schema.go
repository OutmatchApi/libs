...
type ReactionsAddErrorSchema struct {
...
func (o ReactionsAddErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableReactionsAddErrorSchema struct {
	value *ReactionsAddErrorSchema
	isSet bool
}

func (v NullableReactionsAddErrorSchema) Get() *ReactionsAddErrorSchema {
	return v.value
}

func (v *NullableReactionsAddErrorSchema) Set(val *ReactionsAddErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableReactionsAddErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableReactionsAddErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReactionsAddErrorSchema(val *ReactionsAddErrorSchema) *NullableReactionsAddErrorSchema {
	return &NullableReactionsAddErrorSchema{value: val, isSet: true}
}

func (v NullableReactionsAddErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReactionsAddErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
