...
// AppsPermissionsResourcesApiService AppsPermissionsResourcesApi service
type AppsPermissionsResourcesApiService service

type ApiAppsPermissionsResourcesListRequest struct {
	ctx context.Context
	ApiService *AppsPermissionsResourcesApiService
	token *string
	cursor *string
	limit *int32
}
...
*/
func (a *AppsPermissionsResourcesApiService) AppsPermissionsResourcesList(ctx context.Context) ApiAppsPermissionsResourcesListRequest {
	return ApiAppsPermissionsResourcesListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AppsPermissionsResourcesApiService) AppsPermissionsResourcesListExecute(r ApiAppsPermissionsResourcesListRequest) (*AppsPermissionsResourcesListSuccessSchema, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AppsPermissionsResourcesApiService.AppsPermissionsResourcesList")
	if err != nil {
