...
// AdminAppsRestrictedApiService AdminAppsRestrictedApi service
type AdminAppsRestrictedApiService service

type ApiAdminAppsRestrictedListRequest struct {
	ctx context.Context
	ApiService *AdminAppsRestrictedApiService
	token *string
	limit *int32
	cursor *string
	teamId *string
...
*/
func (a *AdminAppsRestrictedApiService) AdminAppsRestrictedList(ctx context.Context) ApiAdminAppsRestrictedListRequest {
	return ApiAdminAppsRestrictedListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AdminAppsRestrictedApiService) AdminAppsRestrictedListExecute(r ApiAdminAppsRestrictedListRequest) (*DefaultSuccessTemplate, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminAppsRestrictedApiService.AdminAppsRestrictedList")
	if err != nil {
