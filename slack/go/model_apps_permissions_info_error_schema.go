...
type AppsPermissionsInfoErrorSchema struct {
...
func NewAppsPermissionsInfoErrorSchema(error_ string, ok DefsOkFalse) *AppsPermissionsInfoErrorSchema {
	this := AppsPermissionsInfoErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o AppsPermissionsInfoErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableAppsPermissionsInfoErrorSchema struct {
	value *AppsPermissionsInfoErrorSchema
	isSet bool
}

func (v NullableAppsPermissionsInfoErrorSchema) Get() *AppsPermissionsInfoErrorSchema {
	return v.value
}

func (v *NullableAppsPermissionsInfoErrorSchema) Set(val *AppsPermissionsInfoErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableAppsPermissionsInfoErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableAppsPermissionsInfoErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppsPermissionsInfoErrorSchema(val *AppsPermissionsInfoErrorSchema) *NullableAppsPermissionsInfoErrorSchema {
	return &NullableAppsPermissionsInfoErrorSchema{value: val, isSet: true}
}

func (v NullableAppsPermissionsInfoErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppsPermissionsInfoErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
