...
type UsersSetActiveErrorSchema struct {
...
func NewUsersSetActiveErrorSchema(error_ string, ok DefsOkFalse) *UsersSetActiveErrorSchema {
	this := UsersSetActiveErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o UsersSetActiveErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableUsersSetActiveErrorSchema struct {
	value *UsersSetActiveErrorSchema
	isSet bool
}

func (v NullableUsersSetActiveErrorSchema) Get() *UsersSetActiveErrorSchema {
	return v.value
}

func (v *NullableUsersSetActiveErrorSchema) Set(val *UsersSetActiveErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableUsersSetActiveErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableUsersSetActiveErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsersSetActiveErrorSchema(val *UsersSetActiveErrorSchema) *NullableUsersSetActiveErrorSchema {
	return &NullableUsersSetActiveErrorSchema{value: val, isSet: true}
}

func (v NullableUsersSetActiveErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsersSetActiveErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
