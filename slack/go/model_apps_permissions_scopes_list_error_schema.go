...
type AppsPermissionsScopesListErrorSchema struct {
...
func NewAppsPermissionsScopesListErrorSchema(error_ string, ok DefsOkFalse) *AppsPermissionsScopesListErrorSchema {
	this := AppsPermissionsScopesListErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o AppsPermissionsScopesListErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableAppsPermissionsScopesListErrorSchema struct {
	value *AppsPermissionsScopesListErrorSchema
	isSet bool
}

func (v NullableAppsPermissionsScopesListErrorSchema) Get() *AppsPermissionsScopesListErrorSchema {
	return v.value
}

func (v *NullableAppsPermissionsScopesListErrorSchema) Set(val *AppsPermissionsScopesListErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableAppsPermissionsScopesListErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableAppsPermissionsScopesListErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppsPermissionsScopesListErrorSchema(val *AppsPermissionsScopesListErrorSchema) *NullableAppsPermissionsScopesListErrorSchema {
	return &NullableAppsPermissionsScopesListErrorSchema{value: val, isSet: true}
}

func (v NullableAppsPermissionsScopesListErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppsPermissionsScopesListErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
