...
type RemindersAddErrorSchema struct {
...
func (o RemindersAddErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableRemindersAddErrorSchema struct {
	value *RemindersAddErrorSchema
	isSet bool
}

func (v NullableRemindersAddErrorSchema) Get() *RemindersAddErrorSchema {
	return v.value
}

func (v *NullableRemindersAddErrorSchema) Set(val *RemindersAddErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableRemindersAddErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableRemindersAddErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemindersAddErrorSchema(val *RemindersAddErrorSchema) *NullableRemindersAddErrorSchema {
	return &NullableRemindersAddErrorSchema{value: val, isSet: true}
}

func (v NullableRemindersAddErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemindersAddErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
