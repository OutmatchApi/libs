...
type ApiOauthAccessRequest struct {
	ctx context.Context
...
func (r ApiOauthAccessRequest) ClientId(clientId string) ApiOauthAccessRequest {
	r.clientId = &clientId
	return r
}

// Issued when you created your application.
func (r ApiOauthAccessRequest) ClientSecret(clientSecret string) ApiOauthAccessRequest {
	r.clientSecret = &clientSecret
	return r
}

// The &#x60;code&#x60; param returned via the OAuth callback.
func (r ApiOauthAccessRequest) Code(code string) ApiOauthAccessRequest {
	r.code = &code
	return r
}

// This must match the originally submitted URI (if one was sent).
func (r ApiOauthAccessRequest) RedirectUri(redirectUri string) ApiOauthAccessRequest {
...
func (r ApiOauthAccessRequest) SingleChannel(singleChannel bool) ApiOauthAccessRequest {
	r.singleChannel = &singleChannel
	return r
}

func (r ApiOauthAccessRequest) Execute() (*DefaultSuccessTemplate, *http.Response, error) {
	return r.ApiService.OauthAccessExecute(r)
}

/*
OauthAccess Method for OauthAccess

Exchanges a temporary OAuth verifier code for an access token.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiOauthAccessRequest
*/
func (a *OauthApiService) OauthAccess(ctx context.Context) ApiOauthAccessRequest {
	return ApiOauthAccessRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OauthApiService) OauthAccessExecute(r ApiOauthAccessRequest) (*DefaultSuccessTemplate, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OauthApiService.OauthAccess")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/oauth.access"
	...
	if r.singleChannel != nil {
		localVarQueryParams.Add("single_channel", parameterToString(*r.singleChannel, ""))
	}
...
func (r ApiOauthTokenRequest) SingleChannel(singleChannel bool) ApiOauthTokenRequest {
	r.singleChannel = &singleChannel
	return r
}

func (r ApiOauthTokenRequest) Execute() (*DefaultSuccessTemplate, *http.Response, error) {
...
// Execute executes the request
//  @return DefaultSuccessTemplate
func (a *OauthApiService) OauthTokenExecute(r ApiOauthTokenRequest) (*DefaultSuccessTemplate, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *OauthApiService) OauthV2Access(ctx context.Context) ApiOauthV2AccessRequest {
	return ApiOauthV2AccessRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DefaultSuccessTemplate
func (a *OauthApiService) OauthV2AccessExecute(r ApiOauthV2AccessRequest) (*DefaultSuccessTemplate, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OauthApiService.OauthV2Access")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
