...
// AdminConversationsEkmApiService AdminConversationsEkmApi service
type AdminConversationsEkmApiService service

type ApiAdminConversationsEkmListOriginalConnectedChannelInfoRequest struct {
	ctx context.Context
	ApiService *AdminConversationsEkmApiService
	token *string
	channelIds *string
	teamIds *string
	limit *int32
...
*/
func (a *AdminConversationsEkmApiService) AdminConversationsEkmListOriginalConnectedChannelInfo(ctx context.Context) ApiAdminConversationsEkmListOriginalConnectedChannelInfoRequest {
	return ApiAdminConversationsEkmListOriginalConnectedChannelInfoRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AdminConversationsEkmApiService) AdminConversationsEkmListOriginalConnectedChannelInfoExecute(r ApiAdminConversationsEkmListOriginalConnectedChannelInfoRequest) (*DefaultSuccessTemplate, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminConversationsEkmApiService.AdminConversationsEkmListOriginalConnectedChannelInfo")
	if err != nil {
