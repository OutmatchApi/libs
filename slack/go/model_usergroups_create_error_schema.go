...
type UsergroupsCreateErrorSchema struct {
...
func NewUsergroupsCreateErrorSchema(error_ string, ok DefsOkFalse) *UsergroupsCreateErrorSchema {
	this := UsergroupsCreateErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o UsergroupsCreateErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableUsergroupsCreateErrorSchema struct {
	value *UsergroupsCreateErrorSchema
	isSet bool
}

func (v NullableUsergroupsCreateErrorSchema) Get() *UsergroupsCreateErrorSchema {
	return v.value
}

func (v *NullableUsergroupsCreateErrorSchema) Set(val *UsergroupsCreateErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableUsergroupsCreateErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableUsergroupsCreateErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsergroupsCreateErrorSchema(val *UsergroupsCreateErrorSchema) *NullableUsergroupsCreateErrorSchema {
	return &NullableUsergroupsCreateErrorSchema{value: val, isSet: true}
}

func (v NullableUsergroupsCreateErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsergroupsCreateErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
