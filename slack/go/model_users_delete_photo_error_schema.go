...
type UsersDeletePhotoErrorSchema struct {
...
func NewUsersDeletePhotoErrorSchema(error_ string, ok DefsOkFalse) *UsersDeletePhotoErrorSchema {
	this := UsersDeletePhotoErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o UsersDeletePhotoErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableUsersDeletePhotoErrorSchema struct {
	value *UsersDeletePhotoErrorSchema
	isSet bool
}

func (v NullableUsersDeletePhotoErrorSchema) Get() *UsersDeletePhotoErrorSchema {
	return v.value
}

func (v *NullableUsersDeletePhotoErrorSchema) Set(val *UsersDeletePhotoErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableUsersDeletePhotoErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableUsersDeletePhotoErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsersDeletePhotoErrorSchema(val *UsersDeletePhotoErrorSchema) *NullableUsersDeletePhotoErrorSchema {
	return &NullableUsersDeletePhotoErrorSchema{value: val, isSet: true}
}

func (v NullableUsersDeletePhotoErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsersDeletePhotoErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
