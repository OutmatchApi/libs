...
type FilesRevokePublicURLErrorSchema struct {
...
func NewFilesRevokePublicURLErrorSchema(error_ string, ok DefsOkFalse) *FilesRevokePublicURLErrorSchema {
	this := FilesRevokePublicURLErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o FilesRevokePublicURLErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableFilesRevokePublicURLErrorSchema struct {
	value *FilesRevokePublicURLErrorSchema
	isSet bool
}

func (v NullableFilesRevokePublicURLErrorSchema) Get() *FilesRevokePublicURLErrorSchema {
	return v.value
}

func (v *NullableFilesRevokePublicURLErrorSchema) Set(val *FilesRevokePublicURLErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableFilesRevokePublicURLErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableFilesRevokePublicURLErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFilesRevokePublicURLErrorSchema(val *FilesRevokePublicURLErrorSchema) *NullableFilesRevokePublicURLErrorSchema {
	return &NullableFilesRevokePublicURLErrorSchema{value: val, isSet: true}
}

func (v NullableFilesRevokePublicURLErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFilesRevokePublicURLErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
