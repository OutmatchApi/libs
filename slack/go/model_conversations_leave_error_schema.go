...
type ConversationsLeaveErrorSchema struct {
...
func NewConversationsLeaveErrorSchema(error_ string, ok DefsOkFalse) *ConversationsLeaveErrorSchema {
	this := ConversationsLeaveErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o ConversationsLeaveErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableConversationsLeaveErrorSchema struct {
	value *ConversationsLeaveErrorSchema
	isSet bool
}

func (v NullableConversationsLeaveErrorSchema) Get() *ConversationsLeaveErrorSchema {
	return v.value
}

func (v *NullableConversationsLeaveErrorSchema) Set(val *ConversationsLeaveErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableConversationsLeaveErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableConversationsLeaveErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConversationsLeaveErrorSchema(val *ConversationsLeaveErrorSchema) *NullableConversationsLeaveErrorSchema {
	return &NullableConversationsLeaveErrorSchema{value: val, isSet: true}
}

func (v NullableConversationsLeaveErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConversationsLeaveErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
