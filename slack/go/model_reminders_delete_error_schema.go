...
type RemindersDeleteErrorSchema struct {
...
func NewRemindersDeleteErrorSchema(error_ string, ok DefsOkFalse) *RemindersDeleteErrorSchema {
	this := RemindersDeleteErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o RemindersDeleteErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableRemindersDeleteErrorSchema struct {
	value *RemindersDeleteErrorSchema
	isSet bool
}

func (v NullableRemindersDeleteErrorSchema) Get() *RemindersDeleteErrorSchema {
	return v.value
}

func (v *NullableRemindersDeleteErrorSchema) Set(val *RemindersDeleteErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableRemindersDeleteErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableRemindersDeleteErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemindersDeleteErrorSchema(val *RemindersDeleteErrorSchema) *NullableRemindersDeleteErrorSchema {
	return &NullableRemindersDeleteErrorSchema{value: val, isSet: true}
}

func (v NullableRemindersDeleteErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemindersDeleteErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
