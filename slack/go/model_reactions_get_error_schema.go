...
type ReactionsGetErrorSchema struct {
...
func (o ReactionsGetErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableReactionsGetErrorSchema struct {
	value *ReactionsGetErrorSchema
	isSet bool
}

func (v NullableReactionsGetErrorSchema) Get() *ReactionsGetErrorSchema {
	return v.value
}

func (v *NullableReactionsGetErrorSchema) Set(val *ReactionsGetErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableReactionsGetErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableReactionsGetErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReactionsGetErrorSchema(val *ReactionsGetErrorSchema) *NullableReactionsGetErrorSchema {
	return &NullableReactionsGetErrorSchema{value: val, isSet: true}
}

func (v NullableReactionsGetErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReactionsGetErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
