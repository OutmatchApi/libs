...
// AppsPermissionsScopesApiService AppsPermissionsScopesApi service
type AppsPermissionsScopesApiService service

type ApiAppsPermissionsScopesListRequest struct {
	ctx context.Context
	ApiService *AppsPermissionsScopesApiService
	token *string
}
...
*/
func (a *AppsPermissionsScopesApiService) AppsPermissionsScopesList(ctx context.Context) ApiAppsPermissionsScopesListRequest {
	return ApiAppsPermissionsScopesListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AppsPermissionsScopesApiService) AppsPermissionsScopesListExecute(r ApiAppsPermissionsScopesListRequest) (*ApiPermissionsScopesListSuccessSchema, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AppsPermissionsScopesApiService.AppsPermissionsScopesList")
	if err != nil {
