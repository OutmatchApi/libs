...
type ChatPostMessageErrorSchema struct {
...
func NewChatPostMessageErrorSchema(error_ string, ok DefsOkFalse) *ChatPostMessageErrorSchema {
	this := ChatPostMessageErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o ChatPostMessageErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableChatPostMessageErrorSchema struct {
	value *ChatPostMessageErrorSchema
	isSet bool
}

func (v NullableChatPostMessageErrorSchema) Get() *ChatPostMessageErrorSchema {
	return v.value
}

func (v *NullableChatPostMessageErrorSchema) Set(val *ChatPostMessageErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableChatPostMessageErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableChatPostMessageErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChatPostMessageErrorSchema(val *ChatPostMessageErrorSchema) *NullableChatPostMessageErrorSchema {
	return &NullableChatPostMessageErrorSchema{value: val, isSet: true}
}

func (v NullableChatPostMessageErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChatPostMessageErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
