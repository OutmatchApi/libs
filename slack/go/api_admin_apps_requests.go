...
// AdminAppsRequestsApiService AdminAppsRequestsApi service
type AdminAppsRequestsApiService service

type ApiAdminAppsRequestsListRequest struct {
	ctx context.Context
	ApiService *AdminAppsRequestsApiService
	token *string
	limit *int32
	cursor *string
	teamId *string
...
*/
func (a *AdminAppsRequestsApiService) AdminAppsRequestsList(ctx context.Context) ApiAdminAppsRequestsListRequest {
	return ApiAdminAppsRequestsListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AdminAppsRequestsApiService) AdminAppsRequestsListExecute(r ApiAdminAppsRequestsListRequest) (*DefaultSuccessTemplate, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminAppsRequestsApiService.AdminAppsRequestsList")
	if err != nil {
