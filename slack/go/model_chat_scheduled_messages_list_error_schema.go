...
type ChatScheduledMessagesListErrorSchema struct {
...
func NewChatScheduledMessagesListErrorSchema(error_ string, ok DefsOkFalse) *ChatScheduledMessagesListErrorSchema {
	this := ChatScheduledMessagesListErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o ChatScheduledMessagesListErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableChatScheduledMessagesListErrorSchema struct {
	value *ChatScheduledMessagesListErrorSchema
	isSet bool
}

func (v NullableChatScheduledMessagesListErrorSchema) Get() *ChatScheduledMessagesListErrorSchema {
	return v.value
}

func (v *NullableChatScheduledMessagesListErrorSchema) Set(val *ChatScheduledMessagesListErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableChatScheduledMessagesListErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableChatScheduledMessagesListErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChatScheduledMessagesListErrorSchema(val *ChatScheduledMessagesListErrorSchema) *NullableChatScheduledMessagesListErrorSchema {
	return &NullableChatScheduledMessagesListErrorSchema{value: val, isSet: true}
}

func (v NullableChatScheduledMessagesListErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChatScheduledMessagesListErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
