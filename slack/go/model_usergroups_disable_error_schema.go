...
type UsergroupsDisableErrorSchema struct {
...
func NewUsergroupsDisableErrorSchema(error_ string, ok DefsOkFalse) *UsergroupsDisableErrorSchema {
	this := UsergroupsDisableErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o UsergroupsDisableErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableUsergroupsDisableErrorSchema struct {
	value *UsergroupsDisableErrorSchema
	isSet bool
}

func (v NullableUsergroupsDisableErrorSchema) Get() *UsergroupsDisableErrorSchema {
	return v.value
}

func (v *NullableUsergroupsDisableErrorSchema) Set(val *UsergroupsDisableErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableUsergroupsDisableErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableUsergroupsDisableErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsergroupsDisableErrorSchema(val *UsergroupsDisableErrorSchema) *NullableUsergroupsDisableErrorSchema {
	return &NullableUsergroupsDisableErrorSchema{value: val, isSet: true}
}

func (v NullableUsergroupsDisableErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsergroupsDisableErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
