...
type ReactionsRemoveErrorSchema struct {
...
func NewReactionsRemoveErrorSchema(error_ string, ok DefsOkFalse) *ReactionsRemoveErrorSchema {
	this := ReactionsRemoveErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o ReactionsRemoveErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableReactionsRemoveErrorSchema struct {
	value *ReactionsRemoveErrorSchema
	isSet bool
}

func (v NullableReactionsRemoveErrorSchema) Get() *ReactionsRemoveErrorSchema {
	return v.value
}

func (v *NullableReactionsRemoveErrorSchema) Set(val *ReactionsRemoveErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableReactionsRemoveErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableReactionsRemoveErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReactionsRemoveErrorSchema(val *ReactionsRemoveErrorSchema) *NullableReactionsRemoveErrorSchema {
	return &NullableReactionsRemoveErrorSchema{value: val, isSet: true}
}

func (v NullableReactionsRemoveErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReactionsRemoveErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
