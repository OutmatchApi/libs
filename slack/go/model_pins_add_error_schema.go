...
type PinsAddErrorSchema struct {
...
func (o PinsAddErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullablePinsAddErrorSchema struct {
	value *PinsAddErrorSchema
	isSet bool
}

func (v NullablePinsAddErrorSchema) Get() *PinsAddErrorSchema {
	return v.value
}

func (v *NullablePinsAddErrorSchema) Set(val *PinsAddErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullablePinsAddErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullablePinsAddErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePinsAddErrorSchema(val *PinsAddErrorSchema) *NullablePinsAddErrorSchema {
	return &NullablePinsAddErrorSchema{value: val, isSet: true}
}

func (v NullablePinsAddErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePinsAddErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
