...
type TeamInfoErrorSchema struct {
...
func (o TeamInfoErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableTeamInfoErrorSchema struct {
	value *TeamInfoErrorSchema
	isSet bool
}

func (v NullableTeamInfoErrorSchema) Get() *TeamInfoErrorSchema {
	return v.value
}

func (v *NullableTeamInfoErrorSchema) Set(val *TeamInfoErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamInfoErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamInfoErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamInfoErrorSchema(val *TeamInfoErrorSchema) *NullableTeamInfoErrorSchema {
	return &NullableTeamInfoErrorSchema{value: val, isSet: true}
}

func (v NullableTeamInfoErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamInfoErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
