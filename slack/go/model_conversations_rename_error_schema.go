...
type ConversationsRenameErrorSchema struct {
...
func NewConversationsRenameErrorSchema(error_ string, ok DefsOkFalse) *ConversationsRenameErrorSchema {
	this := ConversationsRenameErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o ConversationsRenameErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableConversationsRenameErrorSchema struct {
	value *ConversationsRenameErrorSchema
	isSet bool
}

func (v NullableConversationsRenameErrorSchema) Get() *ConversationsRenameErrorSchema {
	return v.value
}

func (v *NullableConversationsRenameErrorSchema) Set(val *ConversationsRenameErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableConversationsRenameErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableConversationsRenameErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConversationsRenameErrorSchema(val *ConversationsRenameErrorSchema) *NullableConversationsRenameErrorSchema {
	return &NullableConversationsRenameErrorSchema{value: val, isSet: true}
}

func (v NullableConversationsRenameErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConversationsRenameErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
