...
type UsersSetPresenceErrorSchema struct {
...
func NewUsersSetPresenceErrorSchema(error_ string, ok DefsOkFalse) *UsersSetPresenceErrorSchema {
	this := UsersSetPresenceErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o UsersSetPresenceErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableUsersSetPresenceErrorSchema struct {
	value *UsersSetPresenceErrorSchema
	isSet bool
}

func (v NullableUsersSetPresenceErrorSchema) Get() *UsersSetPresenceErrorSchema {
	return v.value
}

func (v *NullableUsersSetPresenceErrorSchema) Set(val *UsersSetPresenceErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableUsersSetPresenceErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableUsersSetPresenceErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsersSetPresenceErrorSchema(val *UsersSetPresenceErrorSchema) *NullableUsersSetPresenceErrorSchema {
	return &NullableUsersSetPresenceErrorSchema{value: val, isSet: true}
}

func (v NullableUsersSetPresenceErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsersSetPresenceErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
