...
type ChatDeleteErrorSchema struct {
...
func (o ChatDeleteErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableChatDeleteErrorSchema struct {
	value *ChatDeleteErrorSchema
	isSet bool
}

func (v NullableChatDeleteErrorSchema) Get() *ChatDeleteErrorSchema {
	return v.value
}

func (v *NullableChatDeleteErrorSchema) Set(val *ChatDeleteErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableChatDeleteErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableChatDeleteErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChatDeleteErrorSchema(val *ChatDeleteErrorSchema) *NullableChatDeleteErrorSchema {
	return &NullableChatDeleteErrorSchema{value: val, isSet: true}
}

func (v NullableChatDeleteErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChatDeleteErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
