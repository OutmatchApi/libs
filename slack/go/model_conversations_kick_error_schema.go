...
func NewConversationsKickErrorSchema(error_ string, ok DefsOkFalse) *ConversationsKickErrorSchema {
	this := ConversationsKickErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o ConversationsKickErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableConversationsKickErrorSchema struct {
	value *ConversationsKickErrorSchema
	isSet bool
}

func (v NullableConversationsKickErrorSchema) Get() *ConversationsKickErrorSchema {
	return v.value
}

func (v *NullableConversationsKickErrorSchema) Set(val *ConversationsKickErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableConversationsKickErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableConversationsKickErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConversationsKickErrorSchema(val *ConversationsKickErrorSchema) *NullableConversationsKickErrorSchema {
	return &NullableConversationsKickErrorSchema{value: val, isSet: true}
}

func (v NullableConversationsKickErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConversationsKickErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
