...
type FilesUploadErrorSchema struct {
...
func (o FilesUploadErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableFilesUploadErrorSchema struct {
	value *FilesUploadErrorSchema
	isSet bool
}

func (v NullableFilesUploadErrorSchema) Get() *FilesUploadErrorSchema {
	return v.value
}

func (v *NullableFilesUploadErrorSchema) Set(val *FilesUploadErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableFilesUploadErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableFilesUploadErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFilesUploadErrorSchema(val *FilesUploadErrorSchema) *NullableFilesUploadErrorSchema {
	return &NullableFilesUploadErrorSchema{value: val, isSet: true}
}

func (v NullableFilesUploadErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFilesUploadErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
