...
type AppsUninstallErrorSchema struct {
...
func (o AppsUninstallErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableAppsUninstallErrorSchema struct {
	value *AppsUninstallErrorSchema
	isSet bool
}

func (v NullableAppsUninstallErrorSchema) Get() *AppsUninstallErrorSchema {
	return v.value
}

func (v *NullableAppsUninstallErrorSchema) Set(val *AppsUninstallErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableAppsUninstallErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableAppsUninstallErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppsUninstallErrorSchema(val *AppsUninstallErrorSchema) *NullableAppsUninstallErrorSchema {
	return &NullableAppsUninstallErrorSchema{value: val, isSet: true}
}

func (v NullableAppsUninstallErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppsUninstallErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
