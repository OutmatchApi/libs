...
type UsergroupsUpdateErrorSchema struct {
...
func NewUsergroupsUpdateErrorSchema(error_ string, ok DefsOkFalse) *UsergroupsUpdateErrorSchema {
	this := UsergroupsUpdateErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o UsergroupsUpdateErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableUsergroupsUpdateErrorSchema struct {
	value *UsergroupsUpdateErrorSchema
	isSet bool
}

func (v NullableUsergroupsUpdateErrorSchema) Get() *UsergroupsUpdateErrorSchema {
	return v.value
}

func (v *NullableUsergroupsUpdateErrorSchema) Set(val *UsergroupsUpdateErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableUsergroupsUpdateErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableUsergroupsUpdateErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsergroupsUpdateErrorSchema(val *UsergroupsUpdateErrorSchema) *NullableUsergroupsUpdateErrorSchema {
	return &NullableUsergroupsUpdateErrorSchema{value: val, isSet: true}
}

func (v NullableUsergroupsUpdateErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsergroupsUpdateErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
