...
type StarsListErrorSchema struct {
...
func (o StarsListErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableStarsListErrorSchema struct {
	value *StarsListErrorSchema
	isSet bool
}

func (v NullableStarsListErrorSchema) Get() *StarsListErrorSchema {
	return v.value
}

func (v *NullableStarsListErrorSchema) Set(val *StarsListErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableStarsListErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableStarsListErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStarsListErrorSchema(val *StarsListErrorSchema) *NullableStarsListErrorSchema {
	return &NullableStarsListErrorSchema{value: val, isSet: true}
}

func (v NullableStarsListErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStarsListErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
