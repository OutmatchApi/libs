...
type FilesSharedPublicURLErrorSchema struct {
...
func NewFilesSharedPublicURLErrorSchema(error_ string, ok DefsOkFalse) *FilesSharedPublicURLErrorSchema {
	this := FilesSharedPublicURLErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o FilesSharedPublicURLErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableFilesSharedPublicURLErrorSchema struct {
	value *FilesSharedPublicURLErrorSchema
	isSet bool
}

func (v NullableFilesSharedPublicURLErrorSchema) Get() *FilesSharedPublicURLErrorSchema {
	return v.value
}

func (v *NullableFilesSharedPublicURLErrorSchema) Set(val *FilesSharedPublicURLErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableFilesSharedPublicURLErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableFilesSharedPublicURLErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFilesSharedPublicURLErrorSchema(val *FilesSharedPublicURLErrorSchema) *NullableFilesSharedPublicURLErrorSchema {
	return &NullableFilesSharedPublicURLErrorSchema{value: val, isSet: true}
}

func (v NullableFilesSharedPublicURLErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFilesSharedPublicURLErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
