...
// AppsPermissionsUsersApiService AppsPermissionsUsersApi service
type AppsPermissionsUsersApiService service

type ApiAppsPermissionsUsersListRequest struct {
	ctx context.Context
	ApiService *AppsPermissionsUsersApiService
	token *string
	cursor *string
	limit *int32
}
...
*/
func (a *AppsPermissionsUsersApiService) AppsPermissionsUsersList(ctx context.Context) ApiAppsPermissionsUsersListRequest {
	return ApiAppsPermissionsUsersListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AppsPermissionsUsersApiService) AppsPermissionsUsersListExecute(r ApiAppsPermissionsUsersListRequest) (*DefaultSuccessTemplate, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AppsPermissionsUsersApiService.AppsPermissionsUsersList")
	if err != nil {
...
*/
func (a *AppsPermissionsUsersApiService) AppsPermissionsUsersRequest(ctx context.Context) ApiAppsPermissionsUsersRequestRequest {
	return ApiAppsPermissionsUsersRequestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DefaultSuccessTemplate
func (a *AppsPermissionsUsersApiService) AppsPermissionsUsersRequestExecute(r ApiAppsPermissionsUsersRequestRequest) (*DefaultSuccessTemplate, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AppsPermissionsUsersApiService.AppsPermissionsUsersRequest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
