...
type TeamProfileGetErrorSchema struct {
...
func NewTeamProfileGetErrorSchema(error_ string, ok DefsOkFalse) *TeamProfileGetErrorSchema {
	this := TeamProfileGetErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o TeamProfileGetErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableTeamProfileGetErrorSchema struct {
	value *TeamProfileGetErrorSchema
	isSet bool
}

func (v NullableTeamProfileGetErrorSchema) Get() *TeamProfileGetErrorSchema {
	return v.value
}

func (v *NullableTeamProfileGetErrorSchema) Set(val *TeamProfileGetErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamProfileGetErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamProfileGetErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamProfileGetErrorSchema(val *TeamProfileGetErrorSchema) *NullableTeamProfileGetErrorSchema {
	return &NullableTeamProfileGetErrorSchema{value: val, isSet: true}
}

func (v NullableTeamProfileGetErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamProfileGetErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
