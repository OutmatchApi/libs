...
type RemindersInfoErrorSchema struct {
...
func (o RemindersInfoErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableRemindersInfoErrorSchema struct {
	value *RemindersInfoErrorSchema
	isSet bool
}

func (v NullableRemindersInfoErrorSchema) Get() *RemindersInfoErrorSchema {
	return v.value
}

func (v *NullableRemindersInfoErrorSchema) Set(val *RemindersInfoErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableRemindersInfoErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableRemindersInfoErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemindersInfoErrorSchema(val *RemindersInfoErrorSchema) *NullableRemindersInfoErrorSchema {
	return &NullableRemindersInfoErrorSchema{value: val, isSet: true}
}

func (v NullableRemindersInfoErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemindersInfoErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
