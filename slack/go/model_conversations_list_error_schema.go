...
type ConversationsListErrorSchema struct {
...
func NewConversationsListErrorSchema(error_ string, ok DefsOkFalse) *ConversationsListErrorSchema {
	this := ConversationsListErrorSchema{}
	this.Error = error_
	this.Ok = ok
	return &this
}
...
func (o ConversationsListErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableConversationsListErrorSchema struct {
	value *ConversationsListErrorSchema
	isSet bool
}

func (v NullableConversationsListErrorSchema) Get() *ConversationsListErrorSchema {
	return v.value
}

func (v *NullableConversationsListErrorSchema) Set(val *ConversationsListErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableConversationsListErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableConversationsListErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConversationsListErrorSchema(val *ConversationsListErrorSchema) *NullableConversationsListErrorSchema {
	return &NullableConversationsListErrorSchema{value: val, isSet: true}
}

func (v NullableConversationsListErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConversationsListErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
