...
type RtmConnectErrorSchema struct {
...
func (o RtmConnectErrorSchema) MarshalJSON() ([]byte, error) {
...
type NullableRtmConnectErrorSchema struct {
	value *RtmConnectErrorSchema
	isSet bool
}

func (v NullableRtmConnectErrorSchema) Get() *RtmConnectErrorSchema {
	return v.value
}

func (v *NullableRtmConnectErrorSchema) Set(val *RtmConnectErrorSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableRtmConnectErrorSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableRtmConnectErrorSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRtmConnectErrorSchema(val *RtmConnectErrorSchema) *NullableRtmConnectErrorSchema {
	return &NullableRtmConnectErrorSchema{value: val, isSet: true}
}

func (v NullableRtmConnectErrorSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRtmConnectErrorSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
