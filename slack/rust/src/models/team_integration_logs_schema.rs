...
pub struct TeamIntegrationLogsSchema {
    #[serde(rename = "logs")]
    pub logs: Vec<crate::models::TeamIntegrationLogsSchemaLogsInner>,
    #[serde(rename = "ok")]
...
impl TeamIntegrationLogsSchema {
    ...
    pub fn new(logs: Vec<crate::models::TeamIntegrationLogsSchemaLogsInner>, ok: crate::models::DefsOkTrue, paging: crate::models::ObjsPaging) -> TeamIntegrationLogsSchema {
