...
pub struct StarsListSchema {
    #[serde(rename = "items")]
    pub items: Vec<Vec<crate::models::StarsListSchemaItemsInnerInner>>,
    #[serde(rename = "ok")]
...
impl StarsListSchema {
    ...
    pub fn new(items: Vec<Vec<crate::models::StarsListSchemaItemsInnerInner>>, ok: crate::models::DefsOkTrue) -> StarsListSchema {
        StarsListSchema {
            items,
            ok,
            paging: None,
