...
pub struct ConversationsRepliesSuccessSchema {
    ...
    pub messages: Vec<Vec<crate::models::ConversationsRepliesSuccessSchemaMessagesInnerInner>>,
    #[serde(rename = "ok")]
...
impl ConversationsRepliesSuccessSchema {
    ...
    pub fn new(messages: Vec<Vec<crate::models::ConversationsRepliesSuccessSchemaMessagesInnerInner>>, ok: crate::models::DefsOkTrue) -> ConversationsRepliesSuccessSchema {
