...
pub struct ChatScheduledMessagesListSchema {
    ...
    pub scheduled_messages: Vec<crate::models::ChatScheduledMessagesListSchemaScheduledMessagesInner>,
}

impl ChatScheduledMessagesListSchema {
    /// Schema for successful response from chat.scheduledMessages.list method
    pub fn new(ok: crate::models::DefsOkTrue, response_metadata: crate::models::AdminConversationsGetTeamsSchemaResponseMetadata, scheduled_messages: Vec<crate::models::ChatScheduledMessagesListSchemaScheduledMessagesInner>) -> ChatScheduledMessagesListSchema {
