...
pub struct ObjsChannelLatestInner {
    #[serde(rename = "attachments", skip_serializing_if = "Option::is_none")]
    pub attachments: Option<Vec<crate::models::ObjsMessageAttachmentsInner>>,
    ...
    pub blocks: Option<Vec<crate::models::BlocksInner>>,
    #[serde(rename = "bot_id", skip_serializing_if = "Option::is_none")]
    pub bot_id: Option<Vec<crate::models::ObjsMessageBotIdInner>>,
...
impl ObjsChannelLatestInner {
    pub fn new(text: String, ts: String, r#type: String) -> ObjsChannelLatestInner {
