...
pub struct FilesInfoSchema {
    ...
    #[serde(rename = "content_html", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub content_html: Option<Option<serde_json::Value>>,
