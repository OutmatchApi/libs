...
pub struct ConversationsHistorySuccessSchema {
    ...
    pub channel_actions_ts: Vec<crate::models::ConversationsHistorySuccessSchemaChannelActionsTsInner>,
...
impl ConversationsHistorySuccessSchema {
    ...
    pub fn new(channel_actions_count: i32, channel_actions_ts: Vec<crate::models::ConversationsHistorySuccessSchemaChannelActionsTsInner>, has_more: bool, messages: Vec<crate::models::ObjsMessage>, ok: crate::models::DefsOkTrue, pin_count: i32) -> ConversationsHistorySuccessSchema {
