...
pub struct ObjsUserInnerAnyOf1 {
...
impl ObjsUserInnerAnyOf1 {
    /// enterprise user
    pub fn new(id: String, is_app_user: bool, is_bot: bool, name: String, profile: crate::models::ObjsUserProfile, updated: f32) -> ObjsUserInnerAnyOf1 {
        ObjsUserInnerAnyOf1 {
            color: None,
            deleted: None,
