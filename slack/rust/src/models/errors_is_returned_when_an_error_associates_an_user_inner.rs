...
pub struct ErrorsIsReturnedWhenAnErrorAssociatesAnUserInner {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl ErrorsIsReturnedWhenAnErrorAssociatesAnUserInner {
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ErrorsIsReturnedWhenAnErrorAssociatesAnUserInner {
