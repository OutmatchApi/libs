...
pub struct ConversationsOpenSuccessSchemaChannelInnerAnyOf {
    ...
    pub latest: Option<Box<crate::models::ObjsMessage>>,
...
impl ConversationsOpenSuccessSchemaChannelInnerAnyOf {
    pub fn new(id: String) -> ConversationsOpenSuccessSchemaChannelInnerAnyOf {
