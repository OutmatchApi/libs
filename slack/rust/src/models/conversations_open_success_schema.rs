...
pub struct ConversationsOpenSuccessSchema {
    ...
    pub channel: Vec<crate::models::ConversationsOpenSuccessSchemaChannelInner>,
...
impl ConversationsOpenSuccessSchema {
    ...
    pub fn new(channel: Vec<crate::models::ConversationsOpenSuccessSchemaChannelInner>, ok: crate::models::DefsOkTrue) -> ConversationsOpenSuccessSchema {
