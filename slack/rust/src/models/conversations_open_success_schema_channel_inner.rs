...
pub struct ConversationsOpenSuccessSchemaChannelInner {
...
impl ConversationsOpenSuccessSchemaChannelInner {
    pub fn new(id: String) -> ConversationsOpenSuccessSchemaChannelInner {
