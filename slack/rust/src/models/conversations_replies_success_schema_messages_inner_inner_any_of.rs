...
pub struct ConversationsRepliesSuccessSchemaMessagesInnerInnerAnyOf {
...
impl ConversationsRepliesSuccessSchemaMessagesInnerInnerAnyOf {
    pub fn new(reply_count: i32, subscribed: bool, text: String, thread_ts: String, ts: String, r#type: String, user: String) -> ConversationsRepliesSuccessSchemaMessagesInnerInnerAnyOf {
