...
pub struct ObjsConversationInner {
    ...
    pub display_counts: Option<Box<crate::models::ConversationObjectDisplayCounts>>,
...
impl ObjsConversationInner {
    pub fn new(created: i32, creator: String, id: String, is_archived: bool, is_channel: bool, is_general: bool, is_group: bool, is_im: bool, is_mpim: IsMpim, is_org_shared: bool, is_private: bool, is_shared: bool, name: String, name_normalized: String, priority: f32, purpose: crate::models::ObjsChannelPurpose, topic: crate::models::ObjsChannelPurpose, user: String) -> ObjsConversationInner {
