...
/// struct for passing parameters to the method [`auth_revoke`]
...
/// struct for passing parameters to the method [`auth_test`]
#[derive(Clone, Debug, Default)]
...
/// Revokes a token.
pub async fn auth_revoke(configuration: &configuration::Configuration, params: AuthRevokeParams) -> Result<crate::models::AuthRevokeSchema, Error<AuthRevokeError>> {
...
pub async fn auth_test(configuration: &configuration::Configuration, params: AuthTestParams) -> Result<crate::models::AuthTestSuccessSchema, Error<AuthTestError>> {
    let local_var_configuration = configuration;
