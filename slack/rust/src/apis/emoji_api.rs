...
pub async fn emoji_list(configuration: &configuration::Configuration, params: EmojiListParams) -> Result<crate::models::DefaultSuccessTemplate, Error<EmojiListError>> {
    ...
    let local_var_uri_str = format!("{}/emoji.list", local_var_configuration.base_path);
