        ...
        class items(
            ...
            class MetaOapg:
                ...
                class any_of_1(
                    ...
                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["warnings"], typing_extensions.Literal["messages"], ]):
                        # dict_instance[name] accessor
                        return super().__getitem__(name)
                    ...
                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["warnings"], typing_extensions.Literal["messages"], ]):
                        return super().get_item_oapg(name)
                ...
                class any_of_2(
                    ...
                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["next_cursor"], typing_extensions.Literal["warnings"], typing_extensions.Literal["messages"], ]):
                        # dict_instance[name] accessor
                        return super().__getitem__(name)
                    ...
                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["next_cursor"], typing_extensions.Literal["warnings"], typing_extensions.Literal["messages"], ]):
                        return super().get_item_oapg(name)
