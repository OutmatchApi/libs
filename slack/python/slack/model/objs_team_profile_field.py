...
class ObjsTeamProfileField(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class id(
                ...
                class MetaOapg:
                    regex=[{
                        'pattern': r'^X[a-zA-Z0-9]{9,}$',  # noqa: E501
                    }]
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["possible_values"]) -> MetaOapg.properties.possible_values: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ordering"], typing_extensions.Literal["hint"], typing_extensions.Literal["id"], typing_extensions.Literal["label"], typing_extensions.Literal["type"], typing_extensions.Literal["field_name"], typing_extensions.Literal["is_hidden"], typing_extensions.Literal["options"], typing_extensions.Literal["possible_values"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["possible_values"]) -> typing.Union[MetaOapg.properties.possible_values, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        possible_values: typing.Union[MetaOapg.properties.possible_values, list, tuple, None, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
