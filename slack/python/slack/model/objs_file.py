...
class ObjsFile(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class shares(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["private"], typing_extensions.Literal["public"], ]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["private"], typing_extensions.Literal["public"], ]):
                    return super().get_item_oapg(name)
            
                def __new__(
                    cls,
                    *args: typing.Union[dict, frozendict.frozendict, ],
                    private: typing.Union[MetaOapg.properties.private, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                    public: typing.Union[MetaOapg.properties.public, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'shares':
                    return super().__new__(
                        cls,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channels"], typing_extensions.Literal["comments_count"], typing_extensions.Literal["created"], typing_extensions.Literal["date_delete"], typing_extensions.Literal["display_as_bot"], typing_extensions.Literal["editable"], typing_extensions.Literal["editor"], typing_extensions.Literal["external_id"], typing_extensions.Literal["external_type"], typing_extensions.Literal["external_url"], typing_extensions.Literal["filetype"], typing_extensions.Literal["groups"], typing_extensions.Literal["has_rich_preview"], typing_extensions.Literal["id"], typing_extensions.Literal["image_exif_rotation"], typing_extensions.Literal["ims"], typing_extensions.Literal["is_external"], typing_extensions.Literal["is_public"], typing_extensions.Literal["is_starred"], typing_extensions.Literal["is_tombstoned"], typing_extensions.Literal["last_editor"], typing_extensions.Literal["mimetype"], typing_extensions.Literal["mode"], typing_extensions.Literal["name"], typing_extensions.Literal["non_owner_editable"], typing_extensions.Literal["num_stars"], typing_extensions.Literal["original_h"], typing_extensions.Literal["original_w"], typing_extensions.Literal["permalink"], typing_extensions.Literal["permalink_public"], typing_extensions.Literal["pinned_info"], typing_extensions.Literal["pinned_to"], typing_extensions.Literal["pretty_type"], typing_extensions.Literal["preview"], typing_extensions.Literal["public_url_shared"], typing_extensions.Literal["reactions"], typing_extensions.Literal["shares"], typing_extensions.Literal["size"], typing_extensions.Literal["source_team"], typing_extensions.Literal["state"], typing_extensions.Literal["thumb_1024"], typing_extensions.Literal["thumb_1024_h"], typing_extensions.Literal["thumb_1024_w"], typing_extensions.Literal["thumb_160"], typing_extensions.Literal["thumb_360"], typing_extensions.Literal["thumb_360_h"], typing_extensions.Literal["thumb_360_w"], typing_extensions.Literal["thumb_480"], typing_extensions.Literal["thumb_480_h"], typing_extensions.Literal["thumb_480_w"], typing_extensions.Literal["thumb_64"], typing_extensions.Literal["thumb_720"], typing_extensions.Literal["thumb_720_h"], typing_extensions.Literal["thumb_720_w"], typing_extensions.Literal["thumb_80"], typing_extensions.Literal["thumb_800"], typing_extensions.Literal["thumb_800_h"], typing_extensions.Literal["thumb_800_w"], typing_extensions.Literal["thumb_960"], typing_extensions.Literal["thumb_960_h"], typing_extensions.Literal["thumb_960_w"], typing_extensions.Literal["thumb_tiny"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["title"], typing_extensions.Literal["updated"], typing_extensions.Literal["url_private"], typing_extensions.Literal["url_private_download"], typing_extensions.Literal["user"], typing_extensions.Literal["user_team"], typing_extensions.Literal["username"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        shares: typing.Union[MetaOapg.properties.shares, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
