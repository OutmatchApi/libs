...
class ObjsTeam(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sso_provider"]) -> MetaOapg.properties.sso_provider: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["domain"], typing_extensions.Literal["icon"], typing_extensions.Literal["name"], typing_extensions.Literal["email_domain"], typing_extensions.Literal["id"], typing_extensions.Literal["archived"], typing_extensions.Literal["avatar_base_url"], typing_extensions.Literal["created"], typing_extensions.Literal["date_create"], typing_extensions.Literal["deleted"], typing_extensions.Literal["description"], typing_extensions.Literal["discoverable"], typing_extensions.Literal["enterprise_id"], typing_extensions.Literal["enterprise_name"], typing_extensions.Literal["external_org_migrations"], typing_extensions.Literal["has_compliance_export"], typing_extensions.Literal["is_assigned"], typing_extensions.Literal["is_enterprise"], typing_extensions.Literal["is_over_storage_limit"], typing_extensions.Literal["limit_ts"], typing_extensions.Literal["locale"], typing_extensions.Literal["messages_count"], typing_extensions.Literal["msg_edit_window_mins"], typing_extensions.Literal["over_integrations_limit"], typing_extensions.Literal["over_storage_limit"], typing_extensions.Literal["pay_prod_cur"], typing_extensions.Literal["plan"], typing_extensions.Literal["primary_owner"], typing_extensions.Literal["sso_provider"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sso_provider"]) -> typing.Union[MetaOapg.properties.sso_provider, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        sso_provider: typing.Union[MetaOapg.properties.sso_provider, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ObjsTeam':
        return super().__new__(
            cls,
