...
class ObjsComment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created"], typing_extensions.Literal["is_intro"], typing_extensions.Literal["comment"], typing_extensions.Literal["id"], typing_extensions.Literal["user"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["is_starred"], typing_extensions.Literal["num_stars"], typing_extensions.Literal["pinned_info"], typing_extensions.Literal["pinned_to"], typing_extensions.Literal["reactions"], ]):
