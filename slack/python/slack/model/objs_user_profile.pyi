...
class ObjsUserProfile(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status_emoji"], typing_extensions.Literal["skype"], typing_extensions.Literal["phone"], typing_extensions.Literal["real_name_normalized"], typing_extensions.Literal["real_name"], typing_extensions.Literal["status_text"], typing_extensions.Literal["avatar_hash"], typing_extensions.Literal["display_name"], typing_extensions.Literal["fields"], typing_extensions.Literal["title"], typing_extensions.Literal["display_name_normalized"], typing_extensions.Literal["always_active"], typing_extensions.Literal["api_app_id"], typing_extensions.Literal["bot_id"], typing_extensions.Literal["email"], typing_extensions.Literal["first_name"], typing_extensions.Literal["guest_expiration_ts"], typing_extensions.Literal["guest_invited_by"], typing_extensions.Literal["image_1024"], typing_extensions.Literal["image_192"], typing_extensions.Literal["image_24"], typing_extensions.Literal["image_32"], typing_extensions.Literal["image_48"], typing_extensions.Literal["image_512"], typing_extensions.Literal["image_72"], typing_extensions.Literal["image_original"], typing_extensions.Literal["is_app_user"], typing_extensions.Literal["is_custom_image"], typing_extensions.Literal["is_restricted"], typing_extensions.Literal["is_ultra_restricted"], typing_extensions.Literal["last_avatar_image_hash"], typing_extensions.Literal["last_name"], typing_extensions.Literal["memberships_count"], typing_extensions.Literal["name"], typing_extensions.Literal["pronouns"], typing_extensions.Literal["status_default_emoji"], typing_extensions.Literal["status_default_text"], typing_extensions.Literal["status_default_text_canonical"], typing_extensions.Literal["status_expiration"], typing_extensions.Literal["status_text_canonical"], typing_extensions.Literal["team"], typing_extensions.Literal["updated"], typing_extensions.Literal["user_id"], typing_extensions.Literal["username"], ]):
