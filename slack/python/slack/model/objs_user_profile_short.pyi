...
class ObjsUserProfileShort(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["is_ultra_restricted"], typing_extensions.Literal["is_restricted"], typing_extensions.Literal["name"], typing_extensions.Literal["real_name"], typing_extensions.Literal["team"], typing_extensions.Literal["avatar_hash"], typing_extensions.Literal["display_name"], typing_extensions.Literal["image_72"], typing_extensions.Literal["first_name"], typing_extensions.Literal["display_name_normalized"], typing_extensions.Literal["real_name_normalized"], ]):
