...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["desktop_app_join_url", "id", "join_url", "title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["desktop_app_join_url", "id", "join_url", "title", ], str]):
...
class CallsUpdate(BaseApi):
    ...
    def calls_update(
        ...
        return self._calls_update_oapg(
            body=body,
