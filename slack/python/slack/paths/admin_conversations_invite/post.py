    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def USER_MUST_BE_ADMIN(cls):
                    return cls("user_must_be_admin")
                
                @schemas.classproperty
                def FAILED_FOR_SOME_USERS(cls):
                    return cls("failed_for_some_users")
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_conversations_invite_oapg(
        self,
...
class AdminConversationsInvite(BaseApi):
    ...
    def admin_conversations_invite(
        ...
        return self._admin_conversations_invite_oapg(
            body=body,
