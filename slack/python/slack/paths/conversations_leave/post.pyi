...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ok"], typing_extensions.Literal["not_in_channel"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ok"], typing_extensions.Literal["not_in_channel"], ]):
        return super().get_item_oapg(name)
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def CANT_LEAVE_GENERAL(cls):
                    return cls("cant_leave_general")
...
class ConversationsLeave(BaseApi):
    ...
    def conversations_leave(
        ...
        return self._conversations_leave_oapg(
            body=body,
