...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["is_private", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["is_private", "name", ], str]):
...
class SchemaFor0ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def NO_CHANNEL(cls):
                    return cls("no_channel")
                
                @schemas.classproperty
                def INVALID_NAME_REQUIRED(cls):
                    return cls("invalid_name_required")
                
                @schemas.classproperty
                def INVALID_NAME_PUNCTUATION(cls):
                    return cls("invalid_name_punctuation")
                
                @schemas.classproperty
                def INVALID_NAME_MAXLENGTH(cls):
                    return cls("invalid_name_maxlength")
                
                @schemas.classproperty
                def INVALID_NAME_SPECIALS(cls):
                    return cls("invalid_name_specials")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["error"], typing_extensions.Literal["ok"], typing_extensions.Literal["callstack"], typing_extensions.Literal["detail"], typing_extensions.Literal["needed"], typing_extensions.Literal["provided"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["error"], typing_extensions.Literal["ok"], typing_extensions.Literal["callstack"], typing_extensions.Literal["detail"], typing_extensions.Literal["needed"], typing_extensions.Literal["provided"], ]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _conversations_create_oapg(
        self,
...
class ConversationsCreate(BaseApi):
    ...
    def conversations_create(
        ...
        return self._conversations_create_oapg(
            body=body,
