...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["reminders"], typing_extensions.Literal["ok"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["reminders"], typing_extensions.Literal["ok"], ]):
...
class RemindersList(BaseApi):
    ...
    def reminders_list(
        ...
        return self._reminders_list_oapg(
