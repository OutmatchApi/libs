...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel", "topic", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel", "topic", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _conversations_set_topic_oapg(
        self,
...
class ConversationsSetTopic(BaseApi):
    ...
    def conversations_set_topic(
        ...
        return self._conversations_set_topic_oapg(
            body=body,
