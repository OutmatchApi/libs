...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "token", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "token", "url", ], str]):
...
class AdminEmojiAdd(BaseApi):
    ...
    def admin_emoji_add(
        ...
        return self._admin_emoji_add_oapg(
            body=body,
