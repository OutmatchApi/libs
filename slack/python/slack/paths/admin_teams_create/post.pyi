...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["team_description", "team_discoverability", "team_domain", "team_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["team_description", "team_discoverability", "team_domain", "team_name", ], str]):
...
class AdminTeamsCreate(BaseApi):
    ...
    def admin_teams_create(
        ...
        return self._admin_teams_create_oapg(
            body=body,
