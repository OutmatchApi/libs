...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel_ids", "is_restricted", "is_ultra_restricted", "team_id", "user_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel_ids", "is_restricted", "is_ultra_restricted", "team_id", "user_id", ], str]):
...
class AdminUsersAssign(BaseApi):
    ...
    def admin_users_assign(
        ...
        return self._admin_users_assign_oapg(
            body=body,
