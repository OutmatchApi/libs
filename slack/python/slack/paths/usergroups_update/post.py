...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channels", "description", "handle", "include_count", "name", "usergroup", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channels", "description", "handle", "include_count", "name", "usergroup", ], str]):
...
class UsergroupsUpdate(BaseApi):
    ...
    def usergroups_update(
        ...
        return self._usergroups_update_oapg(
            body=body,
