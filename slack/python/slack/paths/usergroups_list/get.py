...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["usergroups"], typing_extensions.Literal["ok"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["usergroups"], typing_extensions.Literal["ok"], ]):
...
class UsergroupsList(BaseApi):
    ...
    def usergroups_list(
        ...
        return self._usergroups_list_oapg(
