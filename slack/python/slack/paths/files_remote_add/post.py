...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["external_id", "external_url", "filetype", "indexable_file_contents", "preview_image", "title", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["external_id", "external_url", "filetype", "indexable_file_contents", "preview_image", "title", "token", ], str]):
...
class FilesRemoteAdd(BaseApi):
    ...
    def files_remote_add(
        ...
        return self._files_remote_add_oapg(
            body=body,
