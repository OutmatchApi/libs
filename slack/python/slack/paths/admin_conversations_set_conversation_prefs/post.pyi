...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel_id", "prefs", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel_id", "prefs", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        prefs: typing.Union[MetaOapg.properties.prefs, str, ],
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def COULD_NOT_SET_CHANNEL_PREF(cls):
                    return cls("could_not_set_channel_pref")
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_conversations_set_conversation_prefs_oapg(
        self,
...
class AdminConversationsSetConversationPrefs(BaseApi):
    ...
    def admin_conversations_set_conversation_prefs(
        ...
        return self._admin_conversations_set_conversation_prefs_oapg(
            body=body,
