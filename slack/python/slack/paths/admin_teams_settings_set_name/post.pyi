...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "team_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "team_id", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_teams_settings_set_name_oapg(
        self,
...
class AdminTeamsSettingsSetName(BaseApi):
    ...
    def admin_teams_settings_set_name(
        ...
        return self._admin_teams_settings_set_name_oapg(
            body=body,
