    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def NOT_ARCHIVED(cls):
                    return cls("not_archived")
...
class BaseApi(api_client.Api):
    @typing.overload
    def _conversations_unarchive_oapg(
        self,
...
class ConversationsUnarchive(BaseApi):
    ...
    def conversations_unarchive(
        ...
        return self._conversations_unarchive_oapg(
            body=body,
