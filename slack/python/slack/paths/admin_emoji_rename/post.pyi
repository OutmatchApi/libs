...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "new_name", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "new_name", "token", ], str]):
...
class AdminEmojiRename(BaseApi):
    ...
    def admin_emoji_rename(
        ...
        return self._admin_emoji_rename_oapg(
            body=body,
