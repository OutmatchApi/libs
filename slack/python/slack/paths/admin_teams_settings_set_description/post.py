...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "team_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "team_id", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_teams_settings_set_description_oapg(
        self,
...
class AdminTeamsSettingsSetDescription(BaseApi):
    ...
    def admin_teams_settings_set_description(
        ...
        return self._admin_teams_settings_set_description_oapg(
            body=body,
