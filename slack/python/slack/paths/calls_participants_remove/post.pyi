...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "users", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "users", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _calls_participants_remove_oapg(
        self,
...
class CallsParticipantsRemove(BaseApi):
    ...
    def calls_participants_remove(
        ...
        return self._calls_participants_remove_oapg(
            body=body,
