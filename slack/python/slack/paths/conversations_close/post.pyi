...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ok"], typing_extensions.Literal["already_closed"], typing_extensions.Literal["no_op"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ok"], typing_extensions.Literal["already_closed"], typing_extensions.Literal["no_op"], ]):
        return super().get_item_oapg(name)
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def USER_DOES_NOT_OWN_CHANNEL(cls):
                    return cls("user_does_not_own_channel")
...
class ConversationsClose(BaseApi):
    ...
    def conversations_close(
        ...
        return self._conversations_close_oapg(
            body=body,
