...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["file", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["file", "id", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _files_comments_delete_oapg(
        self,
...
class FilesCommentsDelete(BaseApi):
    ...
    def files_comments_delete(
        ...
        return self._files_comments_delete_oapg(
            body=body,
