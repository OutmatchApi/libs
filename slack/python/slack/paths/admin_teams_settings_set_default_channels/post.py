...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel_ids", "team_id", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel_ids", "team_id", "token", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_teams_settings_set_default_channels_oapg(
        self,
...
class AdminTeamsSettingsSetDefaultChannels(BaseApi):
    ...
    def admin_teams_settings_set_default_channels(
        ...
        return self._admin_teams_settings_set_default_channels_oapg(
            body=body,
