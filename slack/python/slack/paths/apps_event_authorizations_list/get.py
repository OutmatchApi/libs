...
# Query params
EventContextSchema = schemas.StrSchema
CursorSchema = schemas.StrSchema
LimitSchema = schemas.IntSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'event_context': typing.Union[EventContextSchema, str, ],
    }
)
...
request_query_event_context = api_client.QueryParameter(
    name="event_context",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _apps_event_authorizations_list_oapg(
        self,
...
class AppsEventAuthorizationsList(BaseApi):
    ...
    def apps_event_authorizations_list(
        ...
        return self._apps_event_authorizations_list_oapg(
