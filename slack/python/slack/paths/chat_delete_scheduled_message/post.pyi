...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["as_user", "channel", "scheduled_message_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["as_user", "channel", "scheduled_message_id", ], str]):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                def INVALID_SCHEDULED_MESSAGE_ID(cls):
                    return cls("invalid_scheduled_message_id")
...
class BaseApi(api_client.Api):
    @typing.overload
    def _chat_delete_scheduled_message_oapg(
        self,
...
class ChatDeleteScheduledMessage(BaseApi):
    ...
    def chat_delete_scheduled_message(
        ...
        return self._chat_delete_scheduled_message_oapg(
            body=body,
