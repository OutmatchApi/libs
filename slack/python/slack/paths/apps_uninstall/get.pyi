    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                def INVALID_CLIENT_ID(cls):
                    return cls("invalid_client_id")
                
                @schemas.classproperty
                def BAD_CLIENT_SECRET(cls):
                    return cls("bad_client_secret")
                
                @schemas.classproperty
                def CLIENT_ID_TOKEN_MISMATCH(cls):
                    return cls("client_id_token_mismatch")
...
class AppsUninstall(BaseApi):
    ...
    def apps_uninstall(
        ...
        return self._apps_uninstall_oapg(
