    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                def CANNOT_UNFURL_URL(cls):
                    return cls("cannot_unfurl_url")
                
                @schemas.classproperty
                def CANNOT_FIND_SERVICE(cls):
                    return cls("cannot_find_service")
                
                @schemas.classproperty
                def MISSING_UNFURLS(cls):
                    return cls("missing_unfurls")
                
                @schemas.classproperty
                def CANNOT_PROMPT(cls):
                    return cls("cannot_prompt")
