...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel", "name", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _conversations_rename_oapg(
        self,
...
class ConversationsRename(BaseApi):
    ...
    def conversations_rename(
        ...
        return self._conversations_rename_oapg(
            body=body,
