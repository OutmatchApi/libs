...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_conversations_ekm_list_original_connected_channel_info_oapg(
        self,
...
class AdminConversationsEkmListOriginalConnectedChannelInfo(BaseApi):
    ...
    def admin_conversations_ekm_list_original_connected_channel_info(
        ...
        return self._admin_conversations_ekm_list_original_connected_channel_info_oapg(
