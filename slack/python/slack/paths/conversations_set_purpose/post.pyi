...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel", "purpose", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel", "purpose", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _conversations_set_purpose_oapg(
        self,
...
class ConversationsSetPurpose(BaseApi):
    ...
    def conversations_set_purpose(
        ...
        return self._conversations_set_purpose_oapg(
            body=body,
