...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["as_user", "attachments", "blocks", "channel", "icon_emoji", "icon_url", "link_names", "parse", "text", "thread_ts", "user", "username", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["as_user", "attachments", "blocks", "channel", "icon_emoji", "icon_url", "link_names", "parse", "text", "thread_ts", "user", "username", ], str]):
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ok"], typing_extensions.Literal["message_ts"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ok"], typing_extensions.Literal["message_ts"], ]):
        return super().get_item_oapg(name)
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def USER_NOT_IN_CHANNEL(cls):
                    return cls("user_not_in_channel")
...
class ChatPostEphemeral(BaseApi):
    ...
    def chat_post_ephemeral(
        ...
        return self._chat_post_ephemeral_oapg(
            body=body,
