    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def ALREADY_REACTED(cls):
                    return cls("already_reacted")
                
                @schemas.classproperty
                def TOO_MANY_EMOJI(cls):
                    return cls("too_many_emoji")
                
                @schemas.classproperty
                def TOO_MANY_REACTIONS(cls):
                    return cls("too_many_reactions")
...
class ReactionsAdd(BaseApi):
    ...
    def reactions_add(
        ...
        return self._reactions_add_oapg(
            body=body,
