...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["text", "time", "user", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["text", "time", "user", ], str]):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                def CANNOT_PARSE(cls):
                    return cls("cannot_parse")
                ...
                @schemas.classproperty
                def CANNOT_ADD_BOT(cls):
                    return cls("cannot_add_bot")
                
                @schemas.classproperty
                def CANNOT_ADD_SLACKBOT(cls):
                    return cls("cannot_add_slackbot")
                
                @schemas.classproperty
                def CANNOT_ADD_OTHERS(cls):
                    return cls("cannot_add_others")
                
                @schemas.classproperty
                def CANNOT_ADD_OTHERS_RECURRING(cls):
                    return cls("cannot_add_others_recurring")
...
class RemindersAdd(BaseApi):
    ...
    def reminders_add(
        ...
        return self._reminders_add_oapg(
            body=body,
