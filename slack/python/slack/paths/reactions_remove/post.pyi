...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel", "file", "file_comment", "name", "timestamp", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel", "file", "file_comment", "name", "timestamp", ], str]):
...
class ReactionsRemove(BaseApi):
    ...
    def reactions_remove(
        ...
        return self._reactions_remove_oapg(
            body=body,
