...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["presence", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["presence", ], str]):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                def INVALID_PRESENCE(cls):
                    return cls("invalid_presence")
...
class UsersSetPresence(BaseApi):
    ...
    def users_set_presence(
        ...
        return self._users_set_presence_oapg(
            body=body,
