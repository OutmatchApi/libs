    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def INVALID_USER(cls):
                    return cls("invalid_user")
...
class BaseApi(api_client.Api):
    @typing.overload
    def _apps_permissions_request_oapg(
        self,
...
class AppsPermissionsRequest(BaseApi):
    ...
    def apps_permissions_request(
        ...
        return self._apps_permissions_request_oapg(
