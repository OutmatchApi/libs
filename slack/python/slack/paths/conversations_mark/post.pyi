...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel", "ts", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel", "ts", ], str]):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def INVALID_TIMESTAMP(cls):
                    return cls("invalid_timestamp")
                ...
                @schemas.classproperty
                def NOT_ALLOWED_TOKEN_TYPE(cls):
                    return cls("not_allowed_token_type")
...
class ConversationsMark(BaseApi):
    ...
    def conversations_mark(
        ...
        return self._conversations_mark_oapg(
            body=body,
