...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_id"], typing_extensions.Literal["team"], typing_extensions.Literal["team_id"], typing_extensions.Literal["ok"], typing_extensions.Literal["user"], typing_extensions.Literal["url"], typing_extensions.Literal["bot_id"], typing_extensions.Literal["is_enterprise_install"], ]):
