...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channels", "description", "handle", "include_count", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channels", "description", "handle", "include_count", "name", ], str]):
...
class UsergroupsCreate(BaseApi):
    ...
    def usergroups_create(
        ...
        return self._usergroups_create_oapg(
            body=body,
