...
# Query params
DialogSchema = schemas.StrSchema
TriggerIdSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'dialog': typing.Union[DialogSchema, str, ],
...
request_query_dialog = api_client.QueryParameter(
    name="dialog",
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                def VALIDATION_ERRORS(cls):
                    return cls("validation_errors")
                
                @schemas.classproperty
                def MISSING_TRIGGER(cls):
                    return cls("missing_trigger")
                
                @schemas.classproperty
                def MISSING_DIALOG(cls):
                    return cls("missing_dialog")
                
                @schemas.classproperty
                def TRIGGER_EXCHANGED(cls):
                    return cls("trigger_exchanged")
                
                @schemas.classproperty
                def TRIGGER_EXPIRED(cls):
                    return cls("trigger_expired")
                
                @schemas.classproperty
                def INVALID_TRIGGER(cls):
                    return cls("invalid_trigger")
                
                @schemas.classproperty
                def APP_MISSING_ACTION_URL(cls):
                    return cls("app_missing_action_url")
                
                @schemas.classproperty
                def CANNOT_CREATE_DIALOG(cls):
                    return cls("cannot_create_dialog")
                
                @schemas.classproperty
                def FAILED_SENDING_DIALOG(cls):
                    return cls("failed_sending_dialog")
