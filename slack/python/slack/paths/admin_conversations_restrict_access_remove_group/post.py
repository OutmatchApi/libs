...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_conversations_restrict_access_remove_group_oapg(
        self,
...
class AdminConversationsRestrictAccessRemoveGroup(BaseApi):
    ...
    def admin_conversations_restrict_access_remove_group(
        ...
        return self._admin_conversations_restrict_access_remove_group_oapg(
            body=body,
