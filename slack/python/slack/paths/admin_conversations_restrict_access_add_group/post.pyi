...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_conversations_restrict_access_add_group_oapg(
        self,
...
class AdminConversationsRestrictAccessAddGroup(BaseApi):
    ...
    def admin_conversations_restrict_access_add_group(
        ...
        return self._admin_conversations_restrict_access_add_group_oapg(
            body=body,
