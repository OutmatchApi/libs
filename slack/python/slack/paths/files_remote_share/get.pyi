...
ChannelsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'channels': typing.Union[ChannelsSchema, str, ],
    },
    total=False
)
...
request_query_channels = api_client.QueryParameter(
    name="channels",
    style=api_client.ParameterStyle.FORM,
...
class FilesRemoteShare(BaseApi):
    ...
    def files_remote_share(
        ...
        return self._files_remote_share_oapg(
