...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["as_user", "channel", "ts", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["as_user", "channel", "ts", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ts: typing.Union[MetaOapg.properties.ts, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel"], typing_extensions.Literal["ok"], typing_extensions.Literal["ts"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel"], typing_extensions.Literal["ok"], typing_extensions.Literal["ts"], ]):
        return super().get_item_oapg(name)
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def CANT_DELETE_MESSAGE(cls):
                    return cls("cant_delete_message")
                
                @schemas.classproperty
                def COMPLIANCE_EXPORTS_PREVENT_DELETION(cls):
                    return cls("compliance_exports_prevent_deletion")
