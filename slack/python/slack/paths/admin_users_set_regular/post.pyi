...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["team_id", "user_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["team_id", "user_id", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_users_set_regular_oapg(
        self,
...
class AdminUsersSetRegular(BaseApi):
    ...
    def admin_users_set_regular(
        ...
        return self._admin_users_set_regular_oapg(
            body=body,
