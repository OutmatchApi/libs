    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def ALREADY_PINNED(cls):
                    return cls("already_pinned")
                ...
                @schemas.classproperty
                def FILE_NOT_SHARED(cls):
                    return cls("file_not_shared")
                
                @schemas.classproperty
                def NOT_PINNABLE(cls):
                    return cls("not_pinnable")
