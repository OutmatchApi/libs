    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def CHANNEL_NOT_ARCHIVED(cls):
                    return cls("channel_not_archived")
                ...
                @schemas.classproperty
                def COULD_NOT_UNARCHIVE_CHANNEL(cls):
                    return cls("could_not_unarchive_channel")
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_conversations_unarchive_oapg(
        self,
...
class AdminConversationsUnarchive(BaseApi):
    ...
    def admin_conversations_unarchive(
        ...
        return self._admin_conversations_unarchive_oapg(
            body=body,
