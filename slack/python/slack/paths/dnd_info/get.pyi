...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["next_dnd_end_ts"], typing_extensions.Literal["dnd_enabled"], typing_extensions.Literal["next_dnd_start_ts"], typing_extensions.Literal["ok"], typing_extensions.Literal["snooze_enabled"], typing_extensions.Literal["snooze_endtime"], typing_extensions.Literal["snooze_remaining"], ]):
