...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel_ids", "team_id", "usergroup_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel_ids", "team_id", "usergroup_id", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_usergroups_add_channels_oapg(
        self,
...
class AdminUsergroupsAddChannels(BaseApi):
    ...
    def admin_usergroups_add_channels(
        ...
        return self._admin_usergroups_add_channels_oapg(
            body=body,
