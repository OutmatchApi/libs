...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_conversations_restrict_access_list_groups_oapg(
        self,
...
class AdminConversationsRestrictAccessListGroups(BaseApi):
    ...
    def admin_conversations_restrict_access_list_groups(
        ...
        return self._admin_conversations_restrict_access_list_groups_oapg(
