...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["external_id", "file", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["external_id", "file", "token", ], str]):
...
class FilesRemoteRemove(BaseApi):
    ...
    def files_remote_remove(
        ...
        return self._files_remote_remove_oapg(
            body=body,
