...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel_id", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel_id", "name", ], str]):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                @schemas.classproperty
                def COULD_NOT_RENAME_CHANNEL(cls):
                    return cls("could_not_rename_channel")
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_conversations_rename_oapg(
        self,
...
class AdminConversationsRename(BaseApi):
    ...
    def admin_conversations_rename(
        ...
        return self._admin_conversations_rename_oapg(
            body=body,
