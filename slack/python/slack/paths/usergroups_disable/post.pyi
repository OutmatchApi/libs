...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["include_count", "usergroup", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["include_count", "usergroup", ], str]):
...
class UsergroupsDisable(BaseApi):
    ...
    def usergroups_disable(
        ...
        return self._usergroups_disable_oapg(
            body=body,
