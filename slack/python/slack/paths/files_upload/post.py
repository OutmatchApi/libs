...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channels", "content", "file", "filename", "filetype", "initial_comment", "thread_ts", "title", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channels", "content", "file", "filename", "filetype", "initial_comment", "thread_ts", "title", "token", ], str]):
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["file"], typing_extensions.Literal["ok"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["file"], typing_extensions.Literal["ok"], ]):
        return super().get_item_oapg(name)
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error(
                ...
                def POSTING_TO_GENERAL_CHANNEL_DENIED(cls):
                    return cls("posting_to_general_channel_denied")
                ...
                @schemas.classproperty
                def FILE_UPLOADS_DISABLED(cls):
                    return cls("file_uploads_disabled")
                
                @schemas.classproperty
                def FILE_UPLOADS_EXCEPT_IMAGES_DISABLED(cls):
                    return cls("file_uploads_except_images_disabled")
                
                @schemas.classproperty
                def STORAGE_LIMIT_REACHED(cls):
                    return cls("storage_limit_reached")
...
class FilesUpload(BaseApi):
    ...
    def files_upload(
        ...
        return self._files_upload_oapg(
            body=body,
