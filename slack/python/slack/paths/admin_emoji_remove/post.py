...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "token", ], str]):
...
class AdminEmojiRemove(BaseApi):
    ...
    def admin_emoji_remove(
        ...
        return self._admin_emoji_remove_oapg(
            body=body,
