...
SingleChannelSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'single_channel': typing.Union[SingleChannelSchema, bool, ],
    },
    total=False
)
...
request_query_single_channel = api_client.QueryParameter(
    name="single_channel",
    style=api_client.ParameterStyle.FORM,
    schema=SingleChannelSchema,
    explode=True,
)
_auth = [
    'slackAuth',
...
class OauthAccess(BaseApi):
    ...
    def oauth_access(
        ...
        return self._oauth_access_oapg(
