<a name="__pageTop"></a>
# slack.apis.tags.admin_invite_requests_denied_api.AdminInviteRequestsDeniedApi
...
```python
import slack
from slack.apis.tags import admin_invite_requests_denied_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = admin_invite_requests_denied_api.AdminInviteRequestsDeniedApi(api_client)
