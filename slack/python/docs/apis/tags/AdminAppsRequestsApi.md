<a name="__pageTop"></a>
# slack.apis.tags.admin_apps_requests_api.AdminAppsRequestsApi
...
```python
import slack
from slack.apis.tags import admin_apps_requests_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = admin_apps_requests_api.AdminAppsRequestsApi(api_client)
    ...
    try:
        ...
        print("Exception when calling AdminAppsRequestsApi->admin_apps_requests_list: %s\n" % e)
