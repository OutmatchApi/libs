<a name="__pageTop"></a>
# slack.apis.tags.emoji_api.EmojiApi

All URIs are relative to *https://slack.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**emoji_list**](#emoji_list) | **get** /emoji.list | 

# **emoji_list**
<a name="emoji_list"></a>
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} emoji_list(token)
...
```python
import slack
from slack.apis.tags import emoji_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = emoji_api.EmojiApi(api_client)
    ...
    try:
        api_response = api_instance.emoji_list(
...
200 | [ApiResponseFor200](#emoji_list.ApiResponseFor200) | Typical success response
default | [ApiResponseForDefault](#emoji_list.ApiResponseForDefault) | Typical error response

#### emoji_list.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
#### emoji_list.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
