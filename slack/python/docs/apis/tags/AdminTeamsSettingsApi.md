<a name="__pageTop"></a>
# slack.apis.tags.admin_teams_settings_api.AdminTeamsSettingsApi
...
```python
import slack
from slack.apis.tags import admin_teams_settings_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = admin_teams_settings_api.AdminTeamsSettingsApi(api_client)
