<a name="__pageTop"></a>
# slack.apis.tags.apps_event_authorizations_api.AppsEventAuthorizationsApi
...
```python
import slack
from slack.apis.tags import apps_event_authorizations_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = apps_event_authorizations_api.AppsEventAuthorizationsApi(api_client)
