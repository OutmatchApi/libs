<a name="__pageTop"></a>
# slack.apis.tags.admin_teams_admins_api.AdminTeamsAdminsApi
...
```python
import slack
from slack.apis.tags import admin_teams_admins_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = admin_teams_admins_api.AdminTeamsAdminsApi(api_client)
