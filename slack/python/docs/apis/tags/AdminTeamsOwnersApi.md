<a name="__pageTop"></a>
# slack.apis.tags.admin_teams_owners_api.AdminTeamsOwnersApi
...
```python
import slack
from slack.apis.tags import admin_teams_owners_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = admin_teams_owners_api.AdminTeamsOwnersApi(api_client)
    ...
    try:
        ...
        print("Exception when calling AdminTeamsOwnersApi->admin_teams_owners_list: %s\n" % e)
