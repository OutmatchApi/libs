<a name="__pageTop"></a>
# slack.apis.tags.admin_usergroups_api.AdminUsergroupsApi
...
```python
import slack
from slack.apis.tags import admin_usergroups_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = admin_usergroups_api.AdminUsergroupsApi(api_client)
