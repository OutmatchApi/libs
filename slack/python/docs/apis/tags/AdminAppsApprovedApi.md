<a name="__pageTop"></a>
# slack.apis.tags.admin_apps_approved_api.AdminAppsApprovedApi
...
```python
import slack
from slack.apis.tags import admin_apps_approved_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = admin_apps_approved_api.AdminAppsApprovedApi(api_client)
    ...
    try:
        ...
        print("Exception when calling AdminAppsApprovedApi->admin_apps_approved_list: %s\n" % e)
