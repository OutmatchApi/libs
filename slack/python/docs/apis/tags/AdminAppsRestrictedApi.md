<a name="__pageTop"></a>
# slack.apis.tags.admin_apps_restricted_api.AdminAppsRestrictedApi
...
```python
import slack
from slack.apis.tags import admin_apps_restricted_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = admin_apps_restricted_api.AdminAppsRestrictedApi(api_client)
