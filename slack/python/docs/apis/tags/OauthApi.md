<a name="__pageTop"></a>
# slack.apis.tags.oauth_api.OauthApi

All URIs are relative to *https://slack.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**oauth_access**](#oauth_access) | **get** /oauth.access | 
[**oauth_token**](#oauth_token) | **get** /oauth.token | 
[**oauth_v2_access**](#oauth_v2_access) | **get** /oauth.v2.access | 

# **oauth_access**
<a name="oauth_access"></a>
...
```python
import slack
from slack.apis.tags import oauth_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.oauth_access(
...
single_channel | SingleChannelSchema | | optional
...
200 | [ApiResponseFor200](#oauth_access.ApiResponseFor200) | Successful user token negotiation for a single scope
default | [ApiResponseForDefault](#oauth_access.ApiResponseForDefault) | Typical error response

#### oauth_access.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
#### oauth_access.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
...
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} oauth_token()
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#oauth_token.ApiResponseFor200) | Success example using a workspace app produces a very different kind of response
default | [ApiResponseForDefault](#oauth_token.ApiResponseForDefault) | Typical error response
...
with slack.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling OauthApi->oauth_v2_access: %s\n" % e)
