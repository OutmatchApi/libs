<a name="__pageTop"></a>
# slack.apis.tags.admin_invite_requests_approved_api.AdminInviteRequestsApprovedApi
...
```python
import slack
from slack.apis.tags import admin_invite_requests_approved_api
...
with slack.ApiClient(configuration) as api_client:
    ...
    api_instance = admin_invite_requests_approved_api.AdminInviteRequestsApprovedApi(api_client)
    ...
    try:
        ...
        print("Exception when calling AdminInviteRequestsApprovedApi->admin_invite_requests_approved_list: %s\n" % e)
