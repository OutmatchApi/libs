...
/**
 * FilesCommentsDeleteErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class FilesCommentsDeleteErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'files_comments_delete_error_schema';
    ...
    public const ERROR_CANT_DELETE = 'cant_delete';
    public const ERROR_COMMENT_NOT_FOUND = 'comment_not_found';
    ...
    {
        return [
            self::ERROR_CANT_DELETE,
            self::ERROR_COMMENT_NOT_FOUND,
