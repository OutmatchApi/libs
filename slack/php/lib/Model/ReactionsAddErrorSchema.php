...
/**
 * ReactionsAddErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ReactionsAddErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reactions_add_error_schema';
    ...
    public const ERROR_ALREADY_REACTED = 'already_reacted';
    public const ERROR_TOO_MANY_EMOJI = 'too_many_emoji';
    public const ERROR_TOO_MANY_REACTIONS = 'too_many_reactions';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_ALREADY_REACTED,
            self::ERROR_TOO_MANY_EMOJI,
            self::ERROR_TOO_MANY_REACTIONS,
