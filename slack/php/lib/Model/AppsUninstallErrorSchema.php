...
/**
 * AppsUninstallErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class AppsUninstallErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'apps_uninstall_error_schema';
    ...
    public const ERROR_INVALID_CLIENT_ID = 'invalid_client_id';
    public const ERROR_BAD_CLIENT_SECRET = 'bad_client_secret';
    public const ERROR_CLIENT_ID_TOKEN_MISMATCH = 'client_id_token_mismatch';
    ...
    {
        return [
            self::ERROR_INVALID_CLIENT_ID,
            self::ERROR_BAD_CLIENT_SECRET,
            self::ERROR_CLIENT_ID_TOKEN_MISMATCH,
