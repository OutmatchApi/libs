...
/**
 * RemindersCompleteErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class RemindersCompleteErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reminders_complete_error_schema';
    ...
    public const ERROR_CANNOT_COMPLETE_RECURRING = 'cannot_complete_recurring';
    public const ERROR_CANNOT_COMPLETE_OTHERS = 'cannot_complete_others';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_CANNOT_COMPLETE_RECURRING,
            self::ERROR_CANNOT_COMPLETE_OTHERS,
