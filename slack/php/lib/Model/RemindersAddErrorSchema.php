...
/**
 * RemindersAddErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class RemindersAddErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reminders_add_error_schema';
    ...
    public const ERROR_CANNOT_PARSE = 'cannot_parse';
    public const ERROR_USER_NOT_FOUND = 'user_not_found';
    public const ERROR_CANNOT_ADD_BOT = 'cannot_add_bot';
    public const ERROR_CANNOT_ADD_SLACKBOT = 'cannot_add_slackbot';
    public const ERROR_CANNOT_ADD_OTHERS = 'cannot_add_others';
    public const ERROR_CANNOT_ADD_OTHERS_RECURRING = 'cannot_add_others_recurring';
    ...
    {
        return [
            self::ERROR_CANNOT_PARSE,
            self::ERROR_USER_NOT_FOUND,
            self::ERROR_CANNOT_ADD_BOT,
            self::ERROR_CANNOT_ADD_SLACKBOT,
            self::ERROR_CANNOT_ADD_OTHERS,
            self::ERROR_CANNOT_ADD_OTHERS_RECURRING,
