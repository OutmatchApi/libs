...
/**
 * UsersLookupByEmailErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class UsersLookupByEmailErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'users_lookupByEmail_error_schema';
    ...
    public const ERROR_USERS_NOT_FOUND = 'users_not_found';
    public const ERROR_ENTERPRISE_IS_RESTRICTED = 'enterprise_is_restricted';
    ...
    {
        return [
            self::ERROR_USERS_NOT_FOUND,
            self::ERROR_ENTERPRISE_IS_RESTRICTED,
