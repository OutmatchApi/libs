...
/**
 * FilesInfoSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class FilesInfoSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'files_info_schema';
    ...
    protected static $openAPITypes = [
        ...
        'paging' => '\OpenAPI\Client\Model\ObjsPaging',
    ...
    */
     ...
     * Sets content_html
     *
     * @param mixed|null $content_html content_html
     *
     * @return self
     */
    public function setContentHtml($content_html)
    {
        ...
        if (is_null($content_html)) {
            array_push($this->openAPINullablesSetToNull, 'content_html');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('content_html', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setEditor($editor)
    {
        ...
        if (!is_null($editor) && (!preg_match("/^[UW][A-Z0-9]{2,}$/", $editor))) {
            throw new \InvalidArgumentException("invalid value for \$editor when calling FilesInfoSchema., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
     ...
     * Gets file
     *
     * @return \OpenAPI\Client\Model\ObjsFile
     */
     ...
     * Sets file
     *
     * @param \OpenAPI\Client\Model\ObjsFile $file file
     *
     * @return self
     */
     ...
     * Gets paging
     *
     * @return \OpenAPI\Client\Model\ObjsPaging|null
     */
     ...
     * Sets paging
     *
     * @param \OpenAPI\Client\Model\ObjsPaging|null $paging paging
     *
     * @return self
     */
