...
/**
 * ConversationObject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConversationObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Conversation_object';
    ...
    protected static $setters = [
        ...
        'is_global_shared' => 'setIsGlobalShared',
        'is_group' => 'setIsGroup',
        'is_im' => 'setIsIm',
        ...
        'is_open' => 'setIsOpen',
        'is_org_default' => 'setIsOrgDefault',
        'is_org_mandatory' => 'setIsOrgMandatory',
    ...
    protected static $getters = [
        ...
        'is_global_shared' => 'getIsGlobalShared',
        'is_group' => 'getIsGroup',
        'is_im' => 'getIsIm',
        ...
        'is_open' => 'getIsOpen',
        'is_org_default' => 'getIsOrgDefault',
        'is_org_mandatory' => 'getIsOrgMandatory',
    ...
    public const IS_MPIM_FALSE = 'false';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_global_shared', $data ?? [], null);
        ...
        $this->setIfExists('is_org_default', $data ?? [], null);
        $this->setIfExists('is_org_mandatory', $data ?? [], null);
    ...
    */
    ...
    public function setAcceptedUser($accepted_user)
    {
        ...
        if (!is_null($accepted_user) && (!preg_match("/^[UW][A-Z0-9]{2,}$/", $accepted_user))) {
            throw new \InvalidArgumentException("invalid value for \$accepted_user when calling ConversationObject., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
    ...
    public function setConnectedTeamIds($connected_team_ids)
    {
        ...
        if (!is_null($connected_team_ids) && (count($connected_team_ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $connected_team_ids when calling ConversationObject., number of items must be greater than or equal to 0.');
        }
    ...
    public function setConversationHostId($conversation_host_id)
    {
        ...
        if (!is_null($conversation_host_id) && (!preg_match("/^[TE][A-Z0-9]{8,}$/", $conversation_host_id))) {
            throw new \InvalidArgumentException("invalid value for \$conversation_host_id when calling ConversationObject., must conform to the pattern /^[TE][A-Z0-9]{8,}$/.");
        }
    ...
    public function setCreator($creator)
    {
        ...
        if ((!preg_match("/^[UW][A-Z0-9]{2,}$/", $creator))) {
            throw new \InvalidArgumentException("invalid value for \$creator when calling ConversationObject., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
    ...
    public function setEnterpriseId($enterprise_id)
    {
        ...
        if (!is_null($enterprise_id) && (!preg_match("/^[E][A-Z0-9]{8,}$/", $enterprise_id))) {
            throw new \InvalidArgumentException("invalid value for \$enterprise_id when calling ConversationObject., must conform to the pattern /^[E][A-Z0-9]{8,}$/.");
        }
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[CGD][A-Z0-9]{8,}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling ConversationObject., must conform to the pattern /^[CGD][A-Z0-9]{8,}$/.");
        }
    ...
    public function setInternalTeamIds($internal_team_ids)
    {
        ...
        if (!is_null($internal_team_ids) && (count($internal_team_ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $internal_team_ids when calling ConversationObject., number of items must be greater than or equal to 0.');
        }
    ...
    /**
     * Gets is_global_shared
     *
     * @return bool|null
     */
    public function getIsGlobalShared()
    {
        return $this->container['is_global_shared'];
    }

    /**
     * Sets is_global_shared
     *
     * @param bool|null $is_global_shared is_global_shared
     *
     * @return self
     */
    public function setIsGlobalShared($is_global_shared)
    {

        if (is_null($is_global_shared)) {
            throw new \InvalidArgumentException('non-nullable is_global_shared cannot be null');
        }

        $this->container['is_global_shared'] = $is_global_shared;
     ...
     * @return bool|null
     */
    public function getIsOrgDefault()
    {
        return $this->container['is_org_default'];
    }

    /**
     * Sets is_org_default
     *
     * @param bool|null $is_org_default is_org_default
     *
     * @return self
     */
    public function setIsOrgDefault($is_org_default)
    {

        if (is_null($is_org_default)) {
            throw new \InvalidArgumentException('non-nullable is_org_default cannot be null');
        }

        $this->container['is_org_default'] = $is_org_default;

        return $this;
    }

    /**
     * Gets is_org_mandatory
     *
     * @return bool|null
     */
    public function getIsOrgMandatory()
    {
        return $this->container['is_org_mandatory'];
    }

    /**
     * Sets is_org_mandatory
     *
     * @param bool|null $is_org_mandatory is_org_mandatory
     *
     * @return self
     */
    public function setIsOrgMandatory($is_org_mandatory)
    {

        if (is_null($is_org_mandatory)) {
            throw new \InvalidArgumentException('non-nullable is_org_mandatory cannot be null');
        }

        $this->container['is_org_mandatory'] = $is_org_mandatory;
    ...
    public function setLastRead($last_read)
    {
        ...
        if (!is_null($last_read) && (!preg_match("/^\\d{10}\\.\\d{6}$/", $last_read))) {
            throw new \InvalidArgumentException("invalid value for \$last_read when calling ConversationObject., must conform to the pattern /^\\d{10}\\.\\d{6}$/.");
        }
    ...
    public function setMembers($members)
    {
        ...
        if (!is_null($members) && (count($members) < 0)) {
            throw new \InvalidArgumentException('invalid length for $members when calling ConversationObject., number of items must be greater than or equal to 0.');
        }
    ...
    public function setPendingConnectedTeamIds($pending_connected_team_ids)
    {
        ...
        if (!is_null($pending_connected_team_ids) && (count($pending_connected_team_ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $pending_connected_team_ids when calling ConversationObject., number of items must be greater than or equal to 0.');
        }
    ...
    public function setPendingShared($pending_shared)
    {
        ...
        if (!is_null($pending_shared) && (count($pending_shared) < 0)) {
            throw new \InvalidArgumentException('invalid length for $pending_shared when calling ConversationObject., number of items must be greater than or equal to 0.');
        }
    ...
    public function setPreviousNames($previous_names)
    {
        ...
        if (!is_null($previous_names) && (count($previous_names) < 0)) {
            throw new \InvalidArgumentException('invalid length for $previous_names when calling ConversationObject., number of items must be greater than or equal to 0.');
        }
    ...
    public function setSharedTeamIds($shared_team_ids)
    {
        ...
        if (!is_null($shared_team_ids) && (count($shared_team_ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shared_team_ids when calling ConversationObject., number of items must be greater than or equal to 0.');
        }
    ...
    public function setShares($shares)
    {
        ...
        if (!is_null($shares) && (count($shares) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shares when calling ConversationObject., number of items must be greater than or equal to 0.');
        }
     ...
     * Sets use_case
     *
     * @param string|null $use_case use_case
     *
     * @return self
     */
    ...
    public function setUser($user)
    {
        ...
        if (!is_null($user) && (!preg_match("/^[UW][A-Z0-9]{2,}$/", $user))) {
            throw new \InvalidArgumentException("invalid value for \$user when calling ConversationObject., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
