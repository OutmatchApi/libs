...
/**
 * ChatMeMessageSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatMeMessageSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat_meMessage_schema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ts']) && !preg_match("/^\\d{10}\\.\\d{6}$/", $this->container['ts'])) {
    ...
    public function setChannel($channel)
    {
        ...
        if (!is_null($channel) && (!preg_match("/^[CGD][A-Z0-9]{8,}$/", $channel))) {
            throw new \InvalidArgumentException("invalid value for \$channel when calling ChatMeMessageSchema., must conform to the pattern /^[CGD][A-Z0-9]{8,}$/.");
        }
    ...
    public function setTs($ts)
    {
        ...
        if (!is_null($ts) && (!preg_match("/^\\d{10}\\.\\d{6}$/", $ts))) {
            throw new \InvalidArgumentException("invalid value for \$ts when calling ChatMeMessageSchema., must conform to the pattern /^\\d{10}\\.\\d{6}$/.");
        }
