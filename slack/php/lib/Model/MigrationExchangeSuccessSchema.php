...
/**
 * MigrationExchangeSuccessSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class MigrationExchangeSuccessSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'migration_exchange_success_schema';
    ...
    protected static $openAPITypes = [
        ...
        'team_id' => 'string',
        'user_id_map' => 'array<string,mixed>'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('invalid_user_ids', $data ?? [], null);
        $this->setIfExists('ok', $data ?? [], null);
        $this->setIfExists('team_id', $data ?? [], null);
        $this->setIfExists('user_id_map', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string[]|null $invalid_user_ids invalid_user_ids
     *
     * @return self
     */
    public function setInvalidUserIds($invalid_user_ids)
    {
        ...
        if (is_null($invalid_user_ids)) {
            throw new \InvalidArgumentException('non-nullable invalid_user_ids cannot be null');
        }
    ...
    public function setTeamId($team_id)
    {
        ...
        if ((!preg_match("/^[T][A-Z0-9]{2,}$/", $team_id))) {
            throw new \InvalidArgumentException("invalid value for \$team_id when calling MigrationExchangeSuccessSchema., must conform to the pattern /^[T][A-Z0-9]{2,}$/.");
        }
     ...
     */
    public function getUserIdMap()
    {
        return $this->container['user_id_map'];
    }

    /**
     * Sets user_id_map
     *
     * @param array<string,mixed>|null $user_id_map user_id_map
     *
     * @return self
     */
    public function setUserIdMap($user_id_map)
    {

        if (is_null($user_id_map)) {
            throw new \InvalidArgumentException('non-nullable user_id_map cannot be null');
        }

        $this->container['user_id_map'] = $user_id_map;
