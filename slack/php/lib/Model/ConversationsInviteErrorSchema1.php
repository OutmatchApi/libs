...
/**
 * ConversationsInviteErrorSchema1 Class Doc Comment
 *
 * @category Class
 ...
 */
class ConversationsInviteErrorSchema1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversations_invite_error_schema_1';
    ...
    protected static $openAPITypes = [
        'callstack' => 'string',
        'error' => 'string',
        'errors' => '\OpenAPI\Client\Model\ErrorsIsReturnedWhenAnErrorAssociatesAnUserInner[]',
        'needed' => 'string',
    ...
    public const ERROR_METHOD_NOT_SUPPORTED_FOR_CHANNEL_TYPE = 'method_not_supported_for_channel_type';
    public const ERROR_MISSING_SCOPE = 'missing_scope';
    public const ERROR_CHANNEL_NOT_FOUND = 'channel_not_found';
    public const ERROR_USER_NOT_FOUND = 'user_not_found';
    public const ERROR_NO_USER = 'no_user';
    public const ERROR_CANT_INVITE_SELF = 'cant_invite_self';
    public const ERROR_NOT_IN_CHANNEL = 'not_in_channel';
    public const ERROR_ALREADY_IN_CHANNEL = 'already_in_channel';
    public const ERROR_IS_ARCHIVED = 'is_archived';
    public const ERROR_CANT_INVITE = 'cant_invite';
    public const ERROR_TOO_MANY_USERS = 'too_many_users';
    public const ERROR_URA_MAX_CHANNELS = 'ura_max_channels';
    ...
    public const ERROR_USER_IS_RESTRICTED = 'user_is_restricted';
    public const ERROR_USER_IS_ULTRA_RESTRICTED = 'user_is_ultra_restricted';
    ...
    public const ERROR_MISSING_CHARSET = 'missing_charset';
    public const ERROR_SUPERFLUOUS_CHARSET = 'superfluous_charset';
    ...
    {
        return [
            self::ERROR_METHOD_NOT_SUPPORTED_FOR_CHANNEL_TYPE,
            self::ERROR_MISSING_SCOPE,
            self::ERROR_CHANNEL_NOT_FOUND,
            self::ERROR_USER_NOT_FOUND,
            self::ERROR_NO_USER,
            self::ERROR_CANT_INVITE_SELF,
            self::ERROR_NOT_IN_CHANNEL,
            self::ERROR_ALREADY_IN_CHANNEL,
            self::ERROR_IS_ARCHIVED,
            self::ERROR_CANT_INVITE,
            self::ERROR_TOO_MANY_USERS,
            self::ERROR_URA_MAX_CHANNELS,
            self::ERROR_NOT_AUTHED,
            self::ERROR_INVALID_AUTH,
            self::ERROR_ACCOUNT_INACTIVE,
            self::ERROR_USER_IS_BOT,
            self::ERROR_USER_IS_RESTRICTED,
            self::ERROR_USER_IS_ULTRA_RESTRICTED,
            ...
            self::ERROR_MISSING_CHARSET,
            self::ERROR_SUPERFLUOUS_CHARSET,
        ];
    }
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\ErrorsIsReturnedWhenAnErrorAssociatesAnUserInner[]|null
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\ErrorsIsReturnedWhenAnErrorAssociatesAnUserInner[]|null $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if (!is_null($errors) && (count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling ConversationsInviteErrorSchema1., number of items must be greater than or equal to 1.');
        }
