...
/**
 * AdminConversationsGetTeamsErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class AdminConversationsGetTeamsErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_conversations_getTeams_error_schema';
    ...
    public const ERROR_UNSUPPORTED_TEAM_TYPE = 'unsupported_team_type';
    public const ERROR_RESTRICTED_ACTION = 'restricted_action';
    public const ERROR_COULD_NOT_GET_TEAMS = 'could_not_get_teams';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_UNSUPPORTED_TEAM_TYPE,
            self::ERROR_RESTRICTED_ACTION,
            self::ERROR_COULD_NOT_GET_TEAMS,
