...
/**
 * ChatPostMessageSuccessSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatPostMessageSuccessSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat_postMessage_success_schema';
    ...
    */
    ...
    public function setChannel($channel)
    {
        ...
        if ((!preg_match("/^[CGD][A-Z0-9]{8,}$/", $channel))) {
            throw new \InvalidArgumentException("invalid value for \$channel when calling ChatPostMessageSuccessSchema., must conform to the pattern /^[CGD][A-Z0-9]{8,}$/.");
        }
    ...
    public function setTs($ts)
    {
        ...
        if ((!preg_match("/^\\d{10}\\.\\d{6}$/", $ts))) {
            throw new \InvalidArgumentException("invalid value for \$ts when calling ChatPostMessageSuccessSchema., must conform to the pattern /^\\d{10}\\.\\d{6}$/.");
        }
