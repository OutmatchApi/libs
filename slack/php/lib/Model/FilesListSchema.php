...
/**
 * FilesListSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class FilesListSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'files_list_schema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['files']) < 0)) {
            $invalidProperties[] = "invalid value for 'files', number of items must be greater than or equal to 0.";
        }
     ...
     * Sets files
     *
     * @param \OpenAPI\Client\Model\ObjsFile[] $files files
     *
     * @return self
     */
    public function setFiles($files)
    {
        ...
        if ((count($files) < 0)) {
            throw new \InvalidArgumentException('invalid length for $files when calling FilesListSchema., number of items must be greater than or equal to 0.');
        }
