...
/**
 * TeamIntegrationLogsSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class TeamIntegrationLogsSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'team_integrationLogs_schema';
    ...
    protected static $openAPITypes = [
        'logs' => '\OpenAPI\Client\Model\TeamIntegrationLogsSchemaLogsInner[]',
    ...
    */
     ...
     * Gets logs
     *
     * @return \OpenAPI\Client\Model\TeamIntegrationLogsSchemaLogsInner[]
     */
     ...
     * Sets logs
     *
     * @param \OpenAPI\Client\Model\TeamIntegrationLogsSchemaLogsInner[] $logs logs
     *
     * @return self
     */
    public function setLogs($logs)
    {
        ...
        if ((count($logs) < 1)) {
            throw new \InvalidArgumentException('invalid length for $logs when calling TeamIntegrationLogsSchema., number of items must be greater than or equal to 1.');
        }
