...
/**
 * PinsAddErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class PinsAddErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pins_add_error_schema';
    ...
    public const ERROR_ALREADY_PINNED = 'already_pinned';
    public const ERROR_PERMISSION_DENIED = 'permission_denied';
    public const ERROR_FILE_NOT_SHARED = 'file_not_shared';
    public const ERROR_NOT_PINNABLE = 'not_pinnable';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_ALREADY_PINNED,
            self::ERROR_PERMISSION_DENIED,
            self::ERROR_FILE_NOT_SHARED,
            self::ERROR_NOT_PINNABLE,
