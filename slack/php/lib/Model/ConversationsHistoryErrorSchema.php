...
/**
 * ConversationsHistoryErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ConversationsHistoryErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversations_history_error_schema';
    ...
    public const ERROR_INVALID_TS_LATEST = 'invalid_ts_latest';
    public const ERROR_INVALID_TS_OLDEST = 'invalid_ts_oldest';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_INVALID_TS_LATEST,
            self::ERROR_INVALID_TS_OLDEST,
