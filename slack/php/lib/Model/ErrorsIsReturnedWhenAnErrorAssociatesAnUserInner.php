...
/**
 * ErrorsIsReturnedWhenAnErrorAssociatesAnUserInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ErrorsIsReturnedWhenAnErrorAssociatesAnUserInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'errors_is_returned_when_an_error_associates_an_user_inner';
    ...
    */
    ...
    public function setUser($user)
    {
        ...
        if (!is_null($user) && (!preg_match("/^[UW][A-Z0-9]{2,}$/", $user))) {
            throw new \InvalidArgumentException("invalid value for \$user when calling ErrorsIsReturnedWhenAnErrorAssociatesAnUserInner., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
