...
/**
 * FilesInfoErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class FilesInfoErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'files_info_error_schema';
    ...
    public const ERROR_FILE_DELETED = 'file_deleted';
    public const ERROR_TIMEZONE_COUNT_FAILED = 'timezone_count_failed';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_FILE_DELETED,
            self::ERROR_TIMEZONE_COUNT_FAILED,
