...
/**
 * ConversationsCloseErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ConversationsCloseErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversations_close_error_schema';
    ...
    public const ERROR_USER_DOES_NOT_OWN_CHANNEL = 'user_does_not_own_channel';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_USER_DOES_NOT_OWN_CHANNEL,
