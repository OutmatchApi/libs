...
/**
 * ConversationsKickErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ConversationsKickErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversations_kick_error_schema';
    ...
    public const ERROR_CANT_KICK_SELF = 'cant_kick_self';
    public const ERROR_NOT_IN_CHANNEL = 'not_in_channel';
    public const ERROR_CANT_KICK_FROM_GENERAL = 'cant_kick_from_general';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_CANT_KICK_SELF,
            self::ERROR_NOT_IN_CHANNEL,
            self::ERROR_CANT_KICK_FROM_GENERAL,
