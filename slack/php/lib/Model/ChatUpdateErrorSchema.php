...
/**
 * ChatUpdateErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatUpdateErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat_update_error_schema';
    ...
    public const ERROR_CANT_UPDATE_MESSAGE = 'cant_update_message';
    public const ERROR_CHANNEL_NOT_FOUND = 'channel_not_found';
    public const ERROR_EDIT_WINDOW_CLOSED = 'edit_window_closed';
    ...
    public const ERROR_IS_INACTIVE = 'is_inactive';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_CANT_UPDATE_MESSAGE,
            self::ERROR_CHANNEL_NOT_FOUND,
            self::ERROR_EDIT_WINDOW_CLOSED,
