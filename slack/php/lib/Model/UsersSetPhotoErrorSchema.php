...
/**
 * UsersSetPhotoErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class UsersSetPhotoErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'users_setPhoto_error_schema';
    ...
    protected static $setters = [
        ...
        'debug_step' => 'setDebugStep',
        'dims' => 'setDims',
        'error' => 'setError',
        'ok' => 'setOk',
        'time_ident' => 'setTimeIdent'
    ];
    ...
    protected static $getters = [
        ...
        'debug_step' => 'getDebugStep',
        'dims' => 'getDims',
        'error' => 'getError',
        'ok' => 'getOk',
        'time_ident' => 'getTimeIdent'
    ];
    ...
    public const ERROR_BAD_IMAGE = 'bad_image';
    public const ERROR_TOO_LARGE = 'too_large';
    public const ERROR_TOO_MANY_FRAMES = 'too_many_frames';
    ...
    {
        return [
            self::ERROR_BAD_IMAGE,
            self::ERROR_TOO_LARGE,
            self::ERROR_TOO_MANY_FRAMES,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('debug_step', $data ?? [], null);
        $this->setIfExists('dims', $data ?? [], null);
        $this->setIfExists('error', $data ?? [], null);
        $this->setIfExists('ok', $data ?? [], null);
        $this->setIfExists('time_ident', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getDebugStep()
    {
        return $this->container['debug_step'];
    }

    /**
     * Sets debug_step
     *
     * @param string|null $debug_step possibly DEV/QA only
     *
     * @return self
     */
    public function setDebugStep($debug_step)
    {

        if (is_null($debug_step)) {
            throw new \InvalidArgumentException('non-nullable debug_step cannot be null');
        }

        $this->container['debug_step'] = $debug_step;
     ...
     * Sets dims
     *
     * @param string|null $dims possibly DEV/QA only
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getTimeIdent()
    {
        return $this->container['time_ident'];
    }

    /**
     * Sets time_ident
     *
     * @param int|null $time_ident possibly DEV/QA only
     *
     * @return self
     */
    public function setTimeIdent($time_ident)
    {

        if (is_null($time_ident)) {
            throw new \InvalidArgumentException('non-nullable time_ident cannot be null');
        }

        $this->container['time_ident'] = $time_ident;
