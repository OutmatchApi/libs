...
/**
 * ChatUnfurlErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatUnfurlErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat_unfurl_error_schema';
    ...
    public const ERROR_CANNOT_UNFURL_URL = 'cannot_unfurl_url';
    public const ERROR_CANNOT_FIND_SERVICE = 'cannot_find_service';
    public const ERROR_MISSING_UNFURLS = 'missing_unfurls';
    public const ERROR_CANNOT_PROMPT = 'cannot_prompt';
    ...
    {
        return [
            self::ERROR_CANNOT_UNFURL_URL,
            self::ERROR_CANNOT_FIND_SERVICE,
            self::ERROR_MISSING_UNFURLS,
            self::ERROR_CANNOT_PROMPT,
