...
/**
 * ConversationsArchiveErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ConversationsArchiveErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversations_archive_error_schema';
    ...
    public const ERROR_ALREADY_ARCHIVED = 'already_archived';
    public const ERROR_CANT_ARCHIVE_GENERAL = 'cant_archive_general';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_ALREADY_ARCHIVED,
            self::ERROR_CANT_ARCHIVE_GENERAL,
