...
/**
 * AdminConversationsSearchErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class AdminConversationsSearchErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_conversations_search_error_schema';
    ...
    public const ERROR_INVALID_SEARCH_CHANNEL_TYPE = 'invalid_search_channel_type';
    public const ERROR_INVALID_SORT = 'invalid_sort';
    public const ERROR_INVALID_SORT_DIR = 'invalid_sort_dir';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_INVALID_SEARCH_CHANNEL_TYPE,
            self::ERROR_INVALID_SORT,
            self::ERROR_INVALID_SORT_DIR,
        ];
    }
