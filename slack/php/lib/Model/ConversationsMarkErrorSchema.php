...
/**
 * ConversationsMarkErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ConversationsMarkErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversations_mark_error_schema';
    ...
    public const ERROR_INVALID_TIMESTAMP = 'invalid_timestamp';
    ...
    public const ERROR_NOT_ALLOWED_TOKEN_TYPE = 'not_allowed_token_type';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_NOT_ALLOWED_TOKEN_TYPE,
        ];
    }
