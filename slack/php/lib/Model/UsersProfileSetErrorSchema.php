...
/**
 * UsersProfileSetErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class UsersProfileSetErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'users_profile_set_error_schema';
    ...
    public const ERROR_RESERVED_NAME = 'reserved_name';
    public const ERROR_INVALID_PROFILE = 'invalid_profile';
    public const ERROR_PROFILE_SET_FAILED = 'profile_set_failed';
    public const ERROR_NOT_ADMIN = 'not_admin';
    public const ERROR_NOT_APP_ADMIN = 'not_app_admin';
    public const ERROR_CANNOT_UPDATE_ADMIN_USER = 'cannot_update_admin_user';
    ...
    {
        return [
            self::ERROR_RESERVED_NAME,
            self::ERROR_INVALID_PROFILE,
            self::ERROR_PROFILE_SET_FAILED,
            self::ERROR_NOT_ADMIN,
            self::ERROR_NOT_APP_ADMIN,
            self::ERROR_CANNOT_UPDATE_ADMIN_USER,
