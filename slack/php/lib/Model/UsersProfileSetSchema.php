...
/**
 * UsersProfileSetSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class UsersProfileSetSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'users_profile_set_schema';
    ...
    {
        $this->setIfExists('email_pending', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['email_pending'];
    }

    /**
     * Sets email_pending
     *
     * @param string|null $email_pending email_pending
     *
     * @return self
     */
    public function setEmailPending($email_pending)
    {

        if (is_null($email_pending)) {
            throw new \InvalidArgumentException('non-nullable email_pending cannot be null');
        }

        $this->container['email_pending'] = $email_pending;
