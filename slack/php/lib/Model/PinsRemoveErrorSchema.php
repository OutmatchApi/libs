...
/**
 * PinsRemoveErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class PinsRemoveErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pins_remove_error_schema';
    ...
    public const ERROR_BAD_TIMESTAMP = 'bad_timestamp';
    public const ERROR_FILE_NOT_FOUND = 'file_not_found';
    public const ERROR_FILE_COMMENT_NOT_FOUND = 'file_comment_not_found';
    public const ERROR_MESSAGE_NOT_FOUND = 'message_not_found';
    public const ERROR_NO_ITEM_SPECIFIED = 'no_item_specified';
    public const ERROR_NOT_PINNED = 'not_pinned';
    ...
    public const ERROR_INVALID_POST_TYP = 'invalid_post_typ';
    public const ERROR_MISSING_POST_TYP = 'missing_post_typ';
    ...
    public const ERROR_REQUEST_TIMEOU = 'request_timeou';
    ...
    {
        return [
            self::ERROR_BAD_TIMESTAMP,
            self::ERROR_FILE_NOT_FOUND,
            self::ERROR_FILE_COMMENT_NOT_FOUND,
            self::ERROR_MESSAGE_NOT_FOUND,
            self::ERROR_NO_ITEM_SPECIFIED,
            self::ERROR_NOT_PINNED,
            ...
            self::ERROR_INVALID_POST_TYP,
            self::ERROR_MISSING_POST_TYP,
            self::ERROR_TEAM_ADDED_TO_ORG,
            self::ERROR_INVALID_JSON,
            self::ERROR_JSON_NOT_OBJECT,
            self::ERROR_REQUEST_TIMEOU,
