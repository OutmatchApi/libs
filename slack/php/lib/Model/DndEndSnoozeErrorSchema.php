...
/**
 * DndEndSnoozeErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class DndEndSnoozeErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dnd_endSnooze_error_schema';
    ...
    public const ERROR_SNOOZE_NOT_ACTIVE = 'snooze_not_active';
    public const ERROR_SNOOZE_END_FAILED = 'snooze_end_failed';
    ...
    {
        return [
            self::ERROR_SNOOZE_NOT_ACTIVE,
            self::ERROR_SNOOZE_END_FAILED,
