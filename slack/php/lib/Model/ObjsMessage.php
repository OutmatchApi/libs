 ...
 */
class ObjsMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setAttachments($attachments)
    {
        ...
        if (!is_null($attachments) && (count($attachments) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attachments when calling ObjsMessage., number of items must be greater than or equal to 1.');
        }
    ...
    public function setFiles($files)
    {
        ...
        if (!is_null($files) && (count($files) < 1)) {
            throw new \InvalidArgumentException('invalid length for $files when calling ObjsMessage., number of items must be greater than or equal to 1.');
        }
    ...
    public function setInviter($inviter)
    {
        ...
        if (!is_null($inviter) && (!preg_match("/^[UW][A-Z0-9]{2,}$/", $inviter))) {
            throw new \InvalidArgumentException("invalid value for \$inviter when calling ObjsMessage., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
    ...
    public function setParentUserId($parent_user_id)
    {
        ...
        if (!is_null($parent_user_id) && (!preg_match("/^[UW][A-Z0-9]{2,}$/", $parent_user_id))) {
            throw new \InvalidArgumentException("invalid value for \$parent_user_id when calling ObjsMessage., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
    ...
    public function setReplyUsers($reply_users)
    {
        ...
        if (!is_null($reply_users) && (count($reply_users) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reply_users when calling ObjsMessage., number of items must be greater than or equal to 1.');
        }
    ...
    public function setUser($user)
    {
        ...
        if (!is_null($user) && (!preg_match("/^[UW][A-Z0-9]{2,}$/", $user))) {
            throw new \InvalidArgumentException("invalid value for \$user when calling ObjsMessage., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
