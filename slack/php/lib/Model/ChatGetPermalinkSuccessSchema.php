...
/**
 * ChatGetPermalinkSuccessSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatGetPermalinkSuccessSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat_getPermalink_success_schema';
    ...
    */
    ...
    public function setChannel($channel)
    {
        ...
        if ((!preg_match("/^[CGD][A-Z0-9]{8,}$/", $channel))) {
            throw new \InvalidArgumentException("invalid value for \$channel when calling ChatGetPermalinkSuccessSchema., must conform to the pattern /^[CGD][A-Z0-9]{8,}$/.");
        }
