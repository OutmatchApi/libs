...
/**
 * ChatDeleteErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatDeleteErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat_delete_error_schema';
    ...
    public const ERROR_CANT_DELETE_MESSAGE = 'cant_delete_message';
    public const ERROR_COMPLIANCE_EXPORTS_PREVENT_DELETION = 'compliance_exports_prevent_deletion';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_CANT_DELETE_MESSAGE,
            self::ERROR_COMPLIANCE_EXPORTS_PREVENT_DELETION,
