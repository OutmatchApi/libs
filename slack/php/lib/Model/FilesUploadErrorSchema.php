...
/**
 * FilesUploadErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class FilesUploadErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'files_upload_error_schema';
    ...
    public const ERROR_POSTING_TO_GENERAL_CHANNEL_DENIED = 'posting_to_general_channel_denied';
    public const ERROR_INVALID_CHANNEL = 'invalid_channel';
    public const ERROR_FILE_UPLOADS_DISABLED = 'file_uploads_disabled';
    public const ERROR_FILE_UPLOADS_EXCEPT_IMAGES_DISABLED = 'file_uploads_except_images_disabled';
    public const ERROR_STORAGE_LIMIT_REACHED = 'storage_limit_reached';
    ...
    {
        return [
            self::ERROR_POSTING_TO_GENERAL_CHANNEL_DENIED,
            self::ERROR_INVALID_CHANNEL,
            self::ERROR_FILE_UPLOADS_DISABLED,
            self::ERROR_FILE_UPLOADS_EXCEPT_IMAGES_DISABLED,
            self::ERROR_STORAGE_LIMIT_REACHED,
