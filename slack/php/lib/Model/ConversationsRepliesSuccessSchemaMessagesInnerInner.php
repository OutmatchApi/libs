...
/**
 * ConversationsRepliesSuccessSchemaMessagesInnerInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConversationsRepliesSuccessSchemaMessagesInnerInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversations_replies_success_schema_messages_inner_inner';
    ...
    */
    ...
    public function setLastRead($last_read)
    {
        ...
        if (!is_null($last_read) && (!preg_match("/^\\d{10}\\.\\d{6}$/", $last_read))) {
            throw new \InvalidArgumentException("invalid value for \$last_read when calling ConversationsRepliesSuccessSchemaMessagesInnerInner., must conform to the pattern /^\\d{10}\\.\\d{6}$/.");
        }
    ...
    public function setLatestReply($latest_reply)
    {
        ...
        if (!is_null($latest_reply) && (!preg_match("/^\\d{10}\\.\\d{6}$/", $latest_reply))) {
            throw new \InvalidArgumentException("invalid value for \$latest_reply when calling ConversationsRepliesSuccessSchemaMessagesInnerInner., must conform to the pattern /^\\d{10}\\.\\d{6}$/.");
        }
    ...
    public function setSourceTeam($source_team)
    {
        ...
        if (!is_null($source_team) && (!preg_match("/^[T][A-Z0-9]{2,}$/", $source_team))) {
            throw new \InvalidArgumentException("invalid value for \$source_team when calling ConversationsRepliesSuccessSchemaMessagesInnerInner., must conform to the pattern /^[T][A-Z0-9]{2,}$/.");
        }
    ...
    public function setTeam($team)
    {
        ...
        if (!is_null($team) && (!preg_match("/^[T][A-Z0-9]{2,}$/", $team))) {
            throw new \InvalidArgumentException("invalid value for \$team when calling ConversationsRepliesSuccessSchemaMessagesInnerInner., must conform to the pattern /^[T][A-Z0-9]{2,}$/.");
        }
    ...
    public function setThreadTs($thread_ts)
    {
        ...
        if ((!preg_match("/^\\d{10}\\.\\d{6}$/", $thread_ts))) {
            throw new \InvalidArgumentException("invalid value for \$thread_ts when calling ConversationsRepliesSuccessSchemaMessagesInnerInner., must conform to the pattern /^\\d{10}\\.\\d{6}$/.");
        }
    ...
    public function setTs($ts)
    {
        ...
        if ((!preg_match("/^\\d{10}\\.\\d{6}$/", $ts))) {
            throw new \InvalidArgumentException("invalid value for \$ts when calling ConversationsRepliesSuccessSchemaMessagesInnerInner., must conform to the pattern /^\\d{10}\\.\\d{6}$/.");
        }
    ...
    public function setUser($user)
    {
        ...
        if ((!preg_match("/^[UW][A-Z0-9]{2,}$/", $user))) {
            throw new \InvalidArgumentException("invalid value for \$user when calling ConversationsRepliesSuccessSchemaMessagesInnerInner., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
    ...
    public function setUserTeam($user_team)
    {
        ...
        if (!is_null($user_team) && (!preg_match("/^[T][A-Z0-9]{2,}$/", $user_team))) {
            throw new \InvalidArgumentException("invalid value for \$user_team when calling ConversationsRepliesSuccessSchemaMessagesInnerInner., must conform to the pattern /^[T][A-Z0-9]{2,}$/.");
        }
    ...
    public function setParentUserId($parent_user_id)
    {
        ...
        if ((!preg_match("/^[UW][A-Z0-9]{2,}$/", $parent_user_id))) {
            throw new \InvalidArgumentException("invalid value for \$parent_user_id when calling ConversationsRepliesSuccessSchemaMessagesInnerInner., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
