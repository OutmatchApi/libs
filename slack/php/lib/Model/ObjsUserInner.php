...
/**
 * ObjsUserInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ObjsUserInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'objs_user_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['teams']) && (count($this->container['teams']) < 1)) {
            $invalidProperties[] = "invalid value for 'teams', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets color
     *
     * @param string|null $color refercing to bug: https://jira.tinyspeck.com/browse/EVALUE-1559
     *
     * @return self
     */
    public function setColor($color)
    {
        ...
        if (!is_null($color) && (!preg_match("/^([a-fA-F0-9]{6})?$/", $color))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling ObjsUserInner., must conform to the pattern /^([a-fA-F0-9]{6})?$/.");
        }
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[UW][A-Z0-9]{2,}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling ObjsUserInner., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
    ...
    public function setTeam($team)
    {
        ...
        if (!is_null($team) && (!preg_match("/^[TE][A-Z0-9]{8,}$/", $team))) {
            throw new \InvalidArgumentException("invalid value for \$team when calling ObjsUserInner., must conform to the pattern /^[TE][A-Z0-9]{8,}$/.");
        }
    ...
    public function setTeamId($team_id)
    {
        ...
        if (!is_null($team_id) && (!preg_match("/^[TE][A-Z0-9]{8,}$/", $team_id))) {
            throw new \InvalidArgumentException("invalid value for \$team_id when calling ObjsUserInner., must conform to the pattern /^[TE][A-Z0-9]{8,}$/.");
        }
    ...
    public function setTeams($teams)
    {
        ...
        if (!is_null($teams) && (count($teams) < 1)) {
            throw new \InvalidArgumentException('invalid length for $teams when calling ObjsUserInner., number of items must be greater than or equal to 1.');
        }
