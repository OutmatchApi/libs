...
/**
 * ChatScheduleMessageErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatScheduleMessageErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat_scheduleMessage_error_schema';
    ...
    public const ERROR_TIME_IN_PAST = 'time_in_past';
    public const ERROR_TIME_TOO_FAR = 'time_too_far';
    ...
    public const ERROR_MSG_TOO_LONG = 'msg_too_long';
    public const ERROR_NO_TEXT = 'no_text';
    public const ERROR_RESTRICTED_ACTION = 'restricted_action';
    public const ERROR_RESTRICTED_ACTION_READ_ONLY_CHANNEL = 'restricted_action_read_only_channel';
    public const ERROR_RESTRICTED_ACTION_THREAD_ONLY_CHANNEL = 'restricted_action_thread_only_channel';
    public const ERROR_RESTRICTED_ACTION_NON_THREADABLE_CHANNEL = 'restricted_action_non_threadable_channel';
    public const ERROR_TOO_MANY_ATTACHMENTS = 'too_many_attachments';
    ...
    public const ERROR_EKM_ACCESS_DENIED = 'ekm_access_denied';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_TIME_IN_PAST,
            self::ERROR_TIME_TOO_FAR,
            self::ERROR_CHANNEL_NOT_FOUND,
            self::ERROR_NOT_IN_CHANNEL,
            self::ERROR_IS_ARCHIVED,
            self::ERROR_MSG_TOO_LONG,
            self::ERROR_NO_TEXT,
            self::ERROR_RESTRICTED_ACTION,
            self::ERROR_RESTRICTED_ACTION_READ_ONLY_CHANNEL,
            self::ERROR_RESTRICTED_ACTION_THREAD_ONLY_CHANNEL,
            self::ERROR_RESTRICTED_ACTION_NON_THREADABLE_CHANNEL,
            self::ERROR_TOO_MANY_ATTACHMENTS,
            ...
            self::ERROR_EKM_ACCESS_DENIED,
            self::ERROR_MISSING_SCOPE,
            self::ERROR_INVALID_ARGUMENTS,
