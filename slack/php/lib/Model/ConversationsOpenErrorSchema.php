...
/**
 * ConversationsOpenErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ConversationsOpenErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversations_open_error_schema';
    ...
    public const ERROR_USER_NOT_VISIBLE = 'user_not_visible';
    public const ERROR_USER_DISABLED = 'user_disabled';
    public const ERROR_USERS_LIST_NOT_SUPPLIED = 'users_list_not_supplied';
    public const ERROR_NOT_ENOUGH_USERS = 'not_enough_users';
    public const ERROR_TOO_MANY_USERS = 'too_many_users';
    public const ERROR_INVALID_USER_COMBINATION = 'invalid_user_combination';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_USER_NOT_VISIBLE,
            self::ERROR_USER_DISABLED,
            self::ERROR_USERS_LIST_NOT_SUPPLIED,
            self::ERROR_NOT_ENOUGH_USERS,
            self::ERROR_TOO_MANY_USERS,
            self::ERROR_INVALID_USER_COMBINATION,
