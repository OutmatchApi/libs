...
/**
 * ChatDeleteScheduledMessageErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatDeleteScheduledMessageErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat_deleteScheduledMessage_error_schema';
    ...
    public const ERROR_INVALID_SCHEDULED_MESSAGE_ID = 'invalid_scheduled_message_id';
    ...
    {
        return [
            self::ERROR_INVALID_SCHEDULED_MESSAGE_ID,
