...
/**
 * ObjsConversationInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ObjsConversationInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'objs_conversation_inner';
    ...
    */
    ...
    public function setAcceptedUser($accepted_user)
    {
        ...
        if (!is_null($accepted_user) && (!preg_match("/^[UW][A-Z0-9]{2,}$/", $accepted_user))) {
            throw new \InvalidArgumentException("invalid value for \$accepted_user when calling ObjsConversationInner., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
    ...
    public function setConnectedTeamIds($connected_team_ids)
    {
        ...
        if (!is_null($connected_team_ids) && (count($connected_team_ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $connected_team_ids when calling ObjsConversationInner., number of items must be greater than or equal to 0.');
        }
    ...
    public function setConversationHostId($conversation_host_id)
    {
        ...
        if (!is_null($conversation_host_id) && (!preg_match("/^[TE][A-Z0-9]{8,}$/", $conversation_host_id))) {
            throw new \InvalidArgumentException("invalid value for \$conversation_host_id when calling ObjsConversationInner., must conform to the pattern /^[TE][A-Z0-9]{8,}$/.");
        }
    ...
    public function setCreator($creator)
    {
        ...
        if ((!preg_match("/^[UW][A-Z0-9]{2,}$/", $creator))) {
            throw new \InvalidArgumentException("invalid value for \$creator when calling ObjsConversationInner., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
    ...
    public function setEnterpriseId($enterprise_id)
    {
        ...
        if (!is_null($enterprise_id) && (!preg_match("/^[E][A-Z0-9]{8,}$/", $enterprise_id))) {
            throw new \InvalidArgumentException("invalid value for \$enterprise_id when calling ObjsConversationInner., must conform to the pattern /^[E][A-Z0-9]{8,}$/.");
        }
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[D][A-Z0-9]{8,}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling ObjsConversationInner., must conform to the pattern /^[D][A-Z0-9]{8,}$/.");
        }
    ...
    public function setInternalTeamIds($internal_team_ids)
    {
        ...
        if (!is_null($internal_team_ids) && (count($internal_team_ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $internal_team_ids when calling ObjsConversationInner., number of items must be greater than or equal to 0.');
        }
    ...
    public function setLastRead($last_read)
    {
        ...
        if (!is_null($last_read) && (!preg_match("/^\\d{10}\\.\\d{6}$/", $last_read))) {
            throw new \InvalidArgumentException("invalid value for \$last_read when calling ObjsConversationInner., must conform to the pattern /^\\d{10}\\.\\d{6}$/.");
        }
    ...
    public function setMembers($members)
    {
        ...
        if (!is_null($members) && (count($members) < 0)) {
            throw new \InvalidArgumentException('invalid length for $members when calling ObjsConversationInner., number of items must be greater than or equal to 0.');
        }
    ...
    public function setPendingConnectedTeamIds($pending_connected_team_ids)
    {
        ...
        if (!is_null($pending_connected_team_ids) && (count($pending_connected_team_ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $pending_connected_team_ids when calling ObjsConversationInner., number of items must be greater than or equal to 0.');
        }
    ...
    public function setPendingShared($pending_shared)
    {
        ...
        if (!is_null($pending_shared) && (count($pending_shared) < 0)) {
            throw new \InvalidArgumentException('invalid length for $pending_shared when calling ObjsConversationInner., number of items must be greater than or equal to 0.');
        }
    ...
    public function setPreviousNames($previous_names)
    {
        ...
        if (!is_null($previous_names) && (count($previous_names) < 0)) {
            throw new \InvalidArgumentException('invalid length for $previous_names when calling ObjsConversationInner., number of items must be greater than or equal to 0.');
        }
    ...
    public function setSharedTeamIds($shared_team_ids)
    {
        ...
        if (!is_null($shared_team_ids) && (count($shared_team_ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shared_team_ids when calling ObjsConversationInner., number of items must be greater than or equal to 0.');
        }
    ...
    public function setShares($shares)
    {
        ...
        if (!is_null($shares) && (count($shares) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shares when calling ObjsConversationInner., number of items must be greater than or equal to 0.');
        }
    ...
    public function setUser($user)
    {
        ...
        if ((!preg_match("/^[UW][A-Z0-9]{2,}$/", $user))) {
            throw new \InvalidArgumentException("invalid value for \$user when calling ObjsConversationInner., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
