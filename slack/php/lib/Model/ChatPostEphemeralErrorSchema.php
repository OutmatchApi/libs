...
/**
 * ChatPostEphemeralErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatPostEphemeralErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat_postEphemeral_error_schema';
    ...
    public const ERROR_USER_NOT_IN_CHANNEL = 'user_not_in_channel';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_USER_NOT_IN_CHANNEL,
