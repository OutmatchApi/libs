...
/**
 * StarsListSchemaItemsInnerInnerAnyOf3 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StarsListSchemaItemsInnerInnerAnyOf3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stars_list_schema_items_inner_inner_anyOf_3';
    ...
    */
    ...
    public function setChannel($channel)
    {
        ...
        if ((!preg_match("/^[CGD][A-Z0-9]{8,}$/", $channel))) {
            throw new \InvalidArgumentException("invalid value for \$channel when calling StarsListSchemaItemsInnerInnerAnyOf3., must conform to the pattern /^[CGD][A-Z0-9]{8,}$/.");
        }
