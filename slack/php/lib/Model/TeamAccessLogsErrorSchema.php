...
/**
 * TeamAccessLogsErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class TeamAccessLogsErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'team_accessLogs_error_schema';
    ...
    public const ERROR_PAID_ONLY = 'paid_only';
    public const ERROR_OVER_PAGINATION_LIMIT = 'over_pagination_limit';
    ...
    {
        return [
            self::ERROR_PAID_ONLY,
            self::ERROR_OVER_PAGINATION_LIMIT,
