...
/**
 * UsergroupsUsersUpdateSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class UsergroupsUsersUpdateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usergroups_users_update_schema';
    ...
    protected static $openAPITypes = [
        ...
        'usergroup' => '\OpenAPI\Client\Model\ObjsSubteam'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('usergroup', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets usergroup
     *
     * @return \OpenAPI\Client\Model\ObjsSubteam
     */
     ...
     * Sets usergroup
     *
     * @param \OpenAPI\Client\Model\ObjsSubteam $usergroup usergroup
     *
     * @return self
     */
    public function setUsergroup($usergroup)
    {
        ...
        if (is_null($usergroup)) {
            throw new \InvalidArgumentException('non-nullable usergroup cannot be null');
        }
