...
/**
 * DndSetSnoozeErrorSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class DndSetSnoozeErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dnd_setSnooze_error_schema';
    ...
    public const ERROR_MISSING_DURATION = 'missing_duration';
    public const ERROR_SNOOZE_FAILED = 'snooze_failed';
    ...
    {
        return [
            self::ERROR_MISSING_DURATION,
            self::ERROR_SNOOZE_FAILED,
