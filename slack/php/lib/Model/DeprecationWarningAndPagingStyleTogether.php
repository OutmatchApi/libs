...
/**
 * DeprecationWarningAndPagingStyleTogether Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeprecationWarningAndPagingStyleTogether implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deprecation_warning_and_paging_style_together';
    ...
    public const WARNINGS_METHOD_DEPRECATED = 'method_deprecated';
    ...
    {
        return [
            self::WARNINGS_METHOD_DEPRECATED,
        ];
    }
    ...
    */
    ...
    {
        $allowedValues = $this->getWarningsAllowableValues();
        if (array_diff($warnings, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'warnings', must be one of '%s'",
