...
/**
 * ConversationsOpenSuccessSchemaChannelInnerAnyOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConversationsOpenSuccessSchemaChannelInnerAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'conversations_open_success_schema_channel_inner_anyOf';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[D][A-Z0-9]{8,}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling ConversationsOpenSuccessSchemaChannelInnerAnyOf., must conform to the pattern /^[D][A-Z0-9]{8,}$/.");
        }
    ...
    public function setLastRead($last_read)
    {
        ...
        if (!is_null($last_read) && (!preg_match("/^\\d{10}\\.\\d{6}$/", $last_read))) {
            throw new \InvalidArgumentException("invalid value for \$last_read when calling ConversationsOpenSuccessSchemaChannelInnerAnyOf., must conform to the pattern /^\\d{10}\\.\\d{6}$/.");
        }
    ...
    public function setUser($user)
    {
        ...
        if (!is_null($user) && (!preg_match("/^[UW][A-Z0-9]{2,}$/", $user))) {
            throw new \InvalidArgumentException("invalid value for \$user when calling ConversationsOpenSuccessSchemaChannelInnerAnyOf., must conform to the pattern /^[UW][A-Z0-9]{2,}$/.");
        }
