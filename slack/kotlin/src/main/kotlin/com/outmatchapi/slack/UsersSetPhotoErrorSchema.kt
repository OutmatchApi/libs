 ...
 * @param debugStep possibly DEV/QA only
 * @param dims possibly DEV/QA only
 * @param timeIdent possibly DEV/QA only
 */


data class UsersSetPhotoErrorSchema (

    @Json(name = "error")
    val error: UsersSetPhotoErrorSchema.Error,
    ...
    @Json(name = "debug_step")
    val debugStep: kotlin.String? = null,

    /* possibly DEV/QA only */
    @Json(name = "dims")
    val dims: kotlin.String? = null,

    /* possibly DEV/QA only */
    @Json(name = "time_ident")
    val timeIdent: kotlin.Int? = null
     ...
     * 
     *
     * Values: badImage,tooLarge,tooManyFrames,notFound,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "bad_image") badImage("bad_image"),
        @Json(name = "too_large") tooLarge("too_large"),
        @Json(name = "too_many_frames") tooManyFrames("too_many_frames"),
        @Json(name = "not_found") notFound("not_found"),
