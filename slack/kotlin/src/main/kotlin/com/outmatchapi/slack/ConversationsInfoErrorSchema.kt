...
data class ConversationsInfoErrorSchema (

    @Json(name = "error")
    val error: ConversationsInfoErrorSchema.Error,
     ...
     * 
     *
     * Values: missingScope,channelNotFound,teamAddedToOrg,notAuthed,invalidAuth,accountInactive,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
