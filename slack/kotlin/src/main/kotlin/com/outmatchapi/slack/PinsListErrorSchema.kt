...
data class PinsListErrorSchema (

    @Json(name = "error")
    val error: PinsListErrorSchema.Error,
     ...
     * 
     *
     * Values: channelNotFound,notAuthed,invalidAuth,accountInactive,noPermission,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
