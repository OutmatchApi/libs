...
data class DndEndSnoozeErrorSchema (

    @Json(name = "error")
    val error: DndEndSnoozeErrorSchema.Error,
     ...
     * 
     *
     * Values: snoozeNotActive,snoozeEndFailed,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "snooze_not_active") snoozeNotActive("snooze_not_active"),
        @Json(name = "snooze_end_failed") snoozeEndFailed("snooze_end_failed"),
