...
data class UsergroupsUsersListErrorSchema (

    @Json(name = "error")
    val error: UsergroupsUsersListErrorSchema.Error,
     ...
     * 
     *
     * Values: notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,userIsRestricted,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequire,fatalError,missingCharset,superfluousCharset
     */
