...
data class UsersSetPresenceErrorSchema (

    @Json(name = "error")
    val error: UsersSetPresenceErrorSchema.Error,
     ...
     * 
     *
     * Values: invalidPresence,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "invalid_presence") invalidPresence("invalid_presence"),
