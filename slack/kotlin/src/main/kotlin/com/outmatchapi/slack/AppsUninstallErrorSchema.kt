...
data class AppsUninstallErrorSchema (

    @Json(name = "error")
    val error: AppsUninstallErrorSchema.Error,
     ...
     * 
     *
     * Values: invalidClientId,badClientSecret,clientIdTokenMismatch,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "invalid_client_id") invalidClientId("invalid_client_id"),
        @Json(name = "bad_client_secret") badClientSecret("bad_client_secret"),
        @Json(name = "client_id_token_mismatch") clientIdTokenMismatch("client_id_token_mismatch"),
