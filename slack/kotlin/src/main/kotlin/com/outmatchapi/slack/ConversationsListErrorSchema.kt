...
data class ConversationsListErrorSchema (

    @Json(name = "error")
    val error: ConversationsListErrorSchema.Error,
     ...
     * 
     *
     * Values: missingScope,notAuthed,invalidAuth,accountInactive,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
