...
data class RemindersAddErrorSchema (

    @Json(name = "error")
    val error: RemindersAddErrorSchema.Error,
     ...
     * 
     *
     * Values: cannotParse,userNotFound,cannotAddBot,cannotAddSlackbot,cannotAddOthers,cannotAddOthersRecurring,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "cannot_parse") cannotParse("cannot_parse"),
        @Json(name = "user_not_found") userNotFound("user_not_found"),
        @Json(name = "cannot_add_bot") cannotAddBot("cannot_add_bot"),
        @Json(name = "cannot_add_slackbot") cannotAddSlackbot("cannot_add_slackbot"),
        @Json(name = "cannot_add_others") cannotAddOthers("cannot_add_others"),
        @Json(name = "cannot_add_others_recurring") cannotAddOthersRecurring("cannot_add_others_recurring"),
