...
data class ChatUnfurlErrorSchema (

    @Json(name = "error")
    val error: ChatUnfurlErrorSchema.Error,
     ...
     * 
     *
     * Values: cannotUnfurlUrl,cannotFindService,missingUnfurls,cannotPrompt,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "cannot_unfurl_url") cannotUnfurlUrl("cannot_unfurl_url"),
        @Json(name = "cannot_find_service") cannotFindService("cannot_find_service"),
        @Json(name = "missing_unfurls") missingUnfurls("missing_unfurls"),
        @Json(name = "cannot_prompt") cannotPrompt("cannot_prompt"),
