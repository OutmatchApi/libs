...
data class ReactionsGetErrorSchema (

    @Json(name = "error")
    val error: ReactionsGetErrorSchema.Error,
     ...
     * 
     *
     * Values: badTimestamp,fileNotFound,fileCommentNotFound,messageNotFound,noItemSpecified,notAuthed,invalidAuth,accountInactive,noPermission,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
