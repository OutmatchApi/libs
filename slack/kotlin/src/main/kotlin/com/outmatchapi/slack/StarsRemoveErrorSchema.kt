...
data class StarsRemoveErrorSchema (

    @Json(name = "error")
    val error: StarsRemoveErrorSchema.Error,
    ...
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "not_starred") notStarred("not_starred"),
