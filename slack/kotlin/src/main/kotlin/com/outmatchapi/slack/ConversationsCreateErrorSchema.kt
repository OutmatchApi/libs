...
data class ConversationsCreateErrorSchema (

    @Json(name = "error")
    val error: ConversationsCreateErrorSchema.Error,
     ...
     * 
     *
     * Values: methodNotSupportedForChannelType,missingScope,nameTaken,restrictedAction,noChannel,invalidNameRequired,invalidNamePunctuation,invalidNameMaxlength,invalidNameSpecials,invalidName,notAuthed,invalidAuth,accountInactive,userIsBot,userIsRestricted,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "no_channel") noChannel("no_channel"),
