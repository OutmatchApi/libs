...
data class RemindersDeleteErrorSchema (

    @Json(name = "error")
    val error: RemindersDeleteErrorSchema.Error,
     ...
     * 
     *
     * Values: notFound,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
