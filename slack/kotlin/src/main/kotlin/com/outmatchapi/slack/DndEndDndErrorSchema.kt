...
data class DndEndDndErrorSchema (

    @Json(name = "error")
    val error: DndEndDndErrorSchema.Error,
     ...
     * 
     *
     * Values: unknownError,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "unknown_error") unknownError("unknown_error"),
