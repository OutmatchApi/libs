...
data class UsersProfileSetErrorSchema (

    @Json(name = "error")
    val error: UsersProfileSetErrorSchema.Error,
     ...
     * 
     *
     * Values: reservedName,invalidProfile,profileSetFailed,notAdmin,notAppAdmin,cannotUpdateAdminUser,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "reserved_name") reservedName("reserved_name"),
        @Json(name = "invalid_profile") invalidProfile("invalid_profile"),
        @Json(name = "profile_set_failed") profileSetFailed("profile_set_failed"),
        @Json(name = "not_admin") notAdmin("not_admin"),
        @Json(name = "not_app_admin") notAppAdmin("not_app_admin"),
        @Json(name = "cannot_update_admin_user") cannotUpdateAdminUser("cannot_update_admin_user"),
