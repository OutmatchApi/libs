...
data class AppsPermissionsScopesListErrorSchema (

    @Json(name = "error")
    val error: AppsPermissionsScopesListErrorSchema.Error,
     ...
     * 
     *
     * Values: notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
