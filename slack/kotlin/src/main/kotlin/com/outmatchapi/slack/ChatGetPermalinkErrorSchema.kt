...
data class ChatGetPermalinkErrorSchema (

    @Json(name = "error")
    val error: ChatGetPermalinkErrorSchema.Error,
     ...
     * 
     *
     * Values: channelNotFound,messageNotFound,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
