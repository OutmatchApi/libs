...
data class StarsAddErrorSchema (

    @Json(name = "error")
    val error: StarsAddErrorSchema.Error,
     ...
     * 
     *
     * Values: badTimestamp,messageNotFound,fileNotFound,fileCommentNotFound,channelNotFound,noItemSpecified,alreadyStarred,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "already_starred") alreadyStarred("already_starred"),
