...
data class RemindersCompleteErrorSchema (

    @Json(name = "error")
    val error: RemindersCompleteErrorSchema.Error,
     ...
     * 
     *
     * Values: notFound,cannotCompleteRecurring,cannotCompleteOthers,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "not_found") notFound("not_found"),
        @Json(name = "cannot_complete_recurring") cannotCompleteRecurring("cannot_complete_recurring"),
        @Json(name = "cannot_complete_others") cannotCompleteOthers("cannot_complete_others"),
