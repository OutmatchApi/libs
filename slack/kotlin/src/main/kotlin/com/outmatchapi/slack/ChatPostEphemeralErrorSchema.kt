...
data class ChatPostEphemeralErrorSchema (

    @Json(name = "error")
    val error: ChatPostEphemeralErrorSchema.Error,
     ...
     * 
     *
     * Values: channelNotFound,isArchived,msgTooLong,noText,restrictedAction,tooManyAttachments,userNotInChannel,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "user_not_in_channel") userNotInChannel("user_not_in_channel"),
