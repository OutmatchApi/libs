...
data class ConversationsRepliesErrorSchema (

    @Json(name = "error")
    val error: ConversationsRepliesErrorSchema.Error,
     ...
     * 
     *
     * Values: missingScope,channelNotFound,threadNotFound,notAuthed,invalidAuth,accountInactive,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "thread_not_found") threadNotFound("thread_not_found"),
