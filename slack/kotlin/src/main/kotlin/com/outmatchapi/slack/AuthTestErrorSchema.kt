...
data class AuthTestErrorSchema (

    @Json(name = "error")
    val error: AuthTestErrorSchema.Error,
     ...
     * 
     *
     * Values: notAuthed,invalidAuth,tokenRevoked,accountInactive,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
