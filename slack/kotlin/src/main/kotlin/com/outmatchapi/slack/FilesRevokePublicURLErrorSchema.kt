...
data class FilesRevokePublicURLErrorSchema (

    @Json(name = "error")
    val error: FilesRevokePublicURLErrorSchema.Error,
     ...
     * 
     *
     * Values: fileNotFound,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,userIsRestricted,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
