...
data class MigrationExchangeErrorSchema (

    @Json(name = "error")
    val error: MigrationExchangeErrorSchema.Error,
     ...
     * 
     *
     * Values: notEnterpriseTeam,tooManyUsers,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "not_enterprise_team") notEnterpriseTeam("not_enterprise_team"),
