...
data class AppsPermissionsResourcesListErrorSchema (

    @Json(name = "error")
    val error: AppsPermissionsResourcesListErrorSchema.Error,
     ...
     * 
     *
     * Values: invalidCursor,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
