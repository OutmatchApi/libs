...
data class TeamAccessLogsErrorSchema (

    @Json(name = "error")
    val error: TeamAccessLogsErrorSchema.Error,
     ...
     * 
     *
     * Values: paidOnly,overPaginationLimit,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "paid_only") paidOnly("paid_only"),
        @Json(name = "over_pagination_limit") overPaginationLimit("over_pagination_limit"),
