...
data class FilesListErrorSchema (

    @Json(name = "error")
    val error: FilesListErrorSchema.Error,
     ...
     * 
     *
     * Values: userNotFound,unknownType,notAuthed,invalidAuth,accountInactive,noPermission,userIsBot,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "user_not_found") userNotFound("user_not_found"),
        @Json(name = "unknown_type") unknownType("unknown_type"),
