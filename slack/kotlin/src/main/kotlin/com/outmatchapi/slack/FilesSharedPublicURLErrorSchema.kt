...
data class FilesSharedPublicURLErrorSchema (

    @Json(name = "error")
    val error: FilesSharedPublicURLErrorSchema.Error,
     ...
     * 
     *
     * Values: fileNotFound,notAllowed,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,userIsRestricted,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
