...
data class ConversationsMarkErrorSchema (

    @Json(name = "error")
    val error: ConversationsMarkErrorSchema.Error,
     ...
     * 
     *
     * Values: methodNotSupportedForChannelType,missingScope,channelNotFound,invalidTimestamp,notInChannel,notAuthed,invalidAuth,accountInactive,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,notAllowedTokenType
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "invalid_timestamp") invalidTimestamp("invalid_timestamp"),
        ...
        @Json(name = "not_allowed_token_type") notAllowedTokenType("not_allowed_token_type");
    }
}
