...
data class ConversationsHistoryErrorSchema (

    @Json(name = "error")
    val error: ConversationsHistoryErrorSchema.Error,
     ...
     * 
     *
     * Values: missingScope,channelNotFound,invalidTsLatest,invalidTsOldest,notAuthed,invalidAuth,accountInactive,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "invalid_ts_latest") invalidTsLatest("invalid_ts_latest"),
        @Json(name = "invalid_ts_oldest") invalidTsOldest("invalid_ts_oldest"),
