...
data class AuthRevokeErrorSchema (

    @Json(name = "error")
    val error: AuthRevokeErrorSchema.Error,
     ...
     * 
     *
     * Values: notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
