...
data class ReactionsListErrorSchema (

    @Json(name = "error")
    val error: ReactionsListErrorSchema.Error,
     ...
     * 
     *
     * Values: userNotFound,notAuthed,invalidAuth,accountInactiv,noPermission,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "account_inactiv") accountInactiv("account_inactiv"),
