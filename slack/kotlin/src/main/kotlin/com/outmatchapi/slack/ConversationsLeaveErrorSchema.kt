...
data class ConversationsLeaveErrorSchema (

    @Json(name = "error")
    val error: ConversationsLeaveErrorSchema.Error,
     ...
     * 
     *
     * Values: methodNotSupportedForChannelType,lastMember,missingScope,channelNotFound,isArchived,cantLeaveGeneral,notAuthed,invalidAuth,accountInactive,userIsBot,userIsRestricted,userIsUltraRestricted,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,teamAddedToOrg,missingCharset,superfluousCharset
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "last_member") lastMember("last_member"),
        ...
        @Json(name = "cant_leave_general") cantLeaveGeneral("cant_leave_general"),
