...
data class FilesInfoErrorSchema (

    @Json(name = "error")
    val error: FilesInfoErrorSchema.Error,
     ...
     * 
     *
     * Values: fileNotFound,fileDeleted,timezoneCountFailed,notAuthed,invalidAuth,accountInactive,noPermission,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "file_not_found") fileNotFound("file_not_found"),
        @Json(name = "file_deleted") fileDeleted("file_deleted"),
        @Json(name = "timezone_count_failed") timezoneCountFailed("timezone_count_failed"),
