...
data class BotsInfoErrorSchema (

    @Json(name = "error")
    val error: BotsInfoErrorSchema.Error,
     ...
     * 
     *
     * Values: botNotFound,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "bot_not_found") botNotFound("bot_not_found"),
