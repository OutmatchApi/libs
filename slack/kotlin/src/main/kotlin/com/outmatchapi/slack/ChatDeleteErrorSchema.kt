...
data class ChatDeleteErrorSchema (

    @Json(name = "error")
    val error: ChatDeleteErrorSchema.Error,
     ...
     * 
     *
     * Values: messageNotFound,channelNotFound,cantDeleteMessage,complianceExportsPreventDeletion,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "cant_delete_message") cantDeleteMessage("cant_delete_message"),
        @Json(name = "compliance_exports_prevent_deletion") complianceExportsPreventDeletion("compliance_exports_prevent_deletion"),
