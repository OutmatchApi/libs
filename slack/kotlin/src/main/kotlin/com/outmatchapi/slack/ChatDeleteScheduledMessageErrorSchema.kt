...
data class ChatDeleteScheduledMessageErrorSchema (

    @Json(name = "error")
    val error: ChatDeleteScheduledMessageErrorSchema.Error,
     ...
     * 
     *
     * Values: invalidScheduledMessageId,channelNotFound,badToken,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,ekmAccessDenied,missingScope,invalidArguments,invalidArgName,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired,fatalError
     */
    enum class Error(val value: kotlin.String) {
        @Json(name = "invalid_scheduled_message_id") invalidScheduledMessageId("invalid_scheduled_message_id"),
        @Json(name = "channel_not_found") channelNotFound("channel_not_found"),
        @Json(name = "bad_token") badToken("bad_token"),
