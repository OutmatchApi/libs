...
data class FilesDeleteErrorSchema (

    @Json(name = "error")
    val error: FilesDeleteErrorSchema.Error,
     ...
     * 
     *
     * Values: fileNotFound,fileDeleted,cantDeleteFile,notAuthed,invalidAuth,accountInactive,noPermission,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequired
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "cant_delete_file") cantDeleteFile("cant_delete_file"),
