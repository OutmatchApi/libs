...
data class UsergroupsUsersUpdateErrorSchema (

    @Json(name = "error")
    val error: UsergroupsUsersUpdateErrorSchema.Error,
     ...
     * 
     *
     * Values: permissionDenied,notAuthed,invalidAuth,accountInactive,tokenRevoked,noPermission,orgLoginRequired,userIsBot,userIsRestricted,invalidArgName,invalidArrayArg,invalidCharset,invalidFormData,invalidPostType,missingPostType,teamAddedToOrg,invalidJson,jsonNotObject,requestTimeout,upgradeRequire,fatalError,missingCharset,superfluousCharset
     */
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "upgrade_require") upgradeRequire("upgrade_require"),
