...
data class ConversationsKickErrorSchema (

    @Json(name = "error")
    val error: ConversationsKickErrorSchema.Error,
    ...
    enum class Error(val value: kotlin.String) {
        ...
        @Json(name = "cant_kick_self") cantKickSelf("cant_kick_self"),
        @Json(name = "not_in_channel") notInChannel("not_in_channel"),
        @Json(name = "cant_kick_from_general") cantKickFromGeneral("cant_kick_from_general"),
