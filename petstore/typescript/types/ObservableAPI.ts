...
export class ObservablePetApi {
     ...
     */
    public addPet(pet: Pet, _options?: Configuration): Observable<void> {
     ...
     * @param pet Pet object that needs to be added to the store
     */
    public updatePet(pet: Pet, _options?: Configuration): Observable<void> {
     ...
     * @param body 
     */
    public uploadFile(petId: number, body?: HttpFile, _options?: Configuration): Observable<ApiResponse> {
        const requestContextPromise = this.requestFactory.uploadFile(petId, body, _options);
...
export class ObservableStoreApi {
     ...
     */
    public deleteOrder(orderId: number, _options?: Configuration): Observable<void> {
