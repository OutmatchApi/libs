...
export class PromisePetApi {
     ...
     * @param body 
     */
    public uploadFile(petId: number, body?: HttpFile, _options?: Configuration): Promise<ApiResponse> {
        const result = this.api.uploadFile(petId, body, _options);
        return result.toPromise();
    }
...
export class PromiseStoreApi {
     ...
     */
    public deleteOrder(orderId: number, _options?: Configuration): Promise<void> {
