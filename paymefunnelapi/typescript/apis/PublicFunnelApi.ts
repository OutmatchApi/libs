 ...
 * no description
 */
export class PublicFunnelApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async getFunnel(funnelId: string, sessionId?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (funnelId === null || funnelId === undefined) {
            throw new RequiredError("PublicFunnelApi", "getFunnel", "funnelId");
        }
...
export class PublicFunnelApiResponseProcessor {
