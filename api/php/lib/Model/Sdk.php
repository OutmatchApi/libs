...
class Sdk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sdk';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('code_url', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['code_url'] === null) {
            $invalidProperties[] = "'code_url' can't be null";
        }
    ...
    {
        return $this->container['code_url'];
    }

    /**
     * Sets code_url
     *
     * @param string $code_url code_url
     *
     * @return self
     */
    public function setCodeUrl($code_url)
    {
        ...
        if (is_null($code_url)) {
            throw new \InvalidArgumentException('non-nullable code_url cannot be null');
        }

        $this->container['code_url'] = $code_url;
