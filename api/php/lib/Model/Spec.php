...
class Spec implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('spec_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['spec_type'] === null) {
            $invalidProperties[] = "'spec_type' can't be null";
        }
    ...
    public function setSpecType($spec_type)
    {
        ...
        if (is_null($spec_type)) {
            throw new \InvalidArgumentException('non-nullable spec_type cannot be null');
        }
     ...
     * Gets logo
     *
     * @return \OpenAPI\Client\Model\Logo
     */
     ...
     * Sets logo
     *
     * @param \OpenAPI\Client\Model\Logo $logo logo
     *
     * @return self
     */
