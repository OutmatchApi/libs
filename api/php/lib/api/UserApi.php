...
/**
     ...
     * @return void
     */
    public function updateUser($update_user_request = null, string $contentType = self::contentTypes['updateUser'][0])
    {
        $this->updateUserWithHttpInfo($update_user_request, $contentType);
    }
     ...
     */
    public function updateUserWithHttpInfo($update_user_request = null, string $contentType = self::contentTypes['updateUser'][0])
    {
        $request = $this->updateUserRequest($update_user_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateUserAsync($update_user_request = null, string $contentType = self::contentTypes['updateUser'][0])
    {
        return $this->updateUserAsyncWithHttpInfo($update_user_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateUserAsyncWithHttpInfo($update_user_request = null, string $contentType = self::contentTypes['updateUser'][0])
    {
        $returnType = '';
        $request = $this->updateUserRequest($update_user_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateUserRequest($update_user_request = null, string $contentType = self::contentTypes['updateUser'][0])
    {
