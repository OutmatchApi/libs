...
export class HealthApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async healthApiV1HealthGet(idempotencyKey?: string, _options?: Configuration): Promise<RequestContext> {
...
export class HealthApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to healthApiV1HealthGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async healthApiV1HealthGet(response: ResponseContext): Promise<void > {
