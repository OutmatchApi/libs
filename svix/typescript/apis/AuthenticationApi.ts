...
export class AuthenticationApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async expireAllApiV1AuthAppAppIdExpireAllPost(appId: string, applicationTokenExpireIn: ApplicationTokenExpireIn, idempotencyKey?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'appId' is not null or undefined
        if (appId === null || appId === undefined) {
            throw new RequiredError("AuthenticationApi", "expireAllApiV1AuthAppAppIdExpireAllPost", "appId");
        }
        ...
        if (applicationTokenExpireIn === null || applicationTokenExpireIn === undefined) {
            throw new RequiredError("AuthenticationApi", "expireAllApiV1AuthAppAppIdExpireAllPost", "applicationTokenExpireIn");
        }
...
export class AuthenticationApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to expireAllApiV1AuthAppAppIdExpireAllPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async expireAllApiV1AuthAppAppIdExpireAllPost(response: ResponseContext): Promise<void > {
