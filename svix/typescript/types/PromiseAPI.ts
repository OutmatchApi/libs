...
export class PromiseAuthenticationApi {
     ...
     * @param idempotencyKey The request&#39;s idempotency key
     */
    public expireAllApiV1AuthAppAppIdExpireAllPost(appId: string, applicationTokenExpireIn: ApplicationTokenExpireIn, idempotencyKey?: string, _options?: Configuration): Promise<void> {
        const result = this.api.expireAllApiV1AuthAppAppIdExpireAllPost(appId, applicationTokenExpireIn, idempotencyKey, _options);
        return result.toPromise();
    }
