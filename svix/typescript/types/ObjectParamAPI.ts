...
export interface AuthenticationApiExpireAllApiV1AuthAppAppIdExpireAllPostRequest {
    /**
     * 
     * @type string
     * @memberof AuthenticationApiexpireAllApiV1AuthAppAppIdExpireAllPost
     */
    appId: string
    /**
     * 
...
export class ObjectAuthenticationApi {
     ...
     * @param param the request object
     */
    public expireAllApiV1AuthAppAppIdExpireAllPost(param: AuthenticationApiExpireAllApiV1AuthAppAppIdExpireAllPostRequest, options?: Configuration): Promise<void> {
        return this.api.expireAllApiV1AuthAppAppIdExpireAllPost(param.appId, param.applicationTokenExpireIn, param.idempotencyKey,  options).toPromise();
    }
