## @gener-api-test/svix@1.4.0

### Install

```
npm install @gener-api-test/svix@1.4.0 --save

// Or with yarn

yarn add @gener-api-test/svix@1.4.0
...
*AuthenticationApi* | [**expireAllApiV1AuthAppAppIdExpireAllPost**](AuthenticationApi.md#expireallapiv1authappappidexpireallpost) | **POST** /api/v1/auth/app/{app_id}/expire-all/ | Expire All
