...
import com.outmatchapi.svix.MessageAttemptEndpointOut;
...
public class ListResponseMessageAttemptEndpointOut {
  ...
  public ListResponseMessageAttemptEndpointOut() {
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(data, iterator, prevIterator, done);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListResponseMessageAttemptEndpointOut
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListResponseMessageAttemptEndpointOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListResponseMessageAttemptEndpointOut is not found in the empty JSON string", ListResponseMessageAttemptEndpointOut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListResponseMessageAttemptEndpointOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListResponseMessageAttemptEndpointOut` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListResponseMessageAttemptEndpointOut.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        MessageAttemptEndpointOut.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListResponseMessageAttemptEndpointOut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListResponseMessageAttemptEndpointOut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListResponseMessageAttemptEndpointOut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListResponseMessageAttemptEndpointOut.class));

       return (TypeAdapter<T>) new TypeAdapter<ListResponseMessageAttemptEndpointOut>() {
           @Override
           public void write(JsonWriter out, ListResponseMessageAttemptEndpointOut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListResponseMessageAttemptEndpointOut read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ListResponseMessageAttemptEndpointOut given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListResponseMessageAttemptEndpointOut
  * @throws IOException if the JSON string is invalid with respect to ListResponseMessageAttemptEndpointOut
  */
  public static ListResponseMessageAttemptEndpointOut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListResponseMessageAttemptEndpointOut.class);
  }

 /**
  * Convert an instance of ListResponseMessageAttemptEndpointOut to an JSON string
  *
  * @return JSON string
  */
