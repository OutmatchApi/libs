...
public class EventTypeUpdate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, archived);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EventTypeUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventTypeUpdate` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
