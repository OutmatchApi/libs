...
import com.outmatchapi.svix.MessageAttemptFailedData;
...
public class MessageAttemptExhaustedEventData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appId, appUid, msgId, msgEventId, endpointId, lastAttempt);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MessageAttemptExhaustedEventData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MessageAttemptExhaustedEventData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MessageAttemptExhaustedEventData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageAttemptExhaustedEventData` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
