...
public class EndpointMessageOut {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventType, endpointMessageOut.eventType) &&
        Objects.equals(this.eventId, endpointMessageOut.eventId) &&
        Objects.equals(this.channels, endpointMessageOut.channels) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventType, eventId, channels, payload, id, timestamp, status, nextAttempt);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EndpointMessageOut
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EndpointMessageOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EndpointMessageOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointMessageOut` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
