...
public class MessageAttemptOut {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, messageAttemptOut.id) &&
        Objects.equals(this.msgId, messageAttemptOut.msgId) &&
        ...
        Objects.equals(this.triggerType, messageAttemptOut.triggerType);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MessageAttemptOut
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MessageAttemptOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageAttemptOut is not found in the empty JSON string", MessageAttemptOut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MessageAttemptOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageAttemptOut` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MessageAttemptOut.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageAttemptOut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageAttemptOut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageAttemptOut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageAttemptOut.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageAttemptOut>() {
           @Override
           public void write(JsonWriter out, MessageAttemptOut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageAttemptOut read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to MessageAttemptOut
  */
  public static MessageAttemptOut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageAttemptOut.class);
  }
