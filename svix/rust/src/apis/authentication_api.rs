...
/// struct for passing parameters to the method [`expire_all_api_v1_auth_app_app_id_expire_all_post`]
#[derive(Clone, Debug, Default)]
pub struct ExpireAllApiV1AuthAppAppIdExpireAllPostParams {
    pub app_id: String,
    pub application_token_expire_in: crate::models::ApplicationTokenExpireIn,
...
/// struct for typed errors of method [`expire_all_api_v1_auth_app_app_id_expire_all_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExpireAllApiV1AuthAppAppIdExpireAllPostError {
...
pub async fn expire_all_api_v1_auth_app_app_id_expire_all_post(configuration: &configuration::Configuration, params: ExpireAllApiV1AuthAppAppIdExpireAllPostParams) -> Result<(), Error<ExpireAllApiV1AuthAppAppIdExpireAllPostError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/auth/app/{app_id}/expire-all/", local_var_configuration.base_path, app_id=crate::apis::urlencode(app_id));
    ...
    local_var_req_builder = local_var_req_builder.json(&application_token_expire_in);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExpireAllApiV1AuthAppAppIdExpireAllPostError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_dashboard_access_api_v1_auth_dashboard_access_app_id_post(configuration: &configuration::Configuration, params: GetDashboardAccessApiV1AuthDashboardAccessAppIdPostParams) -> Result<crate::models::DashboardAccessOut, Error<GetDashboardAccessApiV1AuthDashboardAccessAppIdPostError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/auth/dashboard-access/{app_id}/", local_var_configuration.base_path, app_id=crate::apis::urlencode(app_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn logout_api_v1_auth_logout_post(configuration: &configuration::Configuration, params: LogoutApiV1AuthLogoutPostParams) -> Result<(), Error<LogoutApiV1AuthLogoutPostError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/auth/logout/", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
