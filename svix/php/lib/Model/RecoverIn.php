 ...
 */
class RecoverIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecoverIn';
    ...
    */
    ...
    public function setUntil($until)
    {
        ...
        if (is_null($until)) {
            array_push($this->openAPINullablesSetToNull, 'until');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('until', $nullablesSetToNull);
            if ($index !== FALSE) {
