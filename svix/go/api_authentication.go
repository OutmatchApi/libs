...
func (r ApiExpireAllApiV1AuthAppAppIdExpireAllPostRequest) Execute() (*http.Response, error) {
...
*/
func (a *AuthenticationApiService) ExpireAllApiV1AuthAppAppIdExpireAllPost(ctx context.Context, appId string) ApiExpireAllApiV1AuthAppAppIdExpireAllPostRequest {
	return ApiExpireAllApiV1AuthAppAppIdExpireAllPostRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
func (a *AuthenticationApiService) ExpireAllApiV1AuthAppAppIdExpireAllPostExecute(r ApiExpireAllApiV1AuthAppAppIdExpireAllPostRequest) (*http.Response, error) {
	var (
...
func (r ApiGetDashboardAccessApiV1AuthDashboardAccessAppIdPostRequest) Execute() (*DashboardAccessOut, *http.Response, error) {
...
*/
func (a *AuthenticationApiService) GetDashboardAccessApiV1AuthDashboardAccessAppIdPost(ctx context.Context, appId string) ApiGetDashboardAccessApiV1AuthDashboardAccessAppIdPostRequest {
	return ApiGetDashboardAccessApiV1AuthDashboardAccessAppIdPostRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
func (a *AuthenticationApiService) GetDashboardAccessApiV1AuthDashboardAccessAppIdPostExecute(r ApiGetDashboardAccessApiV1AuthDashboardAccessAppIdPostRequest) (*DashboardAccessOut, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
