...
class EndpointIn(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class secret(
                ...
                class MetaOapg:
                    regex=[{
                        'pattern': r'^(whsec_)?[a-zA-Z0-9+/=]{32,100}$',  # noqa: E501
                    }]
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "version", "uid", "description", "filterTypes", "channels", "disabled", "rateLimit", "metadata", "secret", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "version", "uid", "description", "filterTypes", "channels", "disabled", "rateLimit", "metadata", "secret", ], str]):
        return super().get_item_oapg(name)
