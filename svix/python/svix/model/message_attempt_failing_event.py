...
It's sent on the fourth failure. It complements `message.attempt.exhausted` which is sent after the last failure.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['MessageAttemptFailingEventData']:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "message.attempt.failing": "MESSAGE_ATTEMPT_FAILING",
                    }
                
                @schemas.classproperty
                def MESSAGE_ATTEMPT_FAILING(cls):
                    return cls("message.attempt.failing")
            __annotations__ = {
                "data": data,
                "type": type,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'MessageAttemptFailingEventData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'MessageAttemptFailingEventData': ...
