...
class EndpointDeletedEvent(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['EndpointDeletedEventData']:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "endpoint.deleted": "ENDPOINT_DELETED",
                    }
                
                @schemas.classproperty
                def ENDPOINT_DELETED(cls):
                    return cls("endpoint.deleted")
            __annotations__ = {
                "data": data,
                "type": type,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'EndpointDeletedEventData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'EndpointDeletedEventData': ...
