...
class MessageAttemptExhaustedEvent(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['MessageAttemptExhaustedEventData']:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "message.attempt.exhausted": "MESSAGE_ATTEMPT_EXHAUSTED",
                    }
                
                @schemas.classproperty
                def MESSAGE_ATTEMPT_EXHAUSTED(cls):
                    return cls("message.attempt.exhausted")
            __annotations__ = {
                "data": data,
                "type": type,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'MessageAttemptExhaustedEventData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'MessageAttemptExhaustedEventData': ...
