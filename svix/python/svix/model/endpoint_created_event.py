...
class EndpointCreatedEvent(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['EndpointCreatedEventData']:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "endpoint.created": "ENDPOINT_CREATED",
                    }
                
                @schemas.classproperty
                def ENDPOINT_CREATED(cls):
                    return cls("endpoint.created")
            __annotations__ = {
                "data": data,
                "type": type,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'EndpointCreatedEventData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'EndpointCreatedEventData': ...
