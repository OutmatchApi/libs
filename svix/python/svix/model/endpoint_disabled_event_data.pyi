...
class EndpointDisabledEventData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            failSince = schemas.DateTimeSchema
    ...
    failSince: MetaOapg.properties.failSince
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["failSince"]) -> MetaOapg.properties.failSince: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["appUid"]) -> MetaOapg.properties.appUid: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["endpointUid"]) -> MetaOapg.properties.endpointUid: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["appId", "endpointId", "failSince", "appUid", "endpointUid", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["failSince"]) -> MetaOapg.properties.failSince: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["appUid"]) -> typing.Union[MetaOapg.properties.appUid, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["endpointUid"]) -> typing.Union[MetaOapg.properties.endpointUid, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["appId", "endpointId", "failSince", "appUid", "endpointUid", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        failSince: typing.Union[MetaOapg.properties.failSince, str, datetime, ],
        appUid: typing.Union[MetaOapg.properties.appUid, None, str, schemas.Unset] = schemas.unset,
        endpointUid: typing.Union[MetaOapg.properties.endpointUid, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
