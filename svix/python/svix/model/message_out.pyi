...
class MessageOut(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["eventType", "payload", "id", "timestamp", "eventId", "channels", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["eventType", "payload", "id", "timestamp", "eventId", "channels", ], str]):
