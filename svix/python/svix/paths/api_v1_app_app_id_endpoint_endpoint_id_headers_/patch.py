...
# body param
SchemaForRequestBodyApplicationJson = EndpointHeadersPatchIn


request_body_endpoint_headers_patch_in = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_endpoint_headers_api_v1_app_app_id_endpoint_endpoint_id_headers_patch_oapg(
        self,
    ...
    def _patch_endpoint_headers_api_v1_app_app_id_endpoint_endpoint_id_headers_patch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_endpoint_headers_patch_in.serialize(body, content_type)
...
class PatchEndpointHeadersApiV1AppAppIdEndpointEndpointIdHeadersPatch(BaseApi):
    ...
    def patch_endpoint_headers_api_v1_app_app_id_endpoint_endpoint_id_headers_patch(
        ...
        return self._patch_endpoint_headers_api_v1_app_app_id_endpoint_endpoint_id_headers_patch_oapg(
            body=body,
