...
# body param
SchemaForRequestBodyApplicationJson = EndpointHeadersIn


request_body_endpoint_headers_in = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_endpoint_headers_api_v1_app_app_id_endpoint_endpoint_id_headers_put_oapg(
        self,
    ...
    def _update_endpoint_headers_api_v1_app_app_id_endpoint_endpoint_id_headers_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_endpoint_headers_in.serialize(body, content_type)
...
class UpdateEndpointHeadersApiV1AppAppIdEndpointEndpointIdHeadersPut(BaseApi):
    ...
    def update_endpoint_headers_api_v1_app_app_id_endpoint_endpoint_id_headers_put(
        ...
        return self._update_endpoint_headers_api_v1_app_app_id_endpoint_endpoint_id_headers_put_oapg(
            body=body,
