...
# body param
SchemaForRequestBodyApplicationJson = EventTypeIn


request_body_event_type_in = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_event_type_api_v1_event_type_post_oapg(
        self,
    ...
    def _create_event_type_api_v1_event_type_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_event_type_in.serialize(body, content_type)
...
class CreateEventTypeApiV1EventTypePost(BaseApi):
    ...
    def create_event_type_api_v1_event_type_post(
        ...
        return self._create_event_type_api_v1_event_type_post_oapg(
            body=body,
