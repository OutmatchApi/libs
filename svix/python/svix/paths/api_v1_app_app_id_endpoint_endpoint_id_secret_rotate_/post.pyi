...
# body param
SchemaForRequestBodyApplicationJson = EndpointSecretRotateIn


request_body_endpoint_secret_rotate_in = api_client.RequestBody(
    content={
...
SchemaFor400ResponseBodyApplicationJson = HttpErrorOut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _rotate_endpoint_secret_api_v1_app_app_id_endpoint_endpoint_id_secret_rotate_post_oapg(
        self,
    ...
    def _rotate_endpoint_secret_api_v1_app_app_id_endpoint_endpoint_id_secret_rotate_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_endpoint_secret_rotate_in.serialize(body, content_type)
...
class RotateEndpointSecretApiV1AppAppIdEndpointEndpointIdSecretRotatePost(BaseApi):
    ...
    def rotate_endpoint_secret_api_v1_app_app_id_endpoint_endpoint_id_secret_rotate_post(
        ...
        return self._rotate_endpoint_secret_api_v1_app_app_id_endpoint_endpoint_id_secret_rotate_post_oapg(
            body=body,
