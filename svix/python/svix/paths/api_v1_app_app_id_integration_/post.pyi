...
# body param
SchemaForRequestBodyApplicationJson = IntegrationIn


request_body_integration_in = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = IntegrationOut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_integration_api_v1_app_app_id_integration_post_oapg(
        self,
    ...
    def _create_integration_api_v1_app_app_id_integration_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_integration_in.serialize(body, content_type)
...
class CreateIntegrationApiV1AppAppIdIntegrationPost(BaseApi):
    ...
    def create_integration_api_v1_app_app_id_integration_post(
        ...
        return self._create_integration_api_v1_app_app_id_integration_post_oapg(
            body=body,
