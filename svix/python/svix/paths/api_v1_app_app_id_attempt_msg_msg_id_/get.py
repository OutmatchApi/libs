...
StatusSchema = MessageStatus
StatusCodeClassSchema = StatusCodeClass
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'endpoint_id': typing.Union[EndpointIdSchema, None, str, ],
        'iterator': typing.Union[IteratorSchema, None, str, ],
        'limit': typing.Union[LimitSchema, decimal.Decimal, int, ],
        'status': typing.Union[StatusSchema, ],
        'status_code_class': typing.Union[StatusCodeClassSchema, ],
...
request_query_status_code_class = api_client.QueryParameter(
    name="status_code_class",
    style=api_client.ParameterStyle.FORM,
    schema=StatusCodeClassSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = ListResponseMessageAttemptOut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_attempts_by_msg_api_v1_app_app_id_attempt_msg_msg_id_get_oapg(
        self,
    ...
    def _list_attempts_by_msg_api_v1_app_app_id_attempt_msg_msg_id_get_oapg(
        ...
        for parameter in (
            ...
            request_query_status_code_class,
...
class ListAttemptsByMsgApiV1AppAppIdAttemptMsgMsgIdGet(BaseApi):
    ...
    def list_attempts_by_msg_api_v1_app_app_id_attempt_msg_msg_id_get(
        ...
        return self._list_attempts_by_msg_api_v1_app_app_id_attempt_msg_msg_id_get_oapg(
