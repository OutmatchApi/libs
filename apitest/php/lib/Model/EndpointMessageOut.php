    ...
    */
    ...
    public function setChannels($channels)
    {
        ...
        if (!is_null($channels) && (count($channels) > 5)) {
            throw new \InvalidArgumentException('invalid value for $channels when calling EndpointMessageOut., number of items must be less than or equal to 5.');
        }
        if (!is_null($channels) && (count($channels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $channels when calling EndpointMessageOut., number of items must be greater than or equal to 1.');
        }
