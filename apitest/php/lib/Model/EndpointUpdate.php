    ...
    */
    ...
    public function setFilterTypes($filter_types)
    {
        ...
        if (!is_null($filter_types) && (count($filter_types) < 1)) {
            throw new \InvalidArgumentException('invalid length for $filter_types when calling EndpointUpdate., number of items must be greater than or equal to 1.');
        }
    ...
    public function setChannels($channels)
    {
        ...
        if (!is_null($channels) && (count($channels) > 10)) {
            throw new \InvalidArgumentException('invalid value for $channels when calling EndpointUpdate., number of items must be less than or equal to 10.');
        }
        if (!is_null($channels) && (count($channels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $channels when calling EndpointUpdate., number of items must be greater than or equal to 1.');
        }
    ...
    public function setRateLimit($rate_limit)
    {
        ...
        if (!is_null($rate_limit) && ($rate_limit > 65535)) {
            throw new \InvalidArgumentException('invalid value for $rate_limit when calling EndpointUpdate., must be smaller than or equal to 65535.');
        }
