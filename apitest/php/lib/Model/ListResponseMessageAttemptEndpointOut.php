...
class ListResponseMessageAttemptEndpointOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\MessageAttemptEndpointOut[]',
        'iterator' => 'string',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\MessageAttemptEndpointOut[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\MessageAttemptEndpointOut[] $data data
     *
     * @return self
     */
    ...
    public function setPrevIterator($prev_iterator)
    {
        ...
        if (is_null($prev_iterator)) {
            array_push($this->openAPINullablesSetToNull, 'prev_iterator');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('prev_iterator', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
