...
class MessageAttemptFailingEventData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'msg_event_id' => 'string',
        'endpoint_id' => 'string',
        'last_attempt' => '\OpenAPI\Client\Model\MessageAttemptFailedData'
    ];
    ...
    */
     ...
     * Sets app_uid
     *
     * @param string|null $app_uid Optional unique identifier for the application
     *
     * @return self
     */
    public function setAppUid($app_uid)
    {
        if (!is_null($app_uid) && (mb_strlen($app_uid) > 256)) {
            throw new \InvalidArgumentException('invalid length for $app_uid when calling MessageAttemptFailingEventData., must be smaller than or equal to 256.');
        }
        if (!is_null($app_uid) && (mb_strlen($app_uid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $app_uid when calling MessageAttemptFailingEventData., must be bigger than or equal to 1.');
        }
        if (!is_null($app_uid) && (!preg_match("/^[a-zA-Z0-9\\-_.]+$/", $app_uid))) {
            throw new \InvalidArgumentException("invalid value for \$app_uid when calling MessageAttemptFailingEventData., must conform to the pattern /^[a-zA-Z0-9\\-_.]+$/.");
        }


        if (is_null($app_uid)) {
            array_push($this->openAPINullablesSetToNull, 'app_uid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('app_uid', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets msg_event_id
     *
     * @param string|null $msg_event_id Optional unique identifier for the message
     *
     * @return self
     */
    public function setMsgEventId($msg_event_id)
    {
        if (!is_null($msg_event_id) && (mb_strlen($msg_event_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $msg_event_id when calling MessageAttemptFailingEventData., must be smaller than or equal to 256.');
        }
        if (!is_null($msg_event_id) && (mb_strlen($msg_event_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $msg_event_id when calling MessageAttemptFailingEventData., must be bigger than or equal to 1.');
        }
        if (!is_null($msg_event_id) && (!preg_match("/^[a-zA-Z0-9\\-_.]+$/", $msg_event_id))) {
            throw new \InvalidArgumentException("invalid value for \$msg_event_id when calling MessageAttemptFailingEventData., must conform to the pattern /^[a-zA-Z0-9\\-_.]+$/.");
        }


        if (is_null($msg_event_id)) {
            array_push($this->openAPINullablesSetToNull, 'msg_event_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('msg_event_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets last_attempt
     *
     * @return \OpenAPI\Client\Model\MessageAttemptFailedData
     */
     ...
     * Sets last_attempt
     *
     * @param \OpenAPI\Client\Model\MessageAttemptFailedData $last_attempt last_attempt
     *
     * @return self
     */
