...
class MessageEndpointOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['filter_types']) && (count($this->container['filter_types']) < 1)) {
            $invalidProperties[] = "invalid value for 'filter_types', number of items must be greater than or equal to 1.";
        }

        if (!is_null($this->container['channels']) && (count($this->container['channels']) > 10)) {
            $invalidProperties[] = "invalid value for 'channels', number of items must be less than or equal to 10.";
        }
        ...
        if (!is_null($this->container['rate_limit']) && ($this->container['rate_limit'] > 65535)) {
            $invalidProperties[] = "invalid value for 'rate_limit', must be smaller than or equal to 65535.";
        }
    ...
    public function setFilterTypes($filter_types)
    {
        ...
        if (!is_null($filter_types) && (count($filter_types) < 1)) {
            throw new \InvalidArgumentException('invalid length for $filter_types when calling MessageEndpointOut., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets channels
     *
     * @param string[]|null $channels List of message channels this endpoint listens to (omit for all)
     *
     * @return self
     */
    public function setChannels($channels)
    {
        ...
        if (!is_null($channels) && (count($channels) > 10)) {
            throw new \InvalidArgumentException('invalid value for $channels when calling MessageEndpointOut., number of items must be less than or equal to 10.');
        }
        if (!is_null($channels) && (count($channels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $channels when calling MessageEndpointOut., number of items must be greater than or equal to 1.');
        }
    ...
    public function setRateLimit($rate_limit)
    {
        ...
        if (!is_null($rate_limit) && ($rate_limit > 65535)) {
            throw new \InvalidArgumentException('invalid value for $rate_limit when calling MessageEndpointOut., must be smaller than or equal to 65535.');
        }
        if (!is_null($rate_limit) && ($rate_limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $rate_limit when calling MessageEndpointOut., must be bigger than or equal to 1.');
        }


        if (is_null($rate_limit)) {
            array_push($this->openAPINullablesSetToNull, 'rate_limit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rate_limit', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
