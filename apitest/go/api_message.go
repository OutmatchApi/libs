...
func (r ApiCreateMessageApiV1AppAppIdMsgPostRequest) Execute() (*MessageOut, *http.Response, error) {
...
*/
func (a *MessageApiService) CreateMessageApiV1AppAppIdMsgPost(ctx context.Context, appId string) ApiCreateMessageApiV1AppAppIdMsgPostRequest {
	return ApiCreateMessageApiV1AppAppIdMsgPostRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
//  @return MessageOut
func (a *MessageApiService) CreateMessageApiV1AppAppIdMsgPostExecute(r ApiCreateMessageApiV1AppAppIdMsgPostRequest) (*MessageOut, *http.Response, error) {
	var (
...
func (r ApiGetMessageApiV1AppAppIdMsgMsgIdGetRequest) Execute() (*MessageOut, *http.Response, error) {
...
*/
func (a *MessageApiService) GetMessageApiV1AppAppIdMsgMsgIdGet(ctx context.Context, msgId string, appId string) ApiGetMessageApiV1AppAppIdMsgMsgIdGetRequest {
	return ApiGetMessageApiV1AppAppIdMsgMsgIdGetRequest{
		ApiService: a,
		ctx: ctx,
		msgId: msgId,
...
// Execute executes the request
//  @return MessageOut
func (a *MessageApiService) GetMessageApiV1AppAppIdMsgMsgIdGetExecute(r ApiGetMessageApiV1AppAppIdMsgMsgIdGetRequest) (*MessageOut, *http.Response, error) {
	var (
...
func (r ApiListMessagesApiV1AppAppIdMsgGetRequest) Execute() (*ListResponseMessageOut, *http.Response, error) {
...
*/
func (a *MessageApiService) ListMessagesApiV1AppAppIdMsgGet(ctx context.Context, appId string) ApiListMessagesApiV1AppAppIdMsgGetRequest {
	return ApiListMessagesApiV1AppAppIdMsgGetRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
...
func (a *MessageApiService) ListMessagesApiV1AppAppIdMsgGetExecute(r ApiListMessagesApiV1AppAppIdMsgGetRequest) (*ListResponseMessageOut, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
