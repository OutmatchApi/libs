...
func (r ApiHealthApiV1HealthGetRequest) Execute() (*http.Response, error) {
...
func (a *HealthApiService) HealthApiV1HealthGetExecute(r ApiHealthApiV1HealthGetRequest) (*http.Response, error) {
	var (
