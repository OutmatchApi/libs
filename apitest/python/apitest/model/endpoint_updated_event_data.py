...
class EndpointUpdatedEventData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["appId", "endpointId", "appUid", "endpointUid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["appId", "endpointId", "appUid", "endpointUid", ], str]):
