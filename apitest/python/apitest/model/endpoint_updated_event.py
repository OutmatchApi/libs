...
class EndpointUpdatedEvent(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['EndpointUpdatedEventData']:
            ...
            class type(
                ...
                def ENDPOINT_UPDATED(cls):
                    return cls("endpoint.updated")
            __annotations__ = {
                "data": data,
                "type": type,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'EndpointUpdatedEventData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'EndpointUpdatedEventData': ...
