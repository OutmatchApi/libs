...
class EndpointDisabledEvent(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['EndpointDisabledEventData']:
            ...
            class type(
                ...
                def ENDPOINT_DISABLED(cls):
                    return cls("endpoint.disabled")
            __annotations__ = {
                "data": data,
                "type": type,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'EndpointDisabledEventData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'EndpointDisabledEventData': ...
