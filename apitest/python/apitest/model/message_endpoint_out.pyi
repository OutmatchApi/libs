...
class MessageEndpointOut(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "version", "id", "createdAt", "status", "uid", "description", "filterTypes", "channels", "disabled", "rateLimit", "metadata", "nextAttempt", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "version", "id", "createdAt", "status", "uid", "description", "filterTypes", "channels", "disabled", "rateLimit", "metadata", "nextAttempt", ], str]):
        return super().get_item_oapg(name)
