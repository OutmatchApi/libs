...
class EndpointStats(
    ...
    fail: MetaOapg.properties.fail
    success: MetaOapg.properties.success
    pending: MetaOapg.properties.pending
    sending: MetaOapg.properties.sending
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sending"]) -> MetaOapg.properties.sending: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fail"]) -> MetaOapg.properties.fail: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sending", "success", "pending", "fail", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sending"]) -> MetaOapg.properties.sending: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fail"]) -> MetaOapg.properties.fail: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sending", "success", "pending", "fail", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        fail: typing.Union[MetaOapg.properties.fail, decimal.Decimal, int, ],
        success: typing.Union[MetaOapg.properties.success, decimal.Decimal, int, ],
        pending: typing.Union[MetaOapg.properties.pending, decimal.Decimal, int, ],
        sending: typing.Union[MetaOapg.properties.sending, decimal.Decimal, int, ],
