...
class ListResponseMessageEndpointOut(
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MessageEndpointOut']:
                        return MessageEndpointOut
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MessageEndpointOut'], typing.List['MessageEndpointOut']],
                ...
                def __getitem__(self, i: int) -> 'MessageEndpointOut':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "done", "iterator", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "done", "iterator", ], str]):
