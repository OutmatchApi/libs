...
class EndpointUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "version", "uid", "description", "filterTypes", "channels", "disabled", "rateLimit", "metadata", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "version", "uid", "description", "filterTypes", "channels", "disabled", "rateLimit", "metadata", ], str]):
        return super().get_item_oapg(name)
