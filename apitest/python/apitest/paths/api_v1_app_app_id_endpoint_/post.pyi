...
# body param
SchemaForRequestBodyApplicationJson = EndpointIn


request_body_endpoint_in = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_endpoint_api_v1_app_app_id_endpoint_post_oapg(
        self,
    ...
    def _create_endpoint_api_v1_app_app_id_endpoint_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_endpoint_in.serialize(body, content_type)
...
class CreateEndpointApiV1AppAppIdEndpointPost(BaseApi):
    ...
    def create_endpoint_api_v1_app_app_id_endpoint_post(
        ...
        return self._create_endpoint_api_v1_app_app_id_endpoint_post_oapg(
            body=body,
