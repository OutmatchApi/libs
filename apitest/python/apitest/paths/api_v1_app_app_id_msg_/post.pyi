...
# body param
SchemaForRequestBodyApplicationJson = MessageIn


request_body_message_in = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = MessageOut
...
SchemaFor413ResponseBodyApplicationJson = HttpErrorOut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_message_api_v1_app_app_id_msg_post_oapg(
        self,
    ...
    def _create_message_api_v1_app_app_id_msg_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_message_in.serialize(body, content_type)
...
class CreateMessageApiV1AppAppIdMsgPost(BaseApi):
    ...
    def create_message_api_v1_app_app_id_msg_post(
        ...
        return self._create_message_api_v1_app_app_id_msg_post_oapg(
            body=body,
