...
# body param
SchemaForRequestBodyApplicationJson = RecoverIn


request_body_recover_in = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _recover_failed_webhooks_api_v1_app_app_id_endpoint_endpoint_id_recover_post_oapg(
        self,
    ...
    def _recover_failed_webhooks_api_v1_app_app_id_endpoint_endpoint_id_recover_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_recover_in.serialize(body, content_type)
...
class RecoverFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPost(BaseApi):
    ...
    def recover_failed_webhooks_api_v1_app_app_id_endpoint_endpoint_id_recover_post(
        ...
        return self._recover_failed_webhooks_api_v1_app_app_id_endpoint_endpoint_id_recover_post_oapg(
            body=body,
