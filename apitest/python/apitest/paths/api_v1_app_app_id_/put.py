...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_application_api_v1_app_app_id_put_oapg(
        self,
...
class UpdateApplicationApiV1AppAppIdPut(BaseApi):
    ...
    def update_application_api_v1_app_app_id_put(
        ...
        return self._update_application_api_v1_app_app_id_put_oapg(
            body=body,
