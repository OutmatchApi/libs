...
# Path params
AttemptIdSchema = schemas.StrSchema
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'attempt_id': typing.Union[AttemptIdSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = MessageAttemptOut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_attempt_api_v1_app_app_id_msg_msg_id_attempt_attempt_id_get_oapg(
        self,
...
class GetAttemptApiV1AppAppIdMsgMsgIdAttemptAttemptIdGet(BaseApi):
    ...
    def get_attempt_api_v1_app_app_id_msg_msg_id_attempt_attempt_id_get(
        ...
        return self._get_attempt_api_v1_app_app_id_msg_msg_id_attempt_attempt_id_get_oapg(
