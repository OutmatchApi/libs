...
# body param
SchemaForRequestBodyApplicationJson = EndpointUpdate


request_body_endpoint_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EndpointOut
...
SchemaFor201ResponseBodyApplicationJson = EndpointOut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_endpoint_api_v1_app_app_id_endpoint_endpoint_id_put_oapg(
        self,
    ...
    def _update_endpoint_api_v1_app_app_id_endpoint_endpoint_id_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_endpoint_update.serialize(body, content_type)
...
class UpdateEndpointApiV1AppAppIdEndpointEndpointIdPut(BaseApi):
    ...
    def update_endpoint_api_v1_app_app_id_endpoint_endpoint_id_put(
        ...
        return self._update_endpoint_api_v1_app_app_id_endpoint_endpoint_id_put_oapg(
            body=body,
