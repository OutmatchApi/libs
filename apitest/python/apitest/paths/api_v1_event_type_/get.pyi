...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'include_archived': typing.Union[IncludeArchivedSchema, bool, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = ListResponseEventTypeOut
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_event_types_api_v1_event_type_get_oapg(
        self,
...
class ListEventTypesApiV1EventTypeGet(BaseApi):
    ...
    def list_event_types_api_v1_event_type_get(
        ...
        return self._list_event_types_api_v1_event_type_get_oapg(
