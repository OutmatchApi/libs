...
from apivideo import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJson = CaptionsUpdatePayload


request_body_captions_update_payload = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Subtitle
...
class BaseApi(api_client.Api):
    @typing.overload
    def _p_atch_videos_video_id_captions_language_oapg(
        self,
    ...
    def _p_atch_videos_video_id_captions_language_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_captions_update_payload.serialize(body, content_type)
...
class PAtchVideosVideoIdCaptionsLanguage(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def p_atch_videos_video_id_captions_language(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def p_atch_videos_video_id_captions_language(
        ...
        return self._p_atch_videos_video_id_captions_language_oapg(
            body=body,
