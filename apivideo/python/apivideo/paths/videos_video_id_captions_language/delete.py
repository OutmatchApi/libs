...
class BaseApi(api_client.Api):
    @typing.overload
    def _d_elete_videos_video_id_captions_language_oapg(
        self,
...
class DEleteVideosVideoIdCaptionsLanguage(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def d_elete_videos_video_id_captions_language(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def d_elete_videos_video_id_captions_language(
        ...
        return self._d_elete_videos_video_id_captions_language_oapg(
