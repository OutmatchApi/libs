...
# body param
SchemaForRequestBodyMultipartFormData = CaptionsUploadPayload
...
class BaseApi(api_client.Api):
    @typing.overload
    def _p_ost_videos_video_id_captions_language_oapg(
        self,
...
class POstVideosVideoIdCaptionsLanguage(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def p_ost_videos_video_id_captions_language(
        self,
        content_type: typing_extensions.Literal["multipart/form-data"] = ...,
        body: typing.Union[SchemaForRequestBodyMultipartFormData, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def p_ost_videos_video_id_captions_language(
        ...
        return self._p_ost_videos_video_id_captions_language_oapg(
            body=body,
