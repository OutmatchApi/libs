...
# body param
SchemaForRequestBodyApplicationJson = VideoUpdatePayload


request_body_video_update_payload = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _p_atch_video_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_video_update_payload.serialize(body, content_type)
...
class PAtchVideo(BaseApi):
    ...
    def p_atch_video(
        ...
        return self._p_atch_video_oapg(
            body=body,
