...
# body param
SchemaForRequestBodyMultipartFormData = PlayersUploadLogoPayload
...
class BaseApi(api_client.Api):
    @typing.overload
    def _p_ost_players_player_id_logo_oapg(
        self,
...
class POstPlayersPlayerIdLogo(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def p_ost_players_player_id_logo(
        self,
        content_type: typing_extensions.Literal["multipart/form-data"] = ...,
        body: typing.Union[SchemaForRequestBodyMultipartFormData, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def p_ost_players_player_id_logo(
        ...
        return self._p_ost_players_player_id_logo_oapg(
            body=body,
