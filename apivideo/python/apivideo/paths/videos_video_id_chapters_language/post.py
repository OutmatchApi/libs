...
# body param
SchemaForRequestBodyMultipartFormData = ChaptersUpdatePayload
...
SchemaFor200ResponseBodyApplicationJson = Chapter
...
class BaseApi(api_client.Api):
    @typing.overload
    def _p_ost_videos_video_id_chapters_language_oapg(
        self,
...
class POstVideosVideoIdChaptersLanguage(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def p_ost_videos_video_id_chapters_language(
        self,
        content_type: typing_extensions.Literal["multipart/form-data"] = ...,
        body: typing.Union[SchemaForRequestBodyMultipartFormData, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def p_ost_videos_video_id_chapters_language(
        ...
        return self._p_ost_videos_video_id_chapters_language_oapg(
            body=body,
