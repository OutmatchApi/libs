...
SchemaFor200ResponseBodyApplicationJson = ChaptersListResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _g_et_videos_video_id_chapters_oapg(
        self,
...
class GEtVideosVideoIdChapters(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def g_et_videos_video_id_chapters(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def g_et_videos_video_id_chapters(
        ...
        return self._g_et_videos_video_id_chapters_oapg(
