...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'metadata': typing.Union[MetadataSchema, list, tuple, ],
...
SchemaFor200ResponseBodyApplicationJson = RawStatisticsListSessionsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _g_et_analytics_videos_video_id_oapg(
        self,
...
class GEtAnalyticsVideosVideoId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def g_et_analytics_videos_video_id(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def g_et_analytics_videos_video_id(
        ...
        return self._g_et_analytics_videos_video_id_oapg(
