...
# body param
SchemaForRequestBodyApplicationJson = VideoCreatePayload


request_body_video_create_payload = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = Video
...
class BaseApi(api_client.Api):
    ...
    def _p_ost_video_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_video_create_payload.serialize(body, content_type)
