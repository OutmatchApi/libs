...
class VideoAssets(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hls", "iframe", "mp4", "player", "thumbnail", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hls", "iframe", "mp4", "player", "thumbnail", ], str]):
