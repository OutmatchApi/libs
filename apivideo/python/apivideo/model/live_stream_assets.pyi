...
class LiveStreamAssets(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hls", "iframe", "player", "thumbnail", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hls", "iframe", "player", "thumbnail", ], str]):
