...
# Unit tests for apivideo::AccessToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe apivideo::AccessToken do
  let(:instance) { apivideo::AccessToken.new }

  describe 'test an instance of AccessToken' do
    it 'should create an instance of AccessToken' do
      expect(instance).to be_instance_of(apivideo::AccessToken)
    end
  end
