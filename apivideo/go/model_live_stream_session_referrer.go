...
func (o LiveStreamSessionReferrer) MarshalJSON() ([]byte, error) {
...
func (v NullableLiveStreamSessionReferrer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLiveStreamSessionReferrer) UnmarshalJSON(src []byte) error {
	v.isSet = true
