...
func (o TokenCreatePayload) MarshalJSON() ([]byte, error) {
...
func (v NullableTokenCreatePayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokenCreatePayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
