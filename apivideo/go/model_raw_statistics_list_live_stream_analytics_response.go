...
func (o RawStatisticsListLiveStreamAnalyticsResponse) MarshalJSON() ([]byte, error) {
...
func (v NullableRawStatisticsListLiveStreamAnalyticsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRawStatisticsListLiveStreamAnalyticsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
