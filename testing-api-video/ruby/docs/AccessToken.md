...
| **expires_in** | **Integer** | Lists the time in seconds when your access token expires. It lasts for one hour. | [optional] |
...
instance = testing-api-video::AccessToken.new(
