...
# Unit tests for testing-api-video::AccessToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe testing-api-video::AccessToken do
  let(:instance) { testing-api-video::AccessToken.new }

  describe 'test an instance of AccessToken' do
    it 'should create an instance of AccessToken' do
      expect(instance).to be_instance_of(testing-api-video::AccessToken)
    end
  end
