...
# Unit tests for testing-api-video::Account
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe testing-api-video::Account do
  let(:instance) { testing-api-video::Account.new }

  describe 'test an instance of Account' do
    it 'should create an instance of Account' do
      expect(instance).to be_instance_of(testing-api-video::Account)
    end
  end
