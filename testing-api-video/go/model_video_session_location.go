...
func (o VideoSessionLocation) MarshalJSON() ([]byte, error) {
...
func (v NullableVideoSessionLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoSessionLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
