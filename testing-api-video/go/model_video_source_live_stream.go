...
func (o VideoSourceLiveStream) MarshalJSON() ([]byte, error) {
...
func (v NullableVideoSourceLiveStream) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoSourceLiveStream) UnmarshalJSON(src []byte) error {
	v.isSet = true
