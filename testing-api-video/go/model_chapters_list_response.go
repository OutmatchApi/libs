...
func (o ChaptersListResponse) MarshalJSON() ([]byte, error) {
...
func (v NullableChaptersListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChaptersListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
