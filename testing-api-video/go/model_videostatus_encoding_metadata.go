...
func (o VideostatusEncodingMetadata) MarshalJSON() ([]byte, error) {
...
func (v NullableVideostatusEncodingMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideostatusEncodingMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
