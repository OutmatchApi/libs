...
func (o LiveStreamListResponse) MarshalJSON() ([]byte, error) {
...
func (v NullableLiveStreamListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLiveStreamListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
