...
public class PlayerUpdatePayload {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backgroundBottom, playerUpdatePayload.backgroundBottom) &&
        ...
        Objects.equals(this.text, playerUpdatePayload.text) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to PlayerUpdatePayload
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PlayerUpdatePayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlayerUpdatePayload is not found in the empty JSON string", PlayerUpdatePayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PlayerUpdatePayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlayerUpdatePayload` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlayerUpdatePayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlayerUpdatePayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlayerUpdatePayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlayerUpdatePayload.class));

       return (TypeAdapter<T>) new TypeAdapter<PlayerUpdatePayload>() {
           @Override
           public void write(JsonWriter out, PlayerUpdatePayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlayerUpdatePayload read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PlayerUpdatePayload given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PlayerUpdatePayload
  * @throws IOException if the JSON string is invalid with respect to PlayerUpdatePayload
  */
  public static PlayerUpdatePayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlayerUpdatePayload.class);
  }

 /**
  * Convert an instance of PlayerUpdatePayload to an JSON string
  *
  * @return JSON string
  */
