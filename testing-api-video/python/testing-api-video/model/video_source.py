...
class VideoSource(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["liveStream", "type", "uri", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["liveStream", "type", "uri", ], str]):
