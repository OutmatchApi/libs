...
class VideoSessionSession(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["endedAt", "loadedAt", "sessionId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["endedAt", "loadedAt", "sessionId", ], str]):
