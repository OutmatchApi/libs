...
class WebhooksCreatePayload(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["events", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["events", "url", ], str]):
