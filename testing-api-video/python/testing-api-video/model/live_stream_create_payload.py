...
class LiveStreamCreatePayload(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "playerId", "public", "record", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "playerId", "public", "record", ], str]):
