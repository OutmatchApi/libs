 ...
 */
class PlayerSessionEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'player-session-event';
    ...
    */
     ...
     * Sets emitted_at
     *
     * @param \DateTime|null $emitted_at When an event occurred, presented in ISO-8601 format.
     *
     * @return self
     */
