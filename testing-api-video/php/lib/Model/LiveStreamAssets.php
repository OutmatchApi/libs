 ...
 */
class LiveStreamAssets implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'live_stream_assets';
    ...
    */
    ...
    public function setHls($hls)
    {
        ...
        if (is_null($hls)) {
            throw new \InvalidArgumentException('non-nullable hls cannot be null');
        }
